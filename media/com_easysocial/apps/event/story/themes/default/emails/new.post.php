		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_EVENT_NEW_POST', $event); ?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<tr>
							<td valign="top" width="100%">
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 24px;" class="stack-column">
									<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_PAGE_NEW_POST_FOLLOWER_CONTENT', '<a href="' . $posterLink . '" style="color:#00aeef; text-decoration:underline;">' . $actor . '</a>', '<a href="' . $eventLink . '" style="color:#00aeef; text-decoration:underline;">' . $event . '</a>');?>
								</p>
							</td>
						</tr>
					</table>
							...
							<tr>
								<td valign="top">
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										...
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $permalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_POST_BUTTON');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
