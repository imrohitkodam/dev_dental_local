...
class TasksControllerTasks extends SocialAppsController
{
    ...
    public function unresolve()
    {
        ...
        if ($params->get('notify_uncomplete_task', true)) {
            ...
            $event->notifyMembers('task.uncompleted', array('targets' => $targets, 'userId' => $my->id, 'id' => $task->id, 'title' => $task->title, 'content' => $milestone->description, 'permalink' => $url, 'milestone' => $milestone->title));
        }
