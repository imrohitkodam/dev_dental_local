...
class NewsControllerNews extends SocialAppsController
{
    ...
    public function save()
    {
        ...
        $options['comments'] = $this->input->get('comments', false, 'bool');
        ...
        if (!$id) {
            ...
            $options = array('userId' => $this->my->id, 'permalink' => $permalink,'newsId' => $news->id, 'newsTitle' => $news->title, 'newsContent' => nl2br($news->content));
