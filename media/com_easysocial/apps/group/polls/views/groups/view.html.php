...
class PollsViewGroups extends SocialAppsView
{
	...
	public function display($groupId = null, $docType = null)
	{
		...
		// Check if polls has been disabled explicitly
	...
	public function sidebar($moduleLib, $cluster)
	{
		...
		$total = $helper->getTotalPolls($options);
		$myTotal = $helper->getTotalMyPolls($options);
