        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td style="padding: 24px; text-align: left;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('APP_GROUP_TASKS_EMAILS_COMMENTED_ON_A_MILESTONE', $actor); ?></h1>
                </td>
            </tr>
        </table>
    </td>
						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf('APP_GROUP_TASKS_EMAILS_COMMENTED_ON_A_MILESTONE_CONTENT', $actor) ; ?>
								</p>
							</td>
						</tr>
					</table>
									...
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $permalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('APP_GROUP_TASKS_EMAILS_LIKE_INVOLVED_CONTENT_VIEW');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
