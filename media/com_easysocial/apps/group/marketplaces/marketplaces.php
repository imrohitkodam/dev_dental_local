...
class SocialGroupAppMarketplaces extends SocialAppItem
{
	/**
	...
	public function onNotificationLoad(SocialTableNotification &$item)
	{
		...
		if ($item->cmd == 'group.marketplace.create') {
			...
			$item->title = JText::sprintf('APP_CLUSTER_MARKETPLACES_USER_ADDED_NEW_LISTING', $actor->getName(), $group->getName());
