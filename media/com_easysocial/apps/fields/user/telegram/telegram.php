...
class SocialFieldsUserTelegram extends SocialFieldItem
{
	/**
	 * Normalizes the value for telegram field
	 *
	 * @since	3.3.0
	 * @access	public
	 */
	...
	{
		// Ignore https://t.me/ from the value
		$value = str_ireplace('https://t.me/', '', $value);
	...
	public function onDisplay($user)
	{
		...
		// Since we are going to prefix it with the telgram url, we should always remove it
