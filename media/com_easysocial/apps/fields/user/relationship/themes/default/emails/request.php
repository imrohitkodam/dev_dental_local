...
?>
<?php echo $this->html('email.heading', 'PLG_FIELDS_RELATIONSHIP_EMAIL_CONTENT_REQUEST_TITLE', JText::sprintf('PLG_FIELDS_RELATIONSHIP_EMAIL_CONTENT_REQUEST_DESCRIPTION', $posterName)); ?>
							...
							<tr>
								...
								<td valign="middle" style="padding: 0 16px;">
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										...
										<tr>
											<td style="padding: 5px 0;">
												<?php echo $this->html('email.button', 'PLG_FIELDS_RELATIONSHIP_EMAIL_CONTENT_REQUEST_REVIEW', $link); ?>
											</td>
										</tr>
									</table>
								</td>
