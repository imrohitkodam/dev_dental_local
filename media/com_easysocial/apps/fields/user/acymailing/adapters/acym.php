...
class SocialAcyMailingAdapterAcym
{
	...
	public function isEnabled()
	{
        ...
        $acyInitFile = JPATH_ADMINISTRATOR . $ds . 'components' . $ds . 'com_acym' . $ds . 'Core' . $ds . 'init.php';

		return defined('ACYM_NAME') || (file_exists($acyInitFile) && include_once($acyInitFile));
	}
