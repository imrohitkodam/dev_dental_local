	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_('COM_EASYSOCIAL_EMAILS_NEW_LIKES_STORY'); ?>
			</div>
			<div style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_NEW_LIKES_ON_INVOLVED_STATUS', $actor); ?>
			</div>
		</div>
	</td>
</tr>
		...
		<table width="540" cellspacing="0" cellpadding="0" border="0" align="center">
			<tr>
				<td>
					...
					<p style="text-align:left;">
						<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_NEW_LIKES_ON_INVOLVED_STATUS_DESC', $actor);?>
					</p>
				</td>
			</tr>
		</table>
				...
				<tr>
					...
					<td valign="top" style="color:#888;background-color:#f8f9fb;text-align:left;padding: 0 10px;">
						<p style="margin:0 0 5px;font-weight:bold;font-size:13px;">
							<a href="<?php echo $actorLink;?>" style="color:#888;text-decoration:none;"><?php echo $actor;?></a>
						</p>
						<p style="margin:0;font-size:11px;">
							<a style="
									...
									" href="<?php echo $actorLink;?>"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_PROFILE');?></a>
						</p>
					</td>
				</tr>
			</tbody>
