var tjlmsAdmin = {
	...
	stepform: {
		...
		formactions : function (){
			...
			if(jQuery(".nav-tabs li.active").is(':first-child')){
				jQuery("#toolbar-prev button","[data-js-attr='form-actions']").hide().addClass('hide');
				jQuery("#toolbar-next button","[data-js-attr='form-actions']").show().removeClass('hide');
			}
			else if(jQuery(".nav-tabs li.active").is(':last-child')){
				jQuery("#toolbar-prev button", "[data-js-attr='form-actions']").show().removeClass('hide');
				jQuery("#toolbar-next button", "[data-js-attr='form-actions']").hide().addClass('hide');
				jQuery("#toolbar-save button", "[data-js-attr='form-actions']").show().removeClass('hide');
			}
			else{
				jQuery("#toolbar-prev button","[data-js-attr='form-actions']").show().removeClass('hide');
				jQuery("#toolbar-next button","[data-js-attr='form-actions']").show().removeClass('hide');
	...
	lessonFormatForm: {
		...
		showSubformat: function(format, subformat){
			jQuery(this.$form).find(".subformat").hide().addClass("hide");
			jQuery(this.$form).find("." + format + "_subformat[data-subformat='"+ subformat +"']").show().removeClass("hide");
