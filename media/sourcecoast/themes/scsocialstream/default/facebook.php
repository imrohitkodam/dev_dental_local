...
'<div class="facebook ' . $this->channelType . ' post row-fluid">
   <div class="span12 author">';
        ...
        if($this->authorID)
        {
            echo '<div class="author-image"><img src="'.JFBCFactory::provider('facebook')->profile->getAvatarUrl($this->authorID,false,null).'" alt="Author"/></div>
          ...
          <div class="span12 comment">
              <div>';
                if(isset($comment['from']['id']))
                    echo '<span class="from text-left"><img src="https://graph.facebook.com/' . $comment['from']['id'] . '/picture" width="25" alt="Comment Thumbnail"/> ' . $comment['from']['name'] . '</span>';
                echo '<span class="date text-right">' . $date . '</span>
              </div>
