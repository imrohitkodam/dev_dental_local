...
$.require.template.loader(["easydiscuss/field.form.attachments.item","easydiscuss/conversation.read.item","easydiscuss/field.form.polls.answer","easydiscuss/comment.form","easydiscuss/post.notification"]);
	...
	.done(function($) {
		...
		function(self) {
			return{
				...
				initBBCode: function() {
					self.textEditor().markItUp($.getEasyDiscussBBCodeSettings);
				}
			};
		});
