														...
														<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
															<tr>
																<td align="center" style="font-size:0px;padding:0;word-break:break-word;">
																	<div style="font-family:'Roboto', Arial, sans-serif;font-size:36px;font-weight:bold;line-height:48px;text-align:center;color:#444444;"><?php echo JText::_('COM_PP_EMAIL_SUBSCRIPTION_CANCELLED'); ?></div>
																</td>
															</tr>
															<tr>
																<td align="center" style="font-size:0px;padding:0;padding-bottom:20px;word-break:break-word;">
																	<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;font-weight:100;line-height:30px;text-align:center;color:#444444;"><?php echo JText::_('COM_PP_EMAIL_SUBSCRIPTION_CANCELLED_DESC'); ?></div>
																</td>
															</tr>
														</table>
													</td>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														...
														<p><?php echo JText::_('COM_PP_EMAIL_SUBSCRIPTION_CANCELLED_CONTENT'); ?></p>
														...
														<div style="background: #f8f8f8;padding: 20px;">
															<table align="center" style="padding: 20px;">
																...
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_EMAIL_ORDER_ID'); ?>:</b>
																	</td>
																	<td>
																...
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_EMAIL_TOTAL_AMOUNT'); ?>:</b>
																	</td>
																	<td>
