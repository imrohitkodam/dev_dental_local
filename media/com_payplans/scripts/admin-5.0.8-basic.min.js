...
a.extend(this.defaults,f)};var E=new D;return E}),c.define("select2/options",["require","jquery","./defaults","./utils"],function(a,b,c,d){function e(b,e){if(this.options=b,null!=e&&this.fromElement(e),this.options=c.apply(this.options),e&&e.is("input")){var f=a(this.get("amdBase")+"compat/inputData");this.options.dataAdapter=d.Decorate(this.options.dataAdapter,f)}}return e.prototype.fromElement=function(a){var c=["select2"];null==this.options.multiple&&(this.options.multiple=a.prop("multiple")),null==this.options.disabled&&(this.options.disabled=a.prop("disabled")),null==this.options.language&&(a.prop("lang")?this.options.language=a.prop("lang").toLowerCase():a.closest("[lang]").prop("lang")&&(this.options.language=a.closest("[lang]").prop("lang"))),null==this.options.dir&&(this.options.dir=a.prop("dir")?a.prop("dir"):a.closest("[dir]").prop("dir")?a.closest("[dir]").prop("dir"):"ltr"),a.prop("disabled",this.options.disabled),a.prop("multiple",this.options.multiple),a.data("select2Tags")&&(this.options.debug&&window.console&&console.warn&&console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'),a.data("data",a.data("select2Tags")),a.data("tags",!0)),a.data("ajaxUrl")&&(this.options.debug&&window.console&&console.warn&&console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."),a.attr("ajax--url",a.data("ajaxUrl")),a.data("ajax--url",a.data("ajaxUrl")));var e={};e=b.fn.jquery&&"1."==b.fn.jquery.substr(0,2)&&a[0].dataset?b.extend(!0,{},a[0].dataset,a.data()):a.data();var f=b.extend(!0,{},e);f=d._convertData(f);for(var g in f)b.inArray(g,c)>-1||(b.isPlainObject(this.options[g])?b.extend(this.options[g],f[g]):this.options[g]=f[g]);return this},e.prototype.get=function(a){return this.options[a]},e.prototype.set=function(a,b){this.options[a]=b},e}),c.define("select2/core",["jquery","./options","./utils","./keys"],function(a,b,c,d){var e=function(a,c){null!=a.data("select2")&&a.data("select2").destroy(),this.$element=a,this.id=this._generateId(a),c=c||{},this.options=new b(c,a),e.__super__.constructor.call(this);var d=a.attr("tabindex")||0;a.data("old-tabindex",d),a.attr("tabindex","-1");var f=this.options.get("dataAdapter");this.dataAdapter=new f(a,this.options);var g=this.render();this._placeContainer(g);var h=this.options.get("selectionAdapter");this.selection=new h(a,this.options),this.$selection=this.selection.render(),this.selection.position(this.$selection,g);var i=this.options.get("dropdownAdapter");this.dropdown=new i(a,this.options),this.$dropdown=this.dropdown.render(),this.dropdown.position(this.$dropdown,g);var j=this.options.get("resultsAdapter");this.results=new j(a,this.options,this.dataAdapter),this.$results=this.results.render(),this.results.position(this.$results,this.$dropdown);var k=this;this._bindAdapters(),this._registerDomEvents(),this._registerDataEvents(),this._registerSelectionEvents(),this._registerDropdownEvents(),this._registerResultsEvents(),this._registerEvents(),this.dataAdapter.current(function(a){k.trigger("selection:update",{data:a})}),a.addClass("select2-hidden-accessible"),a.attr("aria-hidden","true"),this._syncAttributes(),a.data("select2",this)};return c.Extend(e,c.Observable),e.prototype._generateId=function(a){var b="";return b=null!=a.attr("id")?a.attr("id"):null!=a.attr("name")?a.attr("name")+"-"+c.generateChars(2):c.generateChars(4),b=b.replace(/(:|\.|\[|\]|,)/g,""),b="select2-"+b},e.prototype._placeContainer=function(a){a.insertAfter(this.$element);var b=this._resolveWidth(this.$element,this.options.get("width"));null!=b&&a.css("width",b)},e.prototype._resolveWidth=function(a,b){var c=/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i;if("resolve"==b){var d=this._resolveWidth(a,"style");return null!=d?d:this._resolveWidth(a,"element")}if("element"==b){var e=a.outerWidth(!1);return 0>=e?"auto":e+"px"}if("style"==b){var f=a.attr("style");if("string"!=typeof f)return null;for(var g=f.split(";"),h=0,i=g.length;i>h;h+=1){var j=g[h].replace(/\s/g,""),k=j.match(c);if(null!==k&&k.length>=1)return k[1]}return null}return b},e.prototype._bindAdapters=function(){this.dataAdapter.bind(this,this.$container),this.selection.bind(this,this.$container),this.dropdown.bind(this,this.$container),this.results.bind(this,this.$container)},e.prototype._registerDomEvents=function(){var b=this;this.$element.on("change.select2",function(){b.dataAdapter.current(function(a){b.trigger("selection:update",{data:a})})}),this.$element.on("focus.select2",function(a){b.trigger("focus",a)}),this._syncA=c.bind(this._syncAttributes,this),this._syncS=c.bind(this._syncSubtree,this),this.$element[0].attachEvent&&this.$element[0].attachEvent("onpropertychange",this._syncA);var d=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver;null!=d?(this._observer=new d(function(c){a.each(c,b._syncA),a.each(c,b._syncS)}),this._observer.observe(this.$element[0],{attributes:!0,childList:!0,subtree:!1})):this.$element[0].addEventListener&&(this.$element[0].addEventListener("DOMAttrModified",b._syncA,!1),this.$element[0].addEventListener("DOMNodeInserted",b._syncS,!1),this.$element[0].addEventListener("DOMNodeRemoved",b._syncS,!1))},e.prototype._registerDataEvents=function(){var a=this;this.dataAdapter.on("*",function(b,c){a.trigger(b,c)})},e.prototype._registerSelectionEvents=function(){var b=this,c=["toggle","focus"];this.selection.on("toggle",function(){b.toggleDropdown()}),this.selection.on("focus",function(a){b.focus(a)}),this.selection.on("*",function(d,e){-1===a.inArray(d,c)&&b.trigger(d,e)})},e.prototype._registerDropdownEvents=function(){var a=this;this.dropdown.on("*",function(b,c){a.trigger(b,c)})},e.prototype._registerResultsEvents=function(){var a=this;this.results.on("*",function(b,c){a.trigger(b,c)})},e.prototype._registerEvents=function(){var a=this;this.on("open",function(){a.$container.addClass("select2-container--open")}),this.on("close",function(){a.$container.removeClass("select2-container--open")}),this.on("enable",function(){a.$container.removeClass("select2-container--disabled")}),this.on("disable",function(){a.$container.addClass("select2-container--disabled")}),this.on("blur",function(){a.$container.removeClass("select2-container--focus")}),this.on("query",function(b){a.isOpen()||a.trigger("open",{}),this.dataAdapter.query(b,function(c){a.trigger("results:all",{data:c,query:b})})}),this.on("query:append",function(b){this.dataAdapter.query(b,function(c){a.trigger("results:append",{data:c,query:b})})}),this.on("keypress",function(b){var c=b.which;a.isOpen()?c===d.ESC||c===d.TAB||c===d.UP&&b.altKey?(a.close(),b.preventDefault()):c===d.ENTER?(a.trigger("results:select",{}),b.preventDefault()):c===d.SPACE&&b.ctrlKey?(a.trigger("results:toggle",{}),b.preventDefault()):c===d.UP?(a.trigger("results:previous",{}),b.preventDefault()):c===d.DOWN&&(a.trigger("results:next",{}),b.preventDefault()):(c===d.ENTER||c===d.SPACE||c===d.DOWN&&b.altKey)&&(a.open(),b.preventDefault())})},e.prototype._syncAttributes=function(){this.options.set("disabled",this.$element.prop("disabled")),this.options.get("disabled")?(this.isOpen()&&this.close(),this.trigger("disable",{})):this.trigger("enable",{})},e.prototype._syncSubtree=function(a,b){var c=!1,d=this;if(!a||!a.target||"OPTION"===a.target.nodeName||"OPTGROUP"===a.target.nodeName){if(b)if(b.addedNodes&&b.addedNodes.length>0)for(var e=0;e<b.addedNodes.length;e++){var f=b.addedNodes[e];f.selected&&(c=!0)}else b.removedNodes&&b.removedNodes.length>0&&(c=!0);else c=!0;c&&this.dataAdapter.current(function(a){d.trigger("selection:update",{data:a})})}},e.prototype.trigger=function(a,b){var c=e.__super__.trigger,d={open:"opening",close:"closing",select:"selecting",unselect:"unselecting"};if(void 0===b&&(b={}),a in d){var f=d[a],g={prevented:!1,name:a,args:b};if(c.call(this,f,g),g.prevented)return b.prevented=!0,void 0}c.call(this,a,b)},e.prototype.toggleDropdown=function(){this.options.get("disabled")||(this.isOpen()?this.close():this.open())},e.prototype.open=function(){this.isOpen()||this.trigger("query",{})},e.prototype.close=function(){this.isOpen()&&this.trigger("close",{})},e.prototype.isOpen=function(){return this.$container.hasClass("select2-container--open")},e.prototype.hasFocus=function(){return this.$container.hasClass("select2-container--focus")},e.prototype.focus=function(){this.hasFocus()||(this.$container.addClass("select2-container--focus"),this.trigger("focus",{}))},e.prototype.enable=function(a){this.options.get("debug")&&window.console&&console.warn&&console.warn('Select2: The `select2("enable")` method has been deprecated and will be removed in later Select2 versions. Use $element.prop("disabled") instead.'),(null==a||0===a.length)&&(a=[!0]);var b=!a[0];this.$element.prop("disabled",b)},e.prototype.data=function(){this.options.get("debug")&&arguments.length>0&&window.console&&console.warn&&console.warn('Select2: Data can no longer be set using `select2("data")`. You should consider setting the value instead using `$element.val()`.');var a=[];return this.dataAdapter.current(function(b){a=b}),a},e.prototype.val=function(b){if(this.options.get("debug")&&window.console&&console.warn&&console.warn('Select2: The `select2("val")` method has been deprecated and will be removed in later Select2 versions. Use $element.val() instead.'),null==b||0===b.length)return this.$element.val();var c=b[0];a.isArray(c)&&(c=a.map(c,function(a){return a.toString()})),this.$element.val(c).trigger("change")},e.prototype.destroy=function(){this.$container.remove(),this.$element[0].detachEvent&&this.$element[0].detachEvent("onpropertychange",this._syncA),null!=this._observer?(this._observer.disconnect(),this._observer=null):this.$element[0].removeEventListener&&(this.$element[0].removeEventListener("DOMAttrModified",this._syncA,!1),this.$element[0].removeEventListener("DOMNodeInserted",this._syncS,!1),this.$element[0].removeEventListener("DOMNodeRemoved",this._syncS,!1)),this._syncA=null,this._syncS=null,this.$element.off(".select2"),this.$element.attr("tabindex",this.$element.data("old-tabindex")),this.$element.removeClass("select2-hidden-accessible"),this.$element.attr("aria-hidden","false"),this.$element.removeData("select2"),this.dataAdapter.destroy(),this.selection.destroy(),this.dropdown.destroy(),this.results.destroy(),this.dataAdapter=null,this.selection=null,this.dropdown=null,this.results=null},e.prototype.render=function(){var b=a('<span class="select2 select2-container"><span class="selection"></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>');return b.attr("dir",this.options.get("dir")),this.$container=b,this.$container.addClass("select2-container--"+this.options.get("theme")),b.data("element",this.$element),b},e}),c.define("jquery-mousewheel",["jquery"],function(a){return a}),c.define("jquery.select2",["jquery","jquery-mousewheel","./select2/core","./select2/defaults"],function(a,b,c,d){if(null==a.fn.select2){var e=["open","close","destroy"];a.fn.select2=function(b){if(b=b||{},"object"==typeof b)return this.each(function(){{var d=a.extend(!0,{},b);new c(a(this),d)}}),this;if("string"==typeof b){var d,f=Array.prototype.slice.call(arguments,1);return this.each(function(){var c=a(this).data("select2");null==c&&window.console&&console.error&&console.error("The select2('"+b+"') method was called on an element that is not using Select2."),d=c[b].apply(c,f)}),a.inArray(b,e)>-1?this:d}throw new Error("Invalid arguments for Select2: "+b)}}return null==a.fn.select2.defaults&&(a.fn.select2.defaults=d),c}),{define:c.define,require:c.require}}(),d=c.require("jquery.select2");return b.fn.select2.amd=c,d}),b.resolve()}),PayPlans.require().script("shared/elements","shared/select2","shared/dialog","shared/foundry").done(function(a){var b=a("[data-table-grid-filter]"),c=function(b,c){var d=a.extend({},{width:"resolve",minimumResultsForSearch:3},c);a(b).select2(d)};b.each(function(){var b=a(this),d=b.children().length;c(b,{theme:"backend",minimumResultsForSearch:d>5?3:1/0})}),c("[data-pp-select]"),PayPlans.timer={show:function(a){this.editToggle(a,!0)},close:function(a){this.editToggle(a,!1)},editToggle:function(b,c){var d=a(b).closest("[data-timer-wrapper]"),e=a(d).find("[data-timer-edit-wrapper]"),f=a(d).find("[data-timer-edit-button]"),g=a(d).find("[data-timer-update-button]");c?(a(d).addClass("active"),a(e).removeClass("t-hidden"),f.addClass("t-hidden"),g.removeClass("t-hidden")):(a(d).removeClass("active"),a(e).addClass("t-hidden"),g.addClass("t-hidden"),f.removeClass("t-hidden"))},update:function(b){var c=a(b).closest("[data-timer-wrapper]"),d=a(c).find("[data-timer-edit-wrapper]"),h=(a(c).data("key"),a(b).data("key"),a(b).val(),a(d).find('[data-timer-select][data-key="year"]').val()),i=a(d).find('[data-timer-select][data-key="month"]').val(),j=a(d).find('[data-timer-select][data-key="day"]').val(),k=a(d).find('[data-timer-select][data-key="hour"]').val(),l=a(d).find('[data-timer-select][data-key="minute"]').val(),m=a(d).find('[data-timer-select][data-key="second"]').val(),n=this.format(h,i,j,k,l,m);a(c).find("[data-timer-hidden]").val(n),PayPlans.ajax("admin/views/support/formatTimer",{timer:n}).done(function(b){a(c).find("[data-timer-label]").val(b)})},format:function(a,b,c,d,e,f){return e||(e="0"),f||(f="0"),this.pad(a,2)+this.pad(b,2)+this.pad(c,2)+this.pad(d,2)+this.pad(e,2)+this.pad(f,2)},pad:function(a,b,c){var d=a.toString();for(c||(c="0");d.length<b;)d=c+d;return d}}}),PayPlans.ready(function(a){a(document).on("click.log.details","[data-pp-log-details]",function(){var c=a(this).data("id");PayPlans.dialog({content:PayPlans.ajax("admin/views/log/view",{id:c})})})}),PayPlans.require().done(function(a){var b=a("[data-table-grid-box-checked]"),c=function(){var c=a("[data-table-grid-id]:checked").length;b.val(c).trigger("change")};a(document).on("click.checkall","[data-pp-table-checkall]",function(){var b=a(this),d=b.parents("[data-table-grid]"),e=b.is(":checked");d.find("[data-table-grid-id]").attr("checked",e).prop("checked",e).trigger("change"),c()}),a(document).on("click.check","[data-table-grid] tbody > tr",function(b){var d=b.target.tagName;if("TD"==d){var e=a(this),f=e.find("[data-table-grid-id]"),g=f.is(":checked");g?f.removeAttr("checked"):f.attr("checked",!g),c(),f.trigger("change")}}),a(document).on("change.checkbox","[data-table-grid] tbody > tr [data-table-grid-id]",function(){var d=a(this).is(":checked"),e=a(this).is(":radio"),f=a(this).parents("tr");e&&f.removeClass("is-checked"),f.toggleClass("is-checked",d),c()}),a("[data-table-grid-filter]").on("change",function(){a("[data-table-grid]").submit()}),a("[data-grid-column] [data-grid-order-up]").on("click",function(){var b=a(this).closest("tr"),c=a(b).find("input[name=cid\\[\\]]"),d=a(this),e=d.data("task");a(c).prop("checked",!0),a("[data-table-grid-task]").val(e),a("[data-table-grid]").submit()}),a("[data-grid-column] [data-grid-order-down]").on("click",function(){var b=a(this).closest("tr"),c=a(b).find("input[name=cid\\[\\]]"),d=a(this),e=d.data("task");a(c).prop("checked",!0),a("[data-table-grid-task]").val(e),a("[data-table-grid]").submit()}),a(document).on("keyup.search","[data-table-grid-search-input]",function(b){var c=a(this),d=a("[data-table-grid-search-spacer]"),e=a("[data-table-grid-search-reset]");return 13==b.keyCode&&""!=c.val()&&a.Joomla("submitform"),""!==c.val()?(e.removeClass("t-hidden"),d.addClass("t-hidden"),void 0):(e.addClass("t-hidden"),d.removeClass("t-hidden"),void 0)}),a(document).on("click.search","[data-table-grid-search-reset]",function(){var c=a(this),e=(a("[data-table-grid-search-submit]"),c.parents("[data-table-grid-search]").find("[data-table-grid-search-input]"));e.val(""),a.Joomla("submitform")}),PayPlans.getSelectedIds=function(){var b=[],c=a("[data-fd-grid]").find("[data-fd-table-id]:checked");return c.length<=0?b:(a(c).each(function(c,d){var e=a(d).val();b.push(e)}),b)},a("[data-table-grid-publishing]").on("click",function(){var b=a(this),c=b.data("task"),d=b.closest("tr"),e=a(d).find("input[name=cid\\[\\]]");a(e).prop("checked",!0),a("[data-table-grid-task]").val(c),a("[data-table-grid]").submit()}),a("[data-table-grid-sort]").on("click",function(){var b=a(this),c=b.data("direction"),d=b.data("sort");a("[data-table-grid-ordering]").val(d),a("[data-table-grid-direction]").val(c),a("[data-table-grid]").submit()}),a("[data-table-grid-saveorder]").on("click",function(){var b=a(this),c=b.data("task");a("[data-pp-table-checkall]").click(),a("[data-table-grid-task]").val(c),a("[data-table-grid]").submit()}),b.on("change",function(){var b=a("body").hasClass("is-joomla-4");if(b){var c=a(this),d=c.val(),e=d>0?!1:!0,f=document.querySelectorAll("joomla-toolbar-button");a(f).each(function(a,b){b.listSelection&&b.setDisabled(e)})}})}),PayPlans.ready(function(a){a(document).on("click.timer","[data-timer-edit-button]",function(){PayPlans.timer.show(this)}),a(document).on("click.timer","[data-timer-update-button]",function(){PayPlans.timer.close(this)}),a(document).on("change.timer","[data-timer-select]",function(){PayPlans.timer.update(this)})}),PayPlans.ready(function(a){a.fn.validateForm=function(){var b=a(this),c=b.find("[data-pp-validate]"),d=!1;return a(c).each(function(b,c){var c=a(c),e=c.find("[data-"+c.data("target")+"]"),f=e.val(),g=c.data("type");c.removeClass("has-error"),"empty"==g&&(f.length<=0||""==f)&&(c.addClass("has-error"),d=!0)}),d}});