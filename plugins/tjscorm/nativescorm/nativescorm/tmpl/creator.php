		...
		<div class="fileupload fileupload-new" data-provides="fileupload">
			<div class="input-append">
				...
				<?php if($edit == 1){ ?>
					...
					<a id="previewbtn" class="btn btn-primary" onclick="tjlmsAdmin.lesson.preview('previewContent', <?php echo $lesson_id; ?>);">
...
<script type="text/javascript">
   ...
   jQuery(document).ready(function() {
        jQuery('#previewbtn').on('click', function() {
            // Add the modal-fullscreen class to the modal dialog
            jQuery('#previewContent<?php echo $lesson_id; ?> .modal-dialog').addClass('modal-fullscreen');
            jQuery('#previewContent<?php echo $lesson_id; ?> .modal-header').css('display', 'none');
        });
    });
</script>
