...
<div class="o-card o-card--borderless t-lg-mb--lg">
	...
	<div class="o-card__body">
		...
		<?php echo $this->html('form.card', array('card' => 'card_num', 'expire_month_year' => $dateFormat, 'expire_month' => 'exp_month', 'expire_year' => 'exp_year', 'code' => 'card_code'), 
					array('card_num' => $params->get('sandbox') ? '370000000000002' : '', 'exp_month_year' => $dateFormat ? $dateFormat : 'MM / YYYY', 'exp_month' => $params->get('sandbox') ? '12' : '', 'exp_year' => $params->get('sandbox') ? '2028' : '', 'card_code' => $params->get('sandbox') ? '1234' : '')
		); ?>
	</div>
</div>		
