...
<div class="o-card o-card--borderless t-lg-mb--lg">
	...
	<div class="o-card__body">
		...
		<?php echo $this->html('form.card', ['name' => 'card_name', 'expire_month_year' => 'MM / YY', 'card' => 'card_num', 'expire_month' => 'exp_month', 'expire_year' => 'exp_year', 'code' => 'card_code'],
			['card_name' => $sandbox ? 'John Doe' : '', 'exp_month_year' => 'MM / YY','card_num' => $sandbox ? '4111111111111111' : '', 'exp_month' => $sandbox ? '08' : '', 'exp_year' => $sandbox ? '2023' : '', 'card_code' => '123']
		); ?>
...
<div class="o-card o-card--borderless t-lg-mb--lg">
	...
	<div class="o-card__body">
		...
		<?php echo $this->html('form.country', 'country', $country, 'country'); ?>
	</div>
</div>
