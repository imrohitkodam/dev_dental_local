...
class PPAppEasyBlog extends PPApp
{
	...
	private function categories()
	{
		...
		if (!$accessibleCategories || !array_key_exists($id, $accessibleCategories)) {
			...
			EB::info()->set(JText::sprintf('COM_PP_APP_EASYBLOG_YOU_ARE_NOT_ALLOWED_TO_VIEW_CATEGORY', $link), 'error');
	...
	public function entry()
	{
		...
		// Check If content acl app allow to view the blog post
		$allowedPost = $this->helper->isContentAclAppAllowBlogPost($id);
		if ($allowedPost) {
			return true;
		}
