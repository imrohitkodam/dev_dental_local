		...
		if ($code && $type) {
			...
			switch ($strType) {
				case 'TRANSACTION':
					...
					*/
					...
					try {
						...
						PP::logger()->log(PPLogger::LEVEL_ERROR, $e->getMessage(), $this->getId(), array($e->getMessage()), 'PayplansPaymentFormatter', '', true);
						return true;
					}
					break;
				...
				default:
					...
					PP::logger()->log(PPLogger::LEVEL_ERROR, $message, $this->getId(), array($message),'PayplansPaymentFormatter', '', true);
