...
class PPHelperRobokassa extends PPHelperPayment
{
	...
	/**
	 * Determines if EURO currency supported
	 *
	 * @since	4.0.0
	 * @access	public
	 */
	public function isEuroCurrencySupported()
	{
		static $euroCurrency = null;

		if (is_null($euroCurrency)) {
			$euroCurrency = $this->params->get('euroCurrencySupport') ? true : false;
		}
	...
	{
		if ($this->isEuroCurrencySupported()) {
			$payload = array(
