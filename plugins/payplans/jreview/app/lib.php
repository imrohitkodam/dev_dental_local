...
class PPJReview
{
	 ...
	 * @access	public
	 */
	public function getParentCategories($catId = 0, &$parents = [])
	{
		$db = PP::db();
	 ...
	 * @access	public
	 */
	public function getCategoryCount($category = 0, $userId = null)
	{
		$db = PP::db();
	 ...
	 * @access	public
	 */
	public function getChildCategories($categoryId = 0, &$childs = [])
	{
		if (!$categoryId) {
			return $childs;
		}
	 ...
	 * @access	public
	 */
	public function getTotalPostEntries($category = 0, $userId = null)
	{
