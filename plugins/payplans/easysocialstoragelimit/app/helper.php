...
class PPHelperEasySocialStorageLimit extends PPHelperStandardApp
{
	private $resource = 'com_easysocial.storagelimit';
	...
	{
		$planId = $plan->getId();
		$availablePlans = $this->params->get('storage_mapping', array());
	...
	/**
	 * Check to see if users has any storage upload size overrides.
	 *
	 * @since	4.2.4
	 * @access	public
	 */
	public function hasStorageSizeOverride(PPUser $user)
	{
