...
class PPHelperEasyBlogSubmission extends PPHelperStandardApp
{
	...
	/**
	 * Increase the resource usage counter
	 *
	 * @since	4.0.0
	 * @access	public
	 */
	public function increase($categoryId, PPUser $user, $count)
	{
		$db = PP::db();
	 ...
	 * @access	public
	 */
	public function isAllowedInCategory($categoryId, $userId)
	{
		$model = PP::model('Resource');
		$total = $model->loadRecords(array(
					'user_id' => $userId,
	...
	/**
	 * Get category usage from a user
	 *
	 * @since	4.2.0
	 * @access	public
	 */
	public function getCategoryUsage($categoryId, PPUser $user)
	{
		$model = PP::model('Resource');
