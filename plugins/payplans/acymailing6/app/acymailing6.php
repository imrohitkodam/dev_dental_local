...
class PPAppAcymailing6 extends PPApp
{
	/**
	...
	public function onPayplansSubscriptionAfterSave($prev, $new)
	{
		...
		if (!$this->helper->exists()) {
			...
			PP::logger()->log(PPLogger::LEVEL_INFO, $message, $this->getId(), $content, 'PayplansAppAcymailing6Formatter');
			return false;
		}
