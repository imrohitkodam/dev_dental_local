...
class plgUserEasydiscussProfile extends JPlugin
{
	...
	public function onContentPrepareForm($form, $data)
	{
		...
		$form->loadFile('easydiscussprofile');
		...
		foreach ($fields as $field) {
			...
			// Case registration	
				...
				if ($this->params->get('register-require_' . $field, 1) > 0) {
					$form->setFieldAttribute($field, 'required', ($this->params->get('register-require_' . $field) == 2) ? 'required' : '', 'easydiscussprofile');
				} else {
					$form->removeField($field, 'easydiscussprofile');
				}
			...
			// Case profile in site or admin	
				...
				if ($this->params->get('profile-require_' . $field, 1) > 0) {
					$form->setFieldAttribute($field, 'required', ($this->params->get('profile-require_' . $field) == 2) ? 'required' : '', 'easydiscussprofile');
				} else {
					$form->removeField($field, 'easydiscussprofile');
				}
			}
