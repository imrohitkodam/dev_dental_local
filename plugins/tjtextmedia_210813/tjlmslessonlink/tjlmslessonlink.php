...
class PlgTjtextmediaTjlmsLessonLink extends CMSPlugin
{
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_tjtextmediaContentInfo($config=array('tjlmslessonlink'))
	{
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_tjlmslessonlinkContentHTML($mod_id , $lesson_id, $lesson, $comp_params)
	{
		$result = array();
	 ...
	 * @since 1.0.0
	 */
	public function tjlmslessonlinkrenderPluginHTML($config)
	{
	...
	public function additionaltjlmslessonlinkFormatCheck($lessonId, $mediaObj)
	{
		return $mediaObj;
	}
	 ...
	 * @since 1.0.0
	 * */
	public function TjlmsLessonLink_updatedata()
	{
