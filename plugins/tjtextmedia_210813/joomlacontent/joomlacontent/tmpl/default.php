...
?>
<link rel="stylesheet" type="text/css"  href="<?php echo JUri::root(true). '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/style/joomlacontent.css';?>"></link>
...
<iframe class="jt_content"type="text/html" width="100%"
		src="<?php echo JUri::root() . $config['file'] . '&tmpl=component';?>">
</iframe>';
