 ...
 * @since  1.0.0
 */
class PlgTjtextmediaNativeeditor extends JPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_tjtextmediaContentInfo($config=array('nativeeditor'))
	{
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_nativeeditorContentHTML($mod_id , $lesson_id, $lesson, $comp_params)
	{
		$html = '';
		$result = array();
	 ...
	 * @since 1.0.0
	 */
	public function nativeeditorrenderPluginHTML($config)
	{
		...
		{
			$config['template'] = JPluginHelper::getLayoutPath($this->_type, $this->_name, 'template');
		}
	 ...
	 * @since 1.0.0
	 */
	public function additionalnativeeditorFormatCheck($lessonId, $mediaObj)
	{
		return $mediaObj;
	}
	...
	public function buildLayout($vars, $layout = 'default' )
	{
		// Load the layout & push variables
		ob_start();
		$layout = JPluginHelper::getLayoutPath($this->_type, $this->_name, $layout);
		include $layout;
		$html = ob_get_contents();
		ob_end_clean();
