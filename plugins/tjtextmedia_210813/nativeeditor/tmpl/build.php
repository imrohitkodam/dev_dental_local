...
<script type="text/javascript"  src="<?php echo JUri::root(true) . '/media/editors/tinymce/js/tinymce.min.js'?>"></script>
<style>
		...
		<div class="htmltoolbar" >
			<div class="left">
				...
				<button type="button" onclick="closepopup()" class="btn btn-small btn-danger">
					<?php echo JText::_("COM_TJLMS_CLOSE");?>
				</button>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function save(action) {
		...
		/* Save Content */
		jQuery.ajax({
			url: "<?php echo JUri::root();?>"+"index.php?option=com_tjlms&task=callSysPlgin&plgType=tjtextmedia&plgName=<?php echo $vars['plgname'];?>&plgtask=saveHtmlContent",
			type: "POST",
			data: {
