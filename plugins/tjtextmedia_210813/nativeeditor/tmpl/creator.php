...
?>
	...
	<div class="tjlms_html_belonging_before_upload" align="left">
		<a class="btn btn-primary article tjmodal" onclick="openNativebuilder(this,'add')"><?php echo JText::_("PLG_TEXTMEDIA_NATIVEBUILDR_LAUNCH_BUILDER");?></a>
	</div>
<?php } ?>
...
function openNativebuilder(thislink,action)
{
	...
	var content_link = "<?php echo JUri::root();?>"+"index.php?option=com_tjlms&task=callSysPlgin&plgType=tjtextmedia&plgName=nativeeditor&plgtask=getpluginHtml&sub_layout=build&callType=1&tmpl=component&creator_id="+<?php echo $user_id?>+"&form_id="+ form_id +"&lesson_id=" + lesson_id +"&action="+ action;
