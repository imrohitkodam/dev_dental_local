...
<?php
$sniffetFilePath = JUri::root(true) . '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/assets/default/snippets.html';
...
<link rel="stylesheet" type="text/css"  href="<?php echo JUri::root(true). '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/assets/default/content.css'?>"></link>
<link rel="stylesheet" type="text/css"  href="<?php echo JUri::root(true). '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/scripts/contentbuilder.css'?>"></link>
<link rel="stylesheet" type="text/css"  href="<?php echo JUri::root(true). '/media/com_tjlms/css/tjlms_backend.css'?>"></link>
...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV; ?>">
	...
	<div id="tjlmscontainer">
		<div class="htmltoolbar" >
			<div class="left">
				<button onclick="save('save')" class="btn btn-small btn-primary"> <?php echo JText::_("COM_TJLMS_SAVE");?> </button>
				<button onclick="save('saveclose')" class="btn btn-small btn-success"> <?php echo JText::_("COM_TJLMS_SAVE_CLOSE");?> </button>
				<button onclick="closepopup()" class="btn btn-small btn-danger"> <?php echo JText::_("COM_TJLMS_CLOSE");?> </button>
			</div>
		</div>
...
<script type="text/javascript" src="<?php echo JUri::root(true) . '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/scripts/jquery-ui.min.js'?>"></script>
<script type="text/javascript" src="<?php echo JUri::root(true) . '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/scripts/contentbuilder.js'?>"></script>
<script type="text/javascript" src="<?php echo JUri::root(true) . '/plugins/tjtextmedia/' . $this->_name . '/' . $this->_name .'/scripts/saveimages.js'?>"></script>
			...
			onComplete: function () {
				...
				jQuery.ajax({
					...
					success: function(data) {
						...
						window.parent.jQuery("#lesson-format-form_<?php echo $form_id; ?> .tjlms_html_belonging_before_upload").hide().addClass("hide");
						window.parent.jQuery("#lesson-format-form_<?php echo $form_id; ?> .tjlms_html_belonging_after_upload").show().removeClass("hide");
