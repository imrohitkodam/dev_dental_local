 ...
 * @since  1.0.0
 */
class PlgTjtextmediaHtmlcreator extends JPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_tjtextmediaContentInfo($config = array('htmlcreator'))
	{
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_htmlcreatorContentHTML($mod_id , $lesson_id, $lesson, $comp_params)
	{
		$html = '';
		$result = array();
	 ...
	 * @since 1.0.0
	 */
	public function additionalhtmlcreatorFormatCheck($lessonId, $mediaObj)
	{
		return $mediaObj;
	}
	 ...
	 * @since 1.0.0
	 */
	public function htmlcreatorrenderPluginHTML($config)
	{
		/*$config['file'] = "http://player.vimeo.com/video/110168157";
		$config['lesson_id'] = 23;
		$config['attempt'] = 1;
