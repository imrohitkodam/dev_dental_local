...
class PlgTjhtmlzipsHtmlzip extends JPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function GetSubFormat_tjhtmlzipsContentInfo($config = array('htmlzip'))
	{
	 ...
	 * @since 1.0.0
	 */
	public function GetSubFormat_htmlzipContentHTML($mod_id, $lesson_id, $lesson, $comp_params)
	{
		$result = array();
	 ...
	 * @since 1.0.0
	 */
	public function Upload_filesOnhtmlzip($lesson_id, $filename = '', $filepath = '')
	{
	 ...
	 * @since 1.0.0
	 */
	public function additionalhtmlzipFormatCheck($lessonId, $mediaObj)
	{
		return $mediaObj;
	}
	 ...
	 * @since 1.0.0
	 */
	public function htmlziprenderPluginHTML($config)
	{
