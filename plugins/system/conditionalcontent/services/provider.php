...
use RegularLabs\Plugin\System\ConditionalContent\Extension\ConditionalContent;
    ...
    public function register(Container $container)
    {
        $container->set(
            ...
            function (Container $container) {
                $plugin = new ConditionalContent(
                    $container->get(DispatcherInterface::class),
                    (array) PluginHelper::getPlugin('system', 'conditionalcontent')
                );
