			...
			onComplete: function () {
				...
				jQuery.ajax({
					...
					success: function(data) {
						...
						window.parent.jQuery("#lesson-format-form_<?php echo $form_id; ?> .tjlms_html_belonging_before_upload").hide();
						window.parent.jQuery("#lesson-format-form_<?php echo $form_id; ?> .tjlms_html_belonging_after_upload").show();
