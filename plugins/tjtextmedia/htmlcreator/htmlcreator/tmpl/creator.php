...
<div class="tjlms_html_belonging_before_upload" align="left">
	<a class="btn btn-primary article modal"
	onclick="openHtmlContentbuilder(this,'add')"><?php echo JText::_("COM_TJLMS_LAUNCH_HTML_BUILDER");?></a>
</div>
<?php } ?>
...
<div class="control-group tjlms_html_lesson_preview tjlms_html_belonging_after_upload <?php echo $preview_class;?>">
	...
	<div class="tjlms_text_center">
		<a class="btn btn-success tjlms_html_belonging_after_upload"
			onclick="openHtmlContentbuilder(this,'edit')"><?php echo JText::_("COM_TJLMS_EDIT_HTML_CONTENT")?></a>
	</div>
</div>

<script type="text/javascript">
/*open htmlcontentbuilder*/
function openHtmlContentbuilder(thislink,action)
{
	...
	var content_link = "<?php echo JUri::root();?>"+"index.php?option=com_tjlms&task=callSysPlgin&plgType=tjtextmedia&plgName=htmlcreator&plgtask=getpluginHtml&sub_layout=build&callType=1&tmpl=component&creator_id="+<?php echo $user_id?>+"&form_id="+ form_id +"&lesson_id=" + lesson_id +"&action="+ action;
...
function validatetextmediahtmlcreator(formid,format,subformat,media_id)
{
	...
	if(media_id == 0)
	{
		...
		{
			res.check = '0';
			res.message = "<?php echo JText::_('PLG_TJTEXTMEDIA_HTMLCREATOR_SOURCE_MISSING');?>";
		}
	}
