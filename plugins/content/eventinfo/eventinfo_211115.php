...
if (JFolder::exists(JPATH_SITE . '/components/com_jticketing'))
{
...
class PlgContentEventInfo extends CMSPlugin
{
	...
	public function onContentPrepareTjHtml($eventId, $client)
	{
		...
		$data = $this->getCertificateClientData($eventId, $client);
	 ...
	 * @return  string|boolean
	 */
	public function getCertificateClientData($clientId, $client)
	{
		if ($client != 'com_jticketing.event')
		{
			return false;
