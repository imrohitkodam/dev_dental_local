...
class EasyBlogView extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		if ($this->doc->getType() == 'html') {
			...
			if ($showMiniHeader && $view == 'entry' && EB::easysocial()->exists() && !EB::easysocial()->isLegacy() && !$contributionHeader) {
				ES::initialize();
