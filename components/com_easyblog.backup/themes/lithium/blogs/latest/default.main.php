...
?>
<div itemprop="blogPosts" itemscope itemtype="http://schema.org/BlogPosting" class="eb-post clearfix" data-blog-posts-item data-id="<?php echo $post->id;?>">
	<div class="eb-post-side">
		<?php if ( in_array($post->posttype, array('photo', 'standard', 'twitter', 'email')) && $this->output('site/blogs/latest/post.cover', array('post' => $post)) ) { ?>
	...
	<div class="eb-post-content">
		...
		<?php if (in_array($post->posttype, array('photo', 'standard', 'twitter', 'email'))) { ?>
			<?php // echo $this->output('site/blogs/latest/post.cover', array('post' => $post)); ?>

			<div class="eb-post-body type-<?php echo $post->posttype; ?> clearfix">
