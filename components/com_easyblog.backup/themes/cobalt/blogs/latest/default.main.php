		...
		<div class="eb-post-authorship row-table">
			...
			<div class="col-cell cell-tight">
				<div class="eb-post-avatar">
					...
					<a href="<?php echo $post->getBlogContribution()->getPermalink(); ?>" class="eb-post-author-avatar team eb-avatar">
						<img src="<?php echo $post->getBlogContribution()->getAvatar();?>" width="50" height="50"  alt="<?php echo $post->getBlogContribution()->getTitle();?>" />
					</a>
					<?php } ?>

					<a href="<?php echo $post->author->getProfileLink(); ?>" class="eb-post-author-avatar single eb-avatar">
