...
<form method="post" action="<?php echo JRoute::_('index.php');?>" class="form-horizontal" enctype="multipart/form-data" data-eb-dashboard-account>
	...
	<?php if ($this->acl->get('update_facebook') && ($this->config->get('main_facebook_ogauthor') || ($this->config->get('integrations_facebook') && $this->config->get('integrations_facebook_centralized_and_own')))) { ?>
