					...
					<div class="eb-table-content mt-10 mb-10 pb-10">
						...
						<div class="text-muted small mt-5">
							<?php if ($post->isScheduled()) { ?>
								<i class="fa fa-clock-o"></i>&nbsp; <?php echo JText::sprintf('COM_EASYBLOG_DASHBOARD_ENTRIES_POST_IS_SCHEDULED_DESC', $post->getPublishDate(true)->format(JText::_('DATE_FORMAT_LC2'))); ?>
							<?php } ?>
