...
<div class="tab-pane <?php echo $active=='quote' ? 'active' : ''; ?>" id="quote" data-quickpost-form data-type="quote">
	<form class="es-quick-quote form-horizontal">
		<div class="form-group">
			<div class="col-md-12">
				<textarea name="quote" class="form-control" placeholder="<?php echo $this->html('string.escape', JText::_('COM_EASYBLOG_MICROBLOG_QUOTE_CONTENT_PLACEHOLDER', true));?>" rows="5" data-quickpost-content></textarea>
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-12">
