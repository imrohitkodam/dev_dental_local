...
<div class="eb-calendar-topbar">
    ...
    <a href="<?php echo EBR::_('index.php?option=com_easyblog&view=calendar&calendar=1&month=' . $date->format('m') . '&year=' . $date->format('Y'));?>" class="eb-calendar-topbar__toggle"><?php echo JText::_('COM_EASYBLOG_SWITCH_TO_CALENDAR_VIEW');?></a>
</div>
