		...
		<?php if ($this->config->get('layout_avatar') && $this->params->get('post_author_avatar', true)) { ?>
			<div class="eb-post-avatar pull-left mr-15">
				...
				<div class="eb-post-author-avatar single" itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
					<a href="<?php echo $post->author->getProfileLink(); ?>" class="eb-avatar" itemtype="https://schema.org/ImageObject" itemscope="" itemprop="logo">
						<img src="<?php echo $post->author->getAvatar();?>" width="50" height="50" alt="<?php echo $post->author->getName();?>" />
						<meta content="<?php echo $post->author->getAvatar();?>" itemprop="url">
		...
		<div class="eb-post-head no-overflow">
			...
			<div class="eb-post-meta text-muted">
				...
				<div itemprop="image" itemscope itemtype="https://schema.org/ImageObject" class="hidden">
					<img src="<?php echo $post->getImage($this->config->get('cover_size', 'large'));?>"/>
