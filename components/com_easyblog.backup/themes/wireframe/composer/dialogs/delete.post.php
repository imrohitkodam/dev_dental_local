...
<dialog>
    ...
    <bindings type="javascript">
    {
        ...
        "{deleteButton} click": function() {
            ...
            "ids": <?php echo $uid; ?>
                ...
                // Redirect the user to backend post listing when the post is deleted from admin site.
                <?php if (JFactory::getApplication()->isAdmin()) { ?>
                    var baseUrl = "index.php%3Foption%3Dcom_easyblog%26view%3Dblogs";
    ...
    <content>
        <form data-form-delete-post method="post" action="<?php echo JRoute::_('index.php');?>">
           ...
           <?php echo $this->html('form.hidden', 'return', base64_encode(EBR::_('index.php?option=com_easyblog&view=blogs', false))); ?>
