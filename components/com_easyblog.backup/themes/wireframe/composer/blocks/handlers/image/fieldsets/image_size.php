...
<div class="eb-composer-fieldset eb-image-size-fieldset preset-simple" data-eb-image-size-fieldset data-name="image-size">
    ...
    <div class="eb-composer-fieldset-content">
        ...
        <div class="eb-composer-field eb-image-size-simple-field style-bordered" data-eb-image-size-simple-field>
            ...
            <div class="eb-composer-fieldgroup eb-image-responsive-field">
                <div class="eb-composer-fieldgroup-content">
                    <div class="row-table eb-composer-fieldrow">
                        <div class="col-cell eb-composer-fieldrow-content">
                            <div data-type="checkbox" class="eb-composer-field eb-checkbox">
                                <input type="checkbox" id="image-responsive-option" data-eb-image-responsive-checkbox >
                                <label class="eb-hint-text" for="image-responsive-option"><?php echo JText::_('COM_EASYBLOG_COMPOSER_ENABLE_RESPONSIVE_LABEL'); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
