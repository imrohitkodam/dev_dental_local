...
<?php } else { ?>
<a href="javascript:void(0);" class="author-friend" data-es-conversations-compose data-id="<?php echo $user->id;?>"><span><?php echo JText::_('COM_EASYBLOG_MESSAGE_AUTHOR'); ?></span></a>
<?php } ?>