...
?>
<?php if ($post->canEdit() || $post->canFeature() || $post->canDuplicate() || $post->canPrint() || $post->canDelete() || $post->canAcceptAsAnswer() || $post->canResolve() || $post->canLock() || $post->canReport() || $post->canReply() || ($post->isPending() && $post->canModerate())) { ?>
