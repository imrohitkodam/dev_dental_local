...
<div class="tab-content" data-ed-editor-tabs-content>
	<div id="preview-editor-<?php echo $editorId;?>" class="ed-editor-tab__content tab-pane active">
		<div class="ed-editor-composer" style="width: 100%;" data-ed-composer>
			<textarea class="o-form-control" data-ed-editor-uuid="<?php echo $editorUuid; ?>" name="<?php echo $name; ?>" placeholder="<?php echo JText::_('COM_EASYDISCUSS_COMPOSER_PLACEHOLDER_' . strtoupper($operation));?>" data-ed-editor><?php echo $this->html('string.escape', $content);?></textarea>
