...
<dialog>
	...
	<bindings type="javascript">
	{
		...
		"{linkUrl} keydown": function(el, event) {
			event = event[0];
		...
		"{submitButton} click": function() {
			...
			// Insert the link
			window.insertLinkCode(url, title, "<?php echo $caretPosition;?>", "<?php echo $element;?>", contents, "<?php echo $dialogRecipient; ?>", "<?php echo $editorUuid; ?>");
