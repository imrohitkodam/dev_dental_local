...
<dialog>
	...
	<bindings type="javascript">
	{
		...
		"{photoUrl} keydown": function(el, event) {
			event = event[0];
		...
		"{submitButton} click": function() {
			...
			// Insert the photo
			window.insertPhotoCode(url, "<?php echo $caretPosition;?>", "<?php echo $element;?>", contents, "<?php echo $dialogRecipient; ?>", "<?php echo $editorUuid; ?>");
