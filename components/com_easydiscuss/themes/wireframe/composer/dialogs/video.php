...
<dialog>
	...
	<bindings type="javascript">
	{
		...
		"{videoUrl} keydown": function(el, event) {
			event = event[0];
		...
		"{submitButton} click": function() {
			...
			// Insert the video
			window.insertVideoCode(url, "<?php echo $caretPosition;?>", "<?php echo $element;?>", contents, "<?php echo $dialogRecipient; ?>", "<?php echo $editorUuid; ?>");
