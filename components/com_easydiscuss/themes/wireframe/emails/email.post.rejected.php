...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAIL_TEMPLATE_NEW_' . $type . '_REJECTED', JText::sprintf('COM_EASYDISCUSS_NEW_' . $type . '_REJECTED', $postLink, $postTitle)); ?>
						...
						<tr>
							<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
								<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:22px;text-align:left;color:#888888;">
									<h5><?php echo JText::_('COM_ED_MAIL_TEMPLATE_POST_REJECTED_REASON'); ?></h5>
									<p>
