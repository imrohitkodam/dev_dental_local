				...
				<div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
					...
					<tr>
						<td style="vertical-align:top;padding:0;">
							...
							<tr>
								<td style="font-size:0px;padding:0;word-break:break-word;" align="left">
									<div style="font-family:'Roboto', Arial, sans-serif;font-size:12px;line-height:12px;text-align:left;color:#626262;">
						                <?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_SUBSCRIPTION_STATEMENT'); ?><br />
						                <?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_TO_UNSUBSCRIBE');?> <a style="font-size:12px;line-height:12px;color:#4e72e2;text-decoration:none;" target="_blank" href="<?php echo $site->unlink;?>"><?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_CLICK_HERE');?></a>.
									</div>
								</td>
							</tr>
							</tbody>
									...
									<tr>
										<td style="font-size:0px;padding:0;word-break:break-word;" align="left">
											<div style="font-family:'Roboto', Arial, sans-serif;font-size:12px;line-height:12px;text-align:left;color:#626262;">
						                		...
						                		<?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_TO_UNSUBSCRIBE');?> <a style="font-size:12px;line-height:12px;color:#4e72e2;text-decoration:none;" target="_blank" href="<?php echo $cat->unlink;?>"><?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_CLICK_HERE');?></a>.
											</div>
										</td>
									</tr>
									</tbody>
