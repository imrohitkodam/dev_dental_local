				...
				<div class="o-media o-media--top">
					...
					<div class="o-media__body l-stack">
						...
						<div class="o-meta l-spaces--2xs">
							<?php echo ED::ranks()->getRank($user->id); ?>
						</div>
						<?php } ?>
						...
						<div class="l-cluster l-spaces--2xs">
							<div class="">
								<?php if ($this->config->get('layout_profile_showsocial')) { ?>
									<?php if ($this->config->get('layout_social_facebook') && $params->get('show_facebook', false) && $user->getFacebook()) { ?>
									<div class="">
									...
									<?php if ($this->config->get('layout_social_twitter') && $params->get('show_twitter', false) && $user->getTwitter()) { ?>
									<div>
									...
									<?php if ($this->config->get('layout_social_linkedin') && $params->get('show_linkedin', false) && $user->getLinkedin()) { ?>
									<div>
									...
									<?php if ($this->config->get('layout_social_skype') && $params->get('show_skype', false) && $user->getSkype()) { ?>
									<div>
									...
									<?php if ($this->config->get('layout_social_website') && $params->get('show_website', false) && $user->getWebsite()) { ?>
									<div>
