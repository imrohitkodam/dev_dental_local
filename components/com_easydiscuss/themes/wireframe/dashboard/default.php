	...
	<div class="l-stack">
		...
		<div class="o-tabs o-tabs--ed">
			<div class="o-tabs__item active" data-ed-tabs>
				<a href="#pending" data-ed-toggle="tab" class="o-tabs__link"><?php echo JText::_('COM_ED_PENDING_POSTS');?></a>
			</div>

			<?php if ($this->config->get('main_work_schedule') && $this->acl->allowed('manage_holiday')) { ?>
			<div class="o-tabs__item" data-ed-tabs>
				<a href="#holidays" data-ed-toggle="tab" class="o-tabs__link"><?php echo JText::_('COM_ED_MANAGE_HOLIDAYS');?></a>
			</div>	
			<?php } ?>
		</div>
