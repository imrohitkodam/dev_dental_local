...
<div class="l-stack">
	...
	<?php if ($this->config->get('layout_user_details')) { ?>
		<div class="o-card o-card--ed-edit-profile-item">
			<div class="o-card__body l-stack l-spaces--sm">
	...
	<div class="o-card o-card--ed-edit-profile-item">
		...
		<div class="o-card__body t-border-top--1 l-stack">
			<?php if ($this->config->get('layout_social_website')) { ?>
				<div class="t-d--flex sm:t-flex-direction--c">
					<div class="lg:t-w--33 sm:t-mb--sm">
			...
			<?php if ($this->config->get('layout_social_facebook')) { ?>
				<div class="t-d--flex sm:t-flex-direction--c">
					<div class="lg:t-w--33 sm:t-mb--sm">
			...
			<?php if ($this->config->get('layout_social_twitter')) { ?>
				<div class="t-d--flex sm:t-flex-direction--c">
					<div class="lg:t-w--33 sm:t-mb--sm">
			...
			<?php if ($this->config->get('layout_social_linkedin')) { ?>
				<div class="t-d--flex sm:t-flex-direction--c">
					<div class="lg:t-w--33 sm:t-mb--sm">
			...
			<?php if ($this->config->get('layout_social_skype')) { ?>
				<div class="t-d--flex sm:t-flex-direction--c">
					<div class="lg:t-w--33 sm:t-mb--sm">
