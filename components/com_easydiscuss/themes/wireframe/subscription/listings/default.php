			...
			<div class="o-card o-card--ed-subscriptions">
				<div class="o-card__body l-stack">
					<div class="t-d--flex t-align-items--c">
						...
						<div class="t-ml--auto ">
							<div class="">
								<?php echo $this->html('form.boolean', 'sitewide', $isSiteActive, '', 'data-ed-subscribe-action data-id="' . $profile->id . '"' . 'data-subscribed="' . $isSiteActive . '"'); ?>
							</div>
						</div>
					</div>
				</div>
			...
			<div id="post" class="tab-pane <?php echo $filter == 'post' ? 'active' : '';?>" data-ed-list-wrapper>
				<div class="l-stack">
					...
					<div class="t-d--flex t-align-items--c">
						...
						<div>
							<a href="javascript:void(0);" class="o-btn o-btn--danger" data-ed-unsubscribe-all data-id="<?php echo $profile->id; ?>">
								<i class="far fa-bell-slash"></i>
								<?php echo JText::_('COM_EASYDISCUSS_BUTTON_UNSUBSCRIBE');?>
							</a>
						</div>
					</div>
					<?php } ?>
