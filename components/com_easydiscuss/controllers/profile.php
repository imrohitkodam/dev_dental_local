...
class EasyDiscussControllerProfile extends EasyDiscussController
{
	...
	public function saveProfile()
	{
		...
		if ($this->config->get('layout_user_details') && !$this->validateProfile($post)) {
		...
		if ($this->config->get('layout_user_details')) {
			// Set the name field.
		...
		if ($profile->store() && $userSaved) {
			...
			ED::history()->log('easydiscuss.update.profile', $this->my->id, 'COM_EASYDISCUSS_BADGES_HISTORY_UPDATED_PROFILE');
