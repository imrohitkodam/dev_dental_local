...
class EasyDiscussViewSubscription extends EasyDiscussView
{
	...
	/**
	 * Displays the delete all the post subscription confirmation dialog
	 *
	 * @since	5.0.9
	 * @access	public
	 */
	public function unsubscribeAllPostDialog()
	{
		...
		$namespace = 'site/subscription/dialogs/unsubscribe.allpost';
		$output = $theme->output($namespace);
