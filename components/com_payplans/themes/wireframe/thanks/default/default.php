					...
					<div class="pp-result-container">
						<div class="pp-result">
							<div class="pp-result__image">
								<?php echo PP::getAnimatedImageHtml('thankyou', '<img src="' . JURI::root() . 'media/com_payplans/images/pp-thankyou.png' . '" />', array('loop' => false)); ?>
							</div>
							...
							<div class="pp-result__action t-lg-mt--xl">
								<?php echo $this->fd->html('button.link', PPR::_('index.php?option=com_payplans&view=dashboard'), 'COM_PP_PROCEED_TO_DASHBOARD_BUTTON', 'primary'); ?>
							</div>
						</div>
					</div>
				</div>
