...
<div class="pp-access-alert">
	<div class="pp-access-alert__icon"><i class="fdi fas fa-lock"></i></div>
	...
	<div class="pp-access-alert__action">
		<?php echo $this->fd->html('button.link', PPR::_('index.php?option=com_payplans&view=plan'), 'COM_PP_VIEW_AVAILABLE_PLANS', 'primary'); ?>
	</div>
</div>