...
?>
<?php echo $this->renderHeader('COM_PAYPLANS_SUBSCRIPTION_MODERATION_REQUIRED_HEADING'); ?>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														<p>
															<?php echo JText::_('COM_PAYPLANS_SUBSCRIPTION_MODERATION_REQUIRED_CONTENT_' . ($this->isPreview() ? 'ADMIN' : $type));?>
														</p>
													</div>
												</td>
											</tr>
