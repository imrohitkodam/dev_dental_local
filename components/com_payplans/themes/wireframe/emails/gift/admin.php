...
?>
<?php echo $this->renderHeader('COM_PP_GIFT_EMAIL_HEADING', 'COM_PP_GIFT_EMAIL_HEADING_SUBTITLE'); ?>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														<p><?php echo JText::_("COM_PP_GIFT_EMAIL_CONTENTS"); ?></p>

														<div style="background: #f8f8f8;padding: 20px;">
															<?php if ($this->isPreview()) { ?>
																<?php for ($i = 1; $i <= 10; $i++) { ?>
																<code><b>CODE_EXAMPLE_<?php echo $i;?></b></code><br />
																<?php } ?>
															<?php } else { ?>
