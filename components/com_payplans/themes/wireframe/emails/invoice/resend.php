...
?>
<?php echo $this->renderHeader('COM_PP_INVOICE_AVAILABLE', 'COM_PP_EMAILS_INVOICE_READY_SUBHEADING'); ?>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														...
														<p>These contents will be replaced with the contents that was submitted when you try to resend the invoice to the customer.</p>
														<?php } else { ?>
