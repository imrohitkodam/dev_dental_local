...
class jMail_acy extends PHPMailer
{
	...
	function &Send()
	{
		...
		{
			return acymailing_raiseError(500, acymailing_translation('MAIL_FUNCTION_DISABLED') );
		}
	...
	function setSender($from)
	{
		...
		// If it is neither, we throw a warning
			...
			acymailing_raiseError(500, "JMail::  Invalid E-Mail Sender: $from", "JMail::setSender($from)");
		}
	}
	...
	function addReplyTo($replyto)
	{
        ...
        if (!is_array($replyto)) {
            ...
            parent::AddReplyTo($replyto0, '');
        } elseif (is_array($replyto[0])) {
