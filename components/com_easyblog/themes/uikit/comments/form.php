...
?>
<form class="xeb-comment-form xreset-form uk-margin-small-top uk-margin-small-bottom" method="post" action="<?php echo JRoute::_('index.php');?>" data-comment-form data-captcha="<?php echo $this->config->get('comment_captcha_type');?>">
	...
	<div class="uk-background-muted uk-padding uk-panel">
		<div class="eb-composer-author row-table">
			...
			<div class="col-cell">
				...
				<div class="text-small"><?php echo $date->format(JText::_('DATE_FORMAT_LC1'));?></div>
			</div>
		</div>
		...
		<div class="eb-comment-editor">
			...
			<div class="form-action">
				<button class="uk-button uk-button-primary" data-comment-submit><?php echo JText::_('COM_EASYBLOG_SUBMIT_COMMENT');?></button>
			</div>
		</div>
		<?php } ?>
