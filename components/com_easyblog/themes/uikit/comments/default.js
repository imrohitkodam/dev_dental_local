...
.done(function($) {
	...
	window.EasyBlogBBCodeSettings = {
		...
		markupSet: [
			...
			{separator:'---------------' },
			{name:'<?php echo JText::_('COM_EASYBLOG_BBCODE_URL', true);?>', key: 'L', openWith: '[url=[![Link:]!]]', closeWith: '[/url]', beforeInsert: function(h ) {},className: 'markitup-url'},
			...
			{name:'<?php echo JText::_('COM_EASYBLOG_BBCODE_LIST', true);?>', openWith:'[*] ', className:'markitup-list', multiline:true},
			{separator:'---------------' },
