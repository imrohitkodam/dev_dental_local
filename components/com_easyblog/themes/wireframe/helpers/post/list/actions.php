...
<div class="eb-post-actions text-muted">
	<?php if ($ratings && $this->config->get('main_ratings') && $params->get('post_ratings', true)) { ?>
	<div class="col-cell">
		<?php echo $this->html('post.ratings', $post, $this->config->get('main_ratings_frontpage_locked')); ?>
	</div>
	<?php } ?>

	<?php if ($hits && $params->get('post_hits', true)) { ?>
	<div class="col-cell">
		<?php echo $this->html('post.hits', $post, true); ?>
	</div>
	<?php } ?>

	<?php if ($comments && $post->getTotalComments() !== false && $params->get('post_comment_counter', true)) { ?>
	<div class="col-cell">
