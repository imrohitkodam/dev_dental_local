...
?>
<div class="eb-featured eb-featured--hero <?php echo $this->isMobile() ? 'is-mobile' : '';?>">
					...
					<div class="eb-gallery-box" style="background-image: url('<?php echo $post->coverImage;?>') !important;">
						<div class="eb-gallery-body">
							...
							<div class="eb-gallery-content">
								<span><?php echo $post->displayContent;?></span>
							</div>
							<?php } ?>

							<?php if ($postOption->date) { ?>
							<div class="eb-post-date">
								<b><time><?php echo $post->getDisplayDate($postOption->dateSource)->format(JText::_('DATE_FORMAT_LC1'));?></time></b>
							</div>
							<?php } ?>
						...
						<div class="swiper-slide">
							<div class="eb-gallery-slide-item ">
								<div class="eb-gallery-slide-item__img">
									<!--TODO -->
									<div class="eb-gallery-menu-thumb" style="background-image: url('<?php echo $post->coverImage;?>') !important;"></div>
