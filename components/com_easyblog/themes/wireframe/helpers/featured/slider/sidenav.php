...
?>
<div class="eb-featured eb-featured--sidenav <?php echo $this->isMobile() ? 'is-mobile' : '';?>">
	<div class="eb-gallery-stage" data-eb-slider data-autoplay="<?php echo $slider->autoplay;?>" data-interval="<?php echo $slider->autoplayInterval;?>" data-direction="vertical">
		<div class="row-table">
			...
			<div class="col-cell cell-tight eb-gallery-side">
				<div class="swiper-container gallery-thumbs swiper-container-vertical" data-thumbs data-free-mode="1" data-space-between="10" data-watch-slides-visibility="1" data-watch-slides-progress="1">
					<div class="swiper-wrapper">
					<?php $i = 0; ?>
					<?php foreach ($posts as $post) { ?>
