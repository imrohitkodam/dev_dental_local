...
?>
<div class="eb-mag eb-mag-list" data-blog-listings>
	<h6 class="eb-mag-header-title">
		<?php echo JText::_('COM_EASYBLOG_RECENT_NEWS'); ?>
	</h6>
	<div data-blog-posts>
		<?php if ($leadingArticle) { ?>
		<div class="eb-mag-post has-border" data-blog-posts-item data-id="<?php echo $leadingArticle->id;?>">
		...
		<?php if ($posts) { ?>
			...
			<div class="eb-mag-table" data-blog-posts-item data-id="<?php echo $post->id;?>">
