...
<?php echo $this->fd->html('email.heading', 'COM_EASYBLOG_MAIL_TEMPLATE_NEW_POST_HEADING', 'COM_EASYBLOG_MAIL_TEMPLATE_NEW_POST_SUBHEADING'); ?>

<?php echo $this->fd->html('email.content', 'COM_EASYBLOG_MAIL_TEMPLATE_NEW_POST_CONTENT', 'clear'); ?>
