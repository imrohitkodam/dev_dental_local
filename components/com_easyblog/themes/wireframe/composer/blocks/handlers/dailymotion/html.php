...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-dailymotion-form>
	<?php echo $this->html('composer.block.placeholder', 'icon-videos-dailymotion', 'COM_EASYBLOG_COMPOSER_BLOCKS_DAILYMOTION_PLACEHOLDER_TITLE', 'COM_EASYBLOG_COMPOSER_BLOCKS_DAILYMOTION_PLACEHOLDER_NOTE'); ?>
