...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-soundcloud-form>
	<?php echo $this->html('composer.block.placeholder', 'fdi fab fa-soundcloud', 'COM_EASYBLOG_COMPOSER_BLOCKS_SOUNDCLOUD'); ?>
...
<div class="eb-composer-placeholder eb-composer-video-placeholder text-center hidden" data-soundcloud-loader>
	<i class="fdi fa fa-sync fa-spin t-mr--sm"></i> <?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_SOUNDCLOUD_RETRIEVING_EMBEDDED_CODES');?>
</div>
