...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-gist-form>
	<?php echo $this->html('composer.block.placeholder', 'fdi fab fa-github-alt', 'COM_EASYBLOG_COMPOSER_BLOCKS_GIST_SHARE_GIST', 'COM_EASYBLOG_COMPOSER_BLOCKS_GIST_SHARE_GIST_NOTE'); ?>
