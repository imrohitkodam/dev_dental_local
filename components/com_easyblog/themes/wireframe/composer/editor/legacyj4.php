...
<?php if (!$templateEditor) { ?>
	...
	<?php } else { ?>
		<?php echo $editor->display('content', htmlspecialchars($post->renderEditorContent(), ENT_COMPAT, 'UTF-8'), '100%', '500', false, false, array('image', 'pagebreak','ninjazemanta'), null, 'com_easyblog'); ?>
	<?php } ?>
<?php } else { ?>
