			...
			<div class="col-sm-6 col-sm-offset-3 col-xs-12">
				<div class="panel panel-default br-0 mt-30">
					...
					<div class="panel-body text-center">
						...
						$pageContent = $dispatcher->trigger('getThankYouPageContent', array($this->course, $this->lesson, $this->item, $this->mediaLib, $this->testState, $this->state, $this->time_taken_format, $this->tjlmsparams));
				...
				?>
					<div class="panel-footer">
						<div class="row">
							...
							<div class="col-xs-12 text-center">
								<?php $link = Route::_('index.php?option=com_tmt&view=answersheet&tmpl=component&id=' . $this->item->id . '&ltId=' . $this->item->attempt['invite_id'] . '&candid_id=' . $this->item->attempt['user_id'] . '&course_id=' . $course_id, false); ?>
								<a class="btn btn-primary com_tmt_button br-0" onclick="openReviewButton('<?php echo $link;?>');return false;" target="_blank">
...
function openReviewButton(rlink)
{
	closeOldWindow();
