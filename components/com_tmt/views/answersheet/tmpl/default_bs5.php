...
HTMLHelper::_('bootstrap.modal', 'a.tjmodal');
												...
												switch ($q->type)
												{
													case "radio":
														...
														foreach($q->answers as $a)
														{
															...
															if(!empty($q->userAnswer) && in_array($a->id, $q->userAnswer))
															{
																$checked  = 'checked';
																$comments = $a->comments;
															}?>
															<div class="col-xs-12 col-md-6">
																<label class="radio input-label mb-20 d-block">
																	...
																	<?php
																		if(!empty($q->userAnswer) && in_array($a->id, $q->userAnswer) && $comments)
																			{ ?>
