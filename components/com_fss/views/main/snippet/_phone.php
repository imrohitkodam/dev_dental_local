		...
		<!--<div class="pull-left">
			<?php if ($item['icon'] && $this->hideicons == 0) : ?>
				<a href='<?php echo $this->getLink($item); ?>' class='pull-left' target='<?php echo $item['target']; ?>'>
					<img src='<?php echo JURI::base(); ?>images/fss/menu/<?php echo FSS_Helper::escape($item['icon']); ?>' width="32" height="32" />
				</a>
			<?php endif; ?>
		</div>-->
		<div class="media-body">
			<h4 class="media-heading">
				<a href='<?php echo $this->getLink($item); ?>' target='<?php echo $item['target']; ?>'>
					<?php if ($item['icon'] && $this->hideicons == 0) : ?>
						<img src='<?php echo JURI::base(); ?>images/fss/menu/<?php echo FSS_Helper::escape($item['icon']); ?>' width="24" height="24" />
					<?php endif; ?>
