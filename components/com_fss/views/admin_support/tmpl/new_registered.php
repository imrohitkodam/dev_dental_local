...
<form action="<?php echo FSSRoute::_('index.php?option=com_fss&view=ticket&layout=open&admincreate=1' . $extra); ?>" method="post" class="form-horizontal form-condensed">
	...
	<div class="control-group">
		...
		<div class="controls">
			<a id="pick_user" class="btn btn-default show_modal_iframe" href="<?php echo FSSRoute::_("index.php?option=com_fss&view=admin_support&layout=users&tmpl=component"); ?>" data_modal_width="1400">
