...
if (count($errors) > 0 && FSS_Settings::get('open_show_error_alert')): ?>

<div class="alert alert-danger fss_open_ticket_error_alert">
	<h4><?php echo JText::_('OPEN_TICKET_ERROR_HEADER'); ?></h4>
	<ul>
		<li>
			<?php echo implode("</li><li>", $errors); ?>
		</li>
	</ul>
	<?php echo JText::_('OPEN_TICKET_ERROR_FOOTER'); ?>
</div>
...
<?php if (FSS_Settings::get('support_user_attach')): ?>
	...
	<div class="form-horizontal form-condensed">
		<div class="control-group cg-upload <?php echo $this->errors['attach'] ? 'error' : ''; ?>">
