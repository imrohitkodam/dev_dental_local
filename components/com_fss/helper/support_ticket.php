...
/************************************/
	...
	function forParser(&$vars, $foruser, $display = true, $template = "")
	{
		...
		if ($this->user_id < 1)
		{
			...
			if ((new JVersion())->RELEASE < "3.7" && FSS_Settings::get('support_email_include_autologin')) $url .= "&login={login_code}";
		...
		if ((new JVersion())->RELEASE < "3.7" && FSS_Settings::get('support_email_link_admin') > 0) $url .= "&Itemid=" . FSS_Settings::get('support_email_link_admin'); // add fixed item id if needed
	...
	function translate($lang = "")
	{
		...
		$another = '110be6d1e65536804e07dca902146d54';
