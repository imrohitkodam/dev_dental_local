...
<div id="jfbc_loginregister" class="row-fluid">
    ...
    <div id="jfbc_loginregister_userinfo" class="<?php echo $this->displayType; ?>">
        <div id="jfbc_loginregister_existinguser" class="<?php echo $existingUserSpan;?>">
            <form action="" method="post" name="form" autocomplete="on">
                <fieldset>
                    ...
                    <dl>
                        ...
                        <dd><input type="text" class="input-medium" name="username" value="" size="20" autocomplete="username"/></dd>
                        <dt><label><?php echo JText::_('COM_JFBCONNECT_PASSWORD') ?> </label></dt>
                        <dd><input type="password" class="input-medium" name="password" value="" size="20"/></dd>
                        <dt></dt>
        ...
        <div id="jfbc_loginregister_newuser" class="<?php echo $newUserSpan;?>">
            <form action="" method="post" id="adminForm" class="form-validate" autocomplete="on">
    ...
    {
        $link = JFBConnectUtilities::getAffiliateLink($this->configModel->getSetting('affiliate_id'), EXT_JFBCONNECT);
        ?>
