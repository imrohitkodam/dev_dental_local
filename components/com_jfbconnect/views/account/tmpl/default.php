        ...
        {?>
            <tr>
                ...
                {?>
                    ...
                    <td><a href="<?php echo JURI::base(true).'/index.php?option=com_jfbconnect&task=account.unlink&provider='.$providerObj->provider->systemName.'&'. JSession::getFormToken() .'=1';?>"><?php echo JText::_('COM_JFBCONNECT_ACCOUNT_LINKED_ACCOUNTS_UNLINKED_LABEL');?></a></td>
                <?php }
                else
                {?>
