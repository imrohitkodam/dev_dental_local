...
(function (jQuery) {
    ...
    jQuery.contentbuilder = function (element, options) {
        ...
        var defaults = {
            ...
            onRender: function () { },
            onDrop: function () { },
            snippetFile: 'assets/htmlbuilder/assets/default/snippets.html',
            hiquality: false,
            snippetTool: 'right',
            snippetOpen: false,
            imageselect: '',
        ...
        this.init = function () {
            ...
            if (jQuery('#divSnippets').length == 0) {
                ...
                s += '';
                s += '<a id="lnkToolOpen" href="#"><i class="cb-icon-pencil"></i></a></div>';
                ...
                jQuery.get(this.settings.snippetFile, function (data) {
                    ...
                    jQuery('<div/>').html(data).children('div').each(function () {
                        ...
                        htmlThumbs += '<div title="Snippet ' + i + '" data-snip="' + i + '" id="snip' + i + '"><img src="' + jQuery(this).data("thumb") + '" /></div>';
                    ...
                    jQuery('#divSnippetList > div').draggable({
                        cursor: 'move',
                        helper: function () {
        ...
        this.html = function () {
            ...
            return jQuery('#temp-contentbuilder').html().trim();
        ...
        this.applyBehavior = function () {
            ...
            $element.contenteditor({ fileselect: fileselect, editable: selectable, colors: colors });
            ...
            $element.find('img').each(function () {
                ...
                jQuery(this).imageembed({ hiquality: hq, imageselect: imageselect, fileselect: fileselect });
                ...
                if (jQuery(this).parents('figure').length != 0) {
                    if (jQuery(this).parents('figure').find('figcaption').css('position') == 'absolute') {
                        jQuery(this).parents('figure').imageembed({ hiquality: hq, imageselect: imageselect, fileselect: fileselect });
                    }
                }
            ...
            $element.children("div").find('.row-html').click(function () {
                ...
                if($activeRow.data('mode')=='code'){ //Mode: code
                    ...
                    jQuery('#txtHtml').val(jQuery('#temp-contentbuilder').html().trim());
    ...
    jQuery.contenteditor = function (element, options) {
        ...
        this.init = function () {
            ...
            var html_rte = '<div id="rte-toolbar">' +
                        ...
                        '<a href="#" data-rte-cmd="bgcolor"> <i class="cb-icon-tint"></i> </a>' +
            ...
            console.log(this.settings.colors.length);
            ...
            $element.bind('keydown', function (e) { /* CTRL-V */
                ...
                if ((e.which == 86 && isCtrl == true) || (e.which == 86 && e.metaKey)) {
                    ...
                    jQuery(this).append("<div style='position:absolute;z-index:-1000;width:1px;height:1px;overflow:auto;' name='idContentWord' id='idContentWord' contenteditable='true'></div>");
        ...
        this.render = function () {
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="html"]').click(function (e) {
                ...
                jQuery('#temp-contenteditor').html($activeElement.html());

                if ($activeElement.attr('data-html')) {
                    jQuery('#temp-contenteditor').html($activeElement.attr('data-html')); // Addition: for script
                }

                jQuery('#temp-contenteditor').find('[contenteditable]').removeAttr('contenteditable');
                jQuery('#temp-contenteditor *[class=""]').removeAttr('class');
                jQuery('#temp-contenteditor *[style=""]').removeAttr('style');
                jQuery('#txtHtml').val(jQuery('#temp-contenteditor').html().trim());

                jQuery('#btnHtmlOk').unbind('click');
                jQuery('#btnHtmlOk').bind('click', function (e) {

                    if ($activeElement.html().indexOf('<script') != -1) {
                        $activeElement.attr('data-html', jQuery('#txtHtml').val()); // Addition: for script
                    }

                    $activeElement.html(jQuery('#txtHtml').val());
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="color"]').click(function (e) {
                ...
                jQuery('.md-pick').click(function(){
                    ...
                    //Cleanup FONTs
                    if($activeElement.find('font').length>0){
                        var $f = $activeElement.find('font:first');
                        var color = $f.attr('color');
                        $f.replaceWith('<span id="tmpSpan">' + $f.html() + '</span>');
                        jQuery('#tmpSpan').css('color',color);
                        jQuery('#tmpSpan').removeAttr('id');
                    }
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="bgcolor"]').unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="bgcolor"]').click(function (e) {
                /**** Custom Modal ****/
                jQuery('#md-color').css('max-width', '465px');
                jQuery('#md-color').simplemodal();
                jQuery('#md-color').data('simplemodal').show();
                ...
                jQuery('.md-pick').click(function(){
                    ...
                    if($activeElement.find('font').length>0){
                        ...
                        $f.replaceWith('<span id="tmpSpan">' + $f.html() + '</span>');
                        jQuery('#tmpSpan').css('background-color',color);
                        jQuery('#tmpSpan').removeAttr('id');
                    }
    ...
    jQuery.imageembed = function (element, options) {
        ...
        this.init = function () {
            ...
            $element.hover(function (e) {
                ...
                jQuery("#divToolImgSettings").css("top", (((p.top + parseInt(jQuery(this).css('height')) / 2) + adjH) * zoom) - 40 + adjy_val + "px");
                ...
                if(browserok){
                    //Chrome 37, Opera 24
                    _top = ((offsettop + parseInt(jQuery(this).css('height')) / 2) - 30) * zoom  + (scrolltop - scrolltop * zoom) ;
                    _left = ((offsetleft + parseInt(jQuery(this).css('width')) / 2) - 30) * zoom;
                    _top2 = _top - 40;
                } else {
                    if(is_ie){
                        //IE 11 (Adjustment required)
                        ...
                        var p = jQuery(this).getPos();
                        _top = ((p.top - 30 + parseInt(jQuery(this).css('height')) / 2)) * zoom + adjy_val;
                        _left = ((p.left - 30 + parseInt(jQuery(this).css('width')) / 2)) * zoom + adjx_val;
                        _top2 = _top - 40;
