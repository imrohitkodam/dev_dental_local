...
function SCORMapi1_2() {
    ...
    var datamodel =  {
        ...
        'cmi.core.lesson_status':{'defaultvalue':'completed', 'format':CMIStatus, 'mod':'rw', 'writeerror':'405'},
   ...
   this.connectPrereqCallback = {
        ...
        failure: function(o) {
            ...
            var sURL = "http://172.132.45.81/moodle" + "/mod/scorm/prereqs.php?a=6&scoid=19&attempt=1&mode=&currentorg=&sesskey=TtTrQZH6Ml";
    ...
    function StoreData(data,storetotaltime) {
        ...
        //alert('going to:' + "http://172.132.45.81/moodle/mod/scorm/datamodel.php" + "id=0&a=6&sesskey=TtTrQZH6Ml"+datastring);
        result = DoRequest(myRequest,"http://172.132.45.81/moodle/mod/scorm/datamodel.php","id=0&a=6&sesskey=TtTrQZH6Ml"+datastring);
