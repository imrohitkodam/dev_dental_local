...
class TjlmsModelCertificates extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->join('LEFT', '#__tjlms_courses AS cs ON cs.id = ct.course_id');
		...
		// Filter course type
		$query->where('UPPER(ct.type) = "COURSE"');
	...
	public function getItems()
	{
		...
		foreach ($items as &$item)
		{
			...
			$item->disp_time_spent = $this->comtjlmsHelper->secToHours($item->time_spent);
		}
