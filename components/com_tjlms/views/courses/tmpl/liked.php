	...
	<form name="adminForm" id="adminForm" class="form-validate" method="post">
		<div class="row-fluid tjlms_courses_head ">
			<div class="tjlms_head_title pull-left">
				<h3><?php echo (!empty($defaultclass))? JText::_("COM_TJLMS_YOUR_LIKED_COURSES"): JText::_("COM_TJLMS_YOUR_LIKED_COURSES"). ' : ' .$active_cat; ?></h3>
			</div>

			<!-- show categoties menu bar on top of the courses while seeing in tablet or phone-->
			<div class="tjlms_category_menu pull-right hidden-desktop">
				<img alt="course_info" src="<?php echo JUri::root(true).'/media/com_tjlms/images/default/icons/menu.png'; ?>" />
				<div class="tjlms_category_menu_items">
			...
			<div class="span9 tjlms-courses">
				...
				if ($this->menuparams->get('layout_to_load','pin','STRING') == 'pin')
				{
					...
					foreach($courses as $data)
					{
						// converting to array
						$data = (array)$data;
						$courseImg	= $this->tjlmsCoursesHelper->getCourseImage($data, $this->course_images_size);
