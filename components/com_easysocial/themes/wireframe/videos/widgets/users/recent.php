...
<div class="es-widget widget-videos">
	<div class="es-widget-head">
		...
		<?php if (!empty($videos)) { ?>
		<a class="fd-small pull-right" href="<?php echo FRoute::videos(array('uid' => $user->getAlias(), 'type' => SOCIAL_TYPE_USER));?>"><?php echo JText::_('APP_VIDEOS_PROFILE_WIDGET_VIEW_ALL');?></a>
		<?php } ?>
	</div>
