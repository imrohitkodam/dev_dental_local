...
<dialog>
	...
	<title><?php echo JText::_($filter->id ? 'COM_ES_EDITING_FILTER' : 'COM_EASYSOCIAL_VIDEOS_CUSTOM_FILTER_HEADER'); ?></title>
	<content>
		<form method="post" action="<?php echo JRoute::_('index.php');?>" class="es-forms" data-es-filter-form>
			<div class="es-forms__group">
				<div class="es-forms__content">
					<div class="es-stream-filter-content">
						<p class="t-lg-mb--xl t-lg-mt--xl"><?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CUSTOM_FILTER_DESC'); ?></p>
						...
						<div class="o-form-group" data-title style="margin-top: 30px;">
							<input type="text" name="title" class="o-form-control"
								placeholder="<?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CUSTOM_FILTER_TITLE_PLACEHOLDER', true); ?>"
								value="<?php echo $this->html('string.escape', $filter->title); ?>"
							/>

							<div class="help-block text-note" data-notice><?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CUSTOM_FILTER_TITLE_DESC'); ?></div>
						</div>
						...
						<div class="o-form-group" data-hashtag>
							<input type="text" name="hashtag" value="<?php echo $filter->getHashTag(true); ?>" class="o-form-control"
								placeholder="<?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CUSTOM_FILTER_HASHTAG_PLACEHOLDER', true ); ?>"
							/>

							<div class="help-block text-note" data-notice><?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CUSTOM_FILTER_HASHTAG_DESC'); ?></div>
						</div>
			...
			<?php echo $this->html('form.hidden', 'filterType', 'videos'); ?>
