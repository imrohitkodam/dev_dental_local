                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="video-category" name="category_id" class="form-control input-sm">
                                    ...
                                    <option value="<?php echo $category->id;?>"<?php echo $video->category_id == $category->id || $defaultCategory == $category->id ? ' selected="selected"' : '';?>><?php echo JText::_($category->title);?></option>
                                    <?php } ?>
                                </select>
