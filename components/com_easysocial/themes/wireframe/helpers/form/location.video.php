...
<div class="es-locations <?php echo $classname; ?>" <?php echo $selectorName; ?> data-language="<?php echo ES::user()->getLocationLanguage(); ?>">
	<div id="map" class="es-location-map <?php echo 'is-' . $this->config->get('location.provider'); ?> <?php echo $hasLocationClass; ?>" data-location-map>
		<div>
	...
	<div class="es-location-form">
		<div class="es-location-textbox">
			<input type="text" class="input-sm form-control" name="location" value="<?php echo $location->address; ?>" placeholder="<?php echo JText::_('COM_EASYSOCIAL_WHERE_ARE_YOU_NOW'); ?>" autocomplete="off" data-location-textField disabled />
	...
	<input type="hidden" name="latitude" data-location-lat value="<?php echo $location->latitude; ?>" />
	<input type="hidden" name="longitude" data-location-lng value="<?php echo $location->longitude; ?>" />
</div>
