...
<div class="es-search-group__item o-grid">
	<div class="o-grid__cell">
		...
		<div class="o-flag__body">
			...
			<ul class="g-list-inline g-list-inline--dashed t-text--muted">
                ...
                <li>
                    <i class="fa fa-users"></i>&nbsp; <?php echo JText::sprintf(ES::string()->computeNoun('COM_EASYSOCIAL_EVENTS_TOTAL_MEMBERS', $item->getTotalMembers()), $item->getTotalMembers() ); ?>
                </li>
                <li>
                    <i class="fa fa-calendar"></i>&nbsp; <?php echo $item->getStartEndDisplay(); ?>
                </li>
			</ul>
		</div>
	</div>
	...
	<div class="o-grid__cell o-grid__cell--auto-size">
		<?php echo $this->html('event.action', $item); ?>
	</div>
</div>
