	...
	<div class="es-stream-repost__meta">
		<div class="es-stream-repost__meta-inner">
			<div class="es-stream-repost__heading t-text--muted t-lg-mb--md">
				<i class="fa fa-retweet"></i>&nbsp; <?php echo JText::sprintf('COM_EASYSOCIAL_REPOSTED_FROM', $sourceActor ? $this->html('html.cluster', $sourceActor) : $this->html('html.user', $video->user_id));?>
			</div>

			<?php echo $this->includeTemplate('site/streams/videos/preview'); ?>
		</div>
	</div>
</div>
