...
<?php if ($customFilter) { ?>
	...
	<div class="es-snackbar2">
		...
		<div class="es-snackbar2__actions">
			<a href="javascript:void(0);" class="btn btn-sm btn-es-default-o" data-marketplace-create-filter data-id="<?php echo $customFilter->id; ?>" data-cluster-type="<?php echo $type; ?>" data-uid="<?php echo $uid; ?>" >
...
<?php } else { ?>
	...
	<div class="es-snackbar2">
		<div class="es-snackbar2__context">
			<div class="es-snackbar2__title">
				<?php echo JText::_('COM_ES_MARKETPLACES_PENDING_TITLE');?>
			</div>
		</div>
	</div>
	<p class="pending-info"><?php echo JText::_('COM_ES_MARKETPLACES_PENDING_INFO');?></p>
	<?php } else { ?>
		...
		<div class="es-snackbar2">
			<div class="es-snackbar2__context">
				<div class="es-snackbar2__title">
					<?php echo JText::_("COM_ES_MARKETPLACES_FEATURED_LISTINGS");?>
				</div>
			</div>

			<?php if ((isset($featuredListingsLink) && $featuredListingsLink)) { ?>
			<div class="es-snackbar2__actions">
				<a href="<?php echo $featuredListingsLink; ?>" class="btn btn-sm btn-es-default-o">
		...
		<div class="es-snackbar2">
			<div class="es-snackbar2__context">
				<div class="es-snackbar2__title">
					<?php echo JText::_("COM_ES_LISTINGS");?>
				</div>
			</div>
