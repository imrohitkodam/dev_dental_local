		...
		<div class="es-forms">
			<div class="es-forms__group">
				<div class="es-forms__content">
					<p><?php echo JText::_('COM_ES_MARKETPLACES_SELECT_CATEGORY_INFO');?></p>
					...
					<div class="es-create-category-select" data-es-items-container>
						<?php foreach ($categories as $category) { ?>
							<?php echo $this->loadTemplate('site/marketplaces/create/category.item', array('category' => $category, 'backId' => $backId, 'profileId' => $profileId, 'categoryRouteBaseOptions' => $categoryRouteBaseOptions)) ?>
						<?php } ?>
					</div>
				</div>
			</div>
