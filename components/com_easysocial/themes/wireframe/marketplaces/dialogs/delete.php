...
<dialog>
	...
	<title><?php echo JText::_('COM_ES_MARKETPLACES_DIALOG_DELETE_LISTING_TITLE'); ?></title>
	<content>
		<p><?php echo JText::sprintf('COM_ES_MARKETPLACES_DIALOG_DELETE_LISTING_CONTENT', $listing->getTitle());?></p>
