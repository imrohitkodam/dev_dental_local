...
<dialog>
	...
	<content>
		<form name="approveUser" method="post" action="index.php" data-approve-event-form>
		...
		<div class="o-checkbox t-lg-mt--xl">
			<input type="checkbox" id="sendConfirmationMail" class="mr-5" checked="checked" name="sendMail" value="1" />
		...
		<input type="hidden" name="task" value="approveEventHasRecurringData" />
