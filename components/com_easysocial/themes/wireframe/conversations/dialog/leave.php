...
<dialog>
	...
	<content>
		<form name="leave-conversation-form" method="post" data-conversation-leave-form>
			<p><?php echo JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_LEAVE_DIALOG_CONFIRMATION' );?></p>
	...
	<buttons>
		...
		<button data-confirm-button type="button" class="btn btn-es-danger btn-sm">
			<?php echo JText::_('COM_EASYSOCIAL_LEAVE_CONVERSATION_BUTTON'); ?>
		</button>
	</buttons>
</dialog>
