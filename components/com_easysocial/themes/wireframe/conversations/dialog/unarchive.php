...
<dialog>
	...
	<title><?php echo JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_UNARCHIVE_DIALOG_TITLE' ); ?></title>
	<content>
		<form data-conversation-archive-form action="<?php echo JRoute::_( 'index.php' );?>" method="post">
			<p><?php echo JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_UNARCHIVE_DIALOG_CONFIRMATION' ); ?></p>
			<input type="hidden" name="id" value="<?php echo $id;?>" />
			<input type="hidden" name="option" value="com_easysocial" />
			<input type="hidden" name="task" value="unarchive" />
	...
	<buttons>
		...
		<button data-archive-button type="button" class="btn btn-es-primary btn-sm"><?php echo JText::_('COM_EASYSOCIAL_YES_UNARCHIVE_BUTTON'); ?></button>
	</buttons>
</dialog>
