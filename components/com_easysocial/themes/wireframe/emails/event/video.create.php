		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_EVENT_NEW_VIDEO'); ?></h1>
				</td>
			</tr>
		</table>
	</td>
					...
					<table role="presentation" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;">
						...
						<tr>
							<td>
								...
								<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_EVENT_NEW_VIDEO_BY', '<a href="' . $userLink . '" style="text-decoration: underline;color:#00aeef;">' . $userName . '</a>'); ?>
							</td>
						</tr>
						<tr>
							<td>
