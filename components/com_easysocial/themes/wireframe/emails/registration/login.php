						...
						<tr>
							<td valign="top" width="100%">
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 24px;" class="stack-column">
									<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_REGISTRATION_THANK_YOU_FOR_REGISTERING_COMPLETED' , $site ); ?>
								</p>
							</td>
						</tr>
					</table>
								...
								<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
									<tr>
										<td style="padding: 5px 0;">
											<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_USERNAME' ); ?>: <strong><?php echo $username;?></strong>
										</td>
									</tr>
									<?php if ($password) { ?>
									<tr>
										<td style="padding: 5px 0;">
											<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_PASSWORD' ); ?>: <strong><?php echo $password;?></strong>
										</td>
									</tr>
									<?php } ?>
								</table>
