        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td style="padding: 24px; text-align: left;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;">
                    	<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_STREAM_NEW_POST_MODERATION', $item); ?>
                    </h1>
                </td>
            </tr>
        </table>
                                        ...
                                        <tr>
                                            <td style="padding: 5px 0;">
                                                <p style="line-height: 1.5;margin: 0; padding:0 0 24px;" class="stack-column">
                                                	<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_STREAM_NEW_POST_MODERATION_CONTENT','<a href="' . $pageLink . '">' . $item . '</a>');?>
                                                </p>
                                            </td>
                                        </tr>
