		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px 24px 10px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_('COM_ES_EMAILS_MARKETPLACE_APPROVED_HEADING'); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_('COM_ES_EMAILS_MARKETPLACE_APPROVED_SUBHEADING'); ?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<tr>
							<td valign="top" width="100%">
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 24px;" class="stack-column">
									<?php echo JText::sprintf( 'COM_ES_EMAILS_MARKETPLACE_APPROVED_CONTENT' , '<span style="color:#00aeef;">' . $title . '</span>' );?>
								</p>
							</td>
						</tr>
					</table>
							...
							<tr>
								...
								<td valign="middle" style="padding: 0 16px;">
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										...
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $listingUrl;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_( 'COM_ES_EMAILS_MARKETPLACE_VIEW_LISTING' ); ?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
