		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px 24px 10px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_('COM_ES_EMAILS_MARKETPLACE_REJECTED_HEADING'); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_('COM_ES_EMAILS_MARKETPLACE_REJECTED_SUBHEADING'); ?></h1>
				</td>
			</tr>
		</table>
	</td>
				...
				<td bgcolor="#f6f9fb" align="center" style="padding: 24px;">
						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf('COM_ES_EMAILS_MARKETPLACE_REJECTED_CONTENT' , $title); ?>
								</p>
							</td>
						</tr>
					</table>
					<table role="presentation" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;">
						<tr>
							<td>
								<?php if(!empty($reason)){ ?>
									<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;" class="stack-column">
										<?php echo JText::_('COM_ES_EMAILS_MARKETPLACE_REJECTED_REASON'); ?>
									</p>
