...
<div class="es-container">
    <div class="es-snackbar">
        <h1 class="es-snackbar__title"><?php echo JText::_('COM_EASYSOCIAL_GROUPS_SELECT_CATEGORY');?></h1>
    </div>
    ...
    <div class="es-create-category-select">
        ...
        <div class="btn-wrap">
            <a class="btn btn-es" href="<?php echo ESR::groups(array('controller' => 'groups' , 'task' => 'selectCategory' , 'category_id' => $category->id));?>">
