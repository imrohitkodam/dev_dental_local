...
<div class="es-group-category">
	...
	<div class="es-container t-lg-mt--xl" data-es-groups-category data-es-container>
		...
		<div data-filter-item data-type="groupcategory" data-id="<?php echo $category->id;?>" class="active"></div>
		...
		<div class="es-content">
			<?php echo $this->html('html.snackbar', 'COM_EASYSOCIAL_GROUPS_RECENT_UPDATES'); ?>
