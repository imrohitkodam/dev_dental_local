...
<dialog>
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DIALOG_PUBLISH_EVENT_TITLE'); ?></title>
    <content>
        <p><?php echo JText::sprintf('COM_EASYSOCIAL_EVENTS_DIALOG_PUBLISH_EVENT_CONTENT', $event->getName());?></p>
