...
$(document)
	...
	.on('click.notes.create', '[data-notes-create]', function() {
		var wrapper = $(this).parents('[data-app-notes]');
		var appId = wrapper.data('app-id');
			...
			"bindings": {
				"{createButton} click" : function() {
					EasySocial.ajax('apps/user/notes/controllers/notes/store', {
						...
						$.buildHTML(item).prependTo(wrapper.find('[data-notes-list]'));
...
$(document)
	...
	.on('click.notes.edit', '[data-notes-item] [data-edit]', function() {
		var button = $(this);
		var wrapper = button.parents('[data-app-notes]');
