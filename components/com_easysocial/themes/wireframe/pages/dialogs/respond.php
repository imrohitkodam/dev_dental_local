...
<dialog>
	...
	<title><?php echo JText::sprintf('COM_EASYSOCIAL_PAGES_DIALOG_RESPOND_TITLE', $page->getName()); ?></title>
	<content>
		<p class="mt-5">
			<img src="<?php echo $page->getAvatar();?>" class="ml-5 es-avatar" align="right" />

			<?php echo JText::sprintf('COM_EASYSOCIAL_PAGES_DIALOG_RESPOND_CONTENT', $inviter->getName(), $page->getName());?>
		</p>
