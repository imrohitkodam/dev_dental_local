...
?>
	...
	<?php
		...
		{
			?>
			<div class="col-xs-12 col-sm-3 col-md-2 eventFilter__ht mb-10">
				<div>
					<?php echo JHtml::_('select.genericlist', $this->cat_options, "filter_events_cat", 'class="form-control" size="1" onchange="this.form.submit();"
