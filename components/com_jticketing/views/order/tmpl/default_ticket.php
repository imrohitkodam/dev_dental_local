...
<div class="ticket-list">
	<?php
		foreach ($this->ticketTypeData as $key => $ticketType)
		{
		    ...
		    {
			?>
				<div class="mb-15 box-shadow bg-white p-15">
					<div class="row">
						<div class="col-xxs-12 col-xs-5 text-left py-5">
							...
							<?php
								...
								{
									?>
							<div class="label label-info br-10">
								<?php echo Text::sprintf('COM_JTICKETING_TICKET_TYPE_REMAINING_SEATS_COUNT', $ticketType->count); ?>
							</div>
							<?php } ?>
						</div>
						<div class="col-xxs-6 col-xs-3 py-5">
							<div
								class="super_number<?php echo $ticketType->id; ?> jt-ticket-buttons float-left">
								<button id="decr<?php echo $ticketType->id; ?>"
									class="removeItem ui attached button float-left pt-5"
								...
								<button id="incr<?php echo $ticketType->id; ?>"
									class="addItem ui attached button float-right pt-15 pl-20"
									data-order-id="<?php echo $this->order->id;?>"
						...
						<div class="col-xxs-6 col-xs-4 text-right py-5">
