...
class DB
{
    ...
    {
        $string = "\n" . (string) $query;
        $string = str_replace('#__', self::get()->getPrefix(), $string);
    ...
    {
        return self::get()->escape($text, $extra);
    }
    ...
    public static function getTableColumns(string $table, bool $typeOnly = \true): array
    {
        ...
        return $cache->set(self::get()->getTableColumns($table, $typeOnly));
    }
