 ...
 * @since  11.1
 */
class XTF0FDatabaseQuerySqlsrv extends XTF0FDatabaseQuery implements XTF0FDatabaseQueryLimitable
{
    /**
    ...
    public function __toString()
    {
        ...
        switch ($this->type) {
            case 'select':
                ...
                if ($this instanceof XTF0FDatabaseQueryLimitable && ($this->limit > 0 || $this->offset > 0)) {
