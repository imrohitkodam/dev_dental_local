 ...
 * @since    2.1
 */
interface XTF0FPlatformInterface
{
    /**
     ...
     * lowest order will be picked by XTF0FPlatform.
     *
     * @return bool
     */
    ...
    /**
     * By default XTF0F will only use the Controller's onBefore* methods to
    ...
    /**
     * Perform an ACL check. Please note that XTF0F uses by default the Joomla!
     ...
     * XTF0F defaults using fof.xml or by specialising the controller.
     *
     ...
     * may also return null and XTF0F will a. try to figure out the output type by
     * examining the "format" input parameter (or fall back to "html") and b.
     * XTF0F will not attempt to load CSS and Javascript files (as it doesn't make
     ...
     *
     * @deprecated Use PHP's version_compare against JVERSION in your code. This method is scheduled for removal in XTF0F 3.0
     *
     * @return bool
     */
