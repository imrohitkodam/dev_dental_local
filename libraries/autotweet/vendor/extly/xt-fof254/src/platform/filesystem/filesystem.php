...
abstract class XTF0FPlatformFilesystem implements XTF0FPlatformFilesystemInterface
{
    /**
    ...
    protected static function getFiles($path, array $ignoreFolders = [], array $ignoreFiles = [])
    {
        ...
        foreach ($files as $file) {
            ...
            $return[] = [
                'fullpath'  => $file,
                'classname' => 'XTF0FPlatform'.ucfirst($parts[0]).ucfirst(basename($parts[1], '.php')),
            ];
        }
