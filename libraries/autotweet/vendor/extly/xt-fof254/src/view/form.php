 ...
 * @since    2.0
 */
class XTF0FViewForm extends XTF0FViewHtml
{
    public $item;

    /** @var XTF0FForm The form to render */
    protected $form;
    ...
    public function display($tpl = null)
    {
        ...
        $basePath = XTF0FPlatform::getInstance()->isBackend() ? 'admin:' : 'site:';
    ...
    /**
     * Returns the HTML rendering of the XTF0FForm attached to this view. Very
    ...
    public function getRenderedForm()
    {
        ...
        if ($xtf0FRenderAbstract instanceof XTF0FRenderAbstract) {
            ...
            // Get the form's HTML
            $html = $xtf0FRenderAbstract->renderForm($this->form, $this->getModel(), $this->input);
        }
