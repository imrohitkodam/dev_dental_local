...
/**
 * An interface for XTF0FFormHeader fields, used to define the filters and the
 * elements of the header row in repeatable (browse) views
 *
 * @since    2.0
 */
abstract class XTF0FFormHeader
{
    /**
    ...
    /**
     * The XTF0FForm object of the form attached to the header field.
     *
     * @var XTF0FForm
     *
     * @since  2.0
     ...
     *
     * @param XTF0FForm $form the form to attach to the form field object
     *
     * @since   2.0
     */
    public function __construct(XTF0FForm $form = null)
    {
    ...
    /**
     * Method to attach a XTF0FForm object to the field.
     *
    ...
    public function setup(SimpleXMLElement $element, $value, $group = null)
    {
        ...
        if ('header' != (string) $element->getName()) {
            return false;
        }
     ...
     *
     * @param XTF0FForm $form the JForm object to attach to the form field
     *
     * @return XTF0FFormHeader the form field object so that the method can be used in a chain
     *
     * @since   2.0
     */
    public function setForm(XTF0FForm $form)
    {
        $this->form = $form;
    ...
    protected function getLabel()
    {
        ...
        if (empty($title)) {
            ...
            $title = $params['option'].'_'.
                XTF0FInflector::pluralize($params['view']).'_FIELD_'.
     ...
     *
     * @return bool True if it's sortable
     */
