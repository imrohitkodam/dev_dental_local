 ...
 * @since    2.0
 */
class XTF0FFormFieldModel extends XTF0FFormFieldList implements XTF0FFormField
{
    protected $static;
    ...
    public function getRepeatable()
    {
        ...
        $value = XTF0FFormFieldList::getOptionName($this->getOptions(), $this->value);
        ...
        $value = $format_string === '' || $format_string === '0' ? htmlspecialchars($value, \ENT_COMPAT, 'UTF-8') : sprintf($format_string, $value);
