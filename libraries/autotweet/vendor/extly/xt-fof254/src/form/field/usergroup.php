 ...
 * @since    2.0
 */
class XTF0FFormFieldUsergroup extends JFormFieldUsergroup implements XTF0FFormField
{
    ...
    public function getStatic()
    {
        ...
        $xtf0FDatabaseQuery->from('#__usergroups AS a');
        $xtf0FDatabaseQuery->group('a.id, a.title');
        $xtf0FDatabaseQuery->order('a.id ASC');
