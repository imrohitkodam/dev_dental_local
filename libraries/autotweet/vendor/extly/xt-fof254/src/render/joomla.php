 ...
 * @since    2.0
 */
class XTF0FRenderJoomla extends XTF0FRenderAbstract
{
    /**
    ...
    public function preRender($view, $task, $input, $config = [])
    {
        ...
        echo '<div id="xt-container" class="'.implode(' ', $classes)."\">\n";
...
JS;
    ...
    protected function renderButtons($view, $task, $input, $config = [])
    {
        ...
        echo '<div id="XTF0FHeaderHolder">', $bar_content, $title, '<div style="clear:both"></div>', '</div>';
    }
}
