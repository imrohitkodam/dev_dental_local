...
namespace XTS_BUILD\Buzz\Message;

use XTS_BUILD\Buzz\Exception\InvalidArgumentException;
use XTS_BUILD\Http\Message\ResponseFactory as HTTPlugResponseFactory;
use XTS_BUILD\Psr\Http\Message\ResponseFactoryInterface as PsrResponseFactory;
