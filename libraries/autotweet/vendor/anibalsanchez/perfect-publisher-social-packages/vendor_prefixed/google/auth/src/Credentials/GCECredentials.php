...
namespace XTS_BUILD\Google\Auth\Credentials;

use XTS_BUILD\Google\Auth\CredentialsLoader;
use XTS_BUILD\Google\Auth\GetQuotaProjectInterface;
use XTS_BUILD\Google\Auth\HttpHandler\HttpClientCache;
use XTS_BUILD\Google\Auth\HttpHandler\HttpHandlerFactory;
use XTS_BUILD\Google\Auth\Iam;
use XTS_BUILD\Google\Auth\IamSignerTrait;
use XTS_BUILD\Google\Auth\ProjectIdProviderInterface;
use XTS_BUILD\Google\Auth\SignBlobInterface;
use XTS_BUILD\GuzzleHttp\Exception\ClientException;
use XTS_BUILD\GuzzleHttp\Exception\ConnectException;
use XTS_BUILD\GuzzleHttp\Exception\RequestException;
use XTS_BUILD\GuzzleHttp\Exception\ServerException;
use XTS_BUILD\GuzzleHttp\Psr7\Request;
