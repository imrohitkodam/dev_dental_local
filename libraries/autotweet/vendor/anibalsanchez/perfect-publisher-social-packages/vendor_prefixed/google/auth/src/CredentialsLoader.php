...
use XTS_BUILD\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use XTS_BUILD\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(
        ...
        $stack = \XTS_BUILD\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \XTS_BUILD\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
