...
namespace XTS_BUILD\Google\Auth;

use DomainException;
use XTS_BUILD\Google\Auth\Credentials\AppIdentityCredentials;
use XTS_BUILD\Google\Auth\Credentials\GCECredentials;
...
use XTS_BUILD\Google\Auth\Middleware\AuthTokenMiddleware;
use XTS_BUILD\Google\Auth\Middleware\ProxyAuthTokenMiddleware;
use XTS_BUILD\Google\Auth\Subscriber\AuthTokenSubscriber;
use XTS_BUILD\GuzzleHttp\Client;
