...
use XTS_BUILD\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use XTS_BUILD\GuzzleHttp\Promise\Promise;
use XTS_BUILD\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('XTS_BUILD\GuzzleHttp\Promise\Promise')) {
