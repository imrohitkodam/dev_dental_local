...
namespace XTS_BUILD\Google\Http;

use XTS_BUILD\Google\Auth\HttpHandler\HttpHandlerFactory;
use XTS_BUILD\Google\Service\Exception as GoogleServiceException;
use XTS_BUILD\Google\Task\Runner;
use XTS_BUILD\GuzzleHttp\ClientInterface;
use XTS_BUILD\GuzzleHttp\Exception\RequestException;
use XTS_BUILD\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (
                interface_exists('\XTS_BUILD\GuzzleHttp\Message\ResponseInterface')
                && $response instanceof \XTS_BUILD\GuzzleHttp\Message\ResponseInterface
            ) {
