...
namespace XTS_BUILD\Google;

use BadMethodCallException;
use DomainException;
use XTS_BUILD\Google\AccessToken\Revoke;
use XTS_BUILD\Google\AccessToken\Verify;
use XTS_BUILD\Google\Auth\ApplicationDefaultCredentials;
use XTS_BUILD\Google\Auth\Cache\MemoryCacheItemPool;
use XTS_BUILD\Google\Auth\Credentials\ServiceAccountCredentials;
use XTS_BUILD\Google\Auth\Credentials\UserRefreshCredentials;
use XTS_BUILD\Google\Auth\CredentialsLoader;
use XTS_BUILD\Google\Auth\FetchAuthTokenCache;
use XTS_BUILD\Google\Auth\HttpHandler\HttpHandlerFactory;
use XTS_BUILD\Google\Auth\OAuth2;
use XTS_BUILD\Google\AuthHandler\AuthHandlerFactory;
use XTS_BUILD\Google\Http\REST;
use XTS_BUILD\GuzzleHttp\Client as GuzzleClient;
use XTS_BUILD\GuzzleHttp\ClientInterface;
use XTS_BUILD\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use XTS_BUILD\Monolog\Handler\StreamHandler as MonologStreamHandler;
use XTS_BUILD\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use XTS_BUILD\Monolog\Logger;
use XTS_BUILD\Psr\Cache\CacheItemPoolInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (defined('\XTS_BUILD\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('\XTS_BUILD\GuzzleHttp\ClientInterface::VERSION')) {
