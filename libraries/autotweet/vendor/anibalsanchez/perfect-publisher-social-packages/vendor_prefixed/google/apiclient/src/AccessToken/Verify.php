...
namespace XTS_BUILD\Google\AccessToken;

use DateTime;
use DomainException;
use Exception;
use ExpiredException;
use XTS_BUILD\Firebase\JWT\ExpiredException as ExpiredExceptionV3;
...
use XTS_BUILD\Google\Exception as GoogleException;
    ...
    */
    ...
    private function getJwtService()
    {
        ...
        if (class_exists('\Firebase\JWT\JWT')) {
            $jwtClass = 'XTS_BUILD\Firebase\JWT\JWT';
        }
