...
namespace XTS_BUILD\League\OAuth2\Client\Provider;

use XTS_BUILD\GuzzleHttp\Client as HttpClient;
use XTS_BUILD\GuzzleHttp\ClientInterface as HttpClientInterface;
use XTS_BUILD\GuzzleHttp\Exception\BadResponseException;
use XTS_BUILD\GuzzleHttp\Exception\GuzzleException;
use InvalidArgumentException;
use XTS_BUILD\League\OAuth2\Client\Grant\AbstractGrant;
use XTS_BUILD\League\OAuth2\Client\Grant\GrantFactory;
use XTS_BUILD\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use XTS_BUILD\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
use XTS_BUILD\League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use XTS_BUILD\League\OAuth2\Client\Token\AccessToken;
use XTS_BUILD\League\OAuth2\Client\Token\AccessTokenInterface;
use XTS_BUILD\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use XTS_BUILD\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use XTS_BUILD\League\OAuth2\Client\Tool\QueryBuilderTrait;
use XTS_BUILD\League\OAuth2\Client\Tool\RequestFactory;
