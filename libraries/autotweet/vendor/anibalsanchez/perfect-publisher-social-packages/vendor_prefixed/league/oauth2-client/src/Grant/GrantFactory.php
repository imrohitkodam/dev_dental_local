...
namespace XTS_BUILD\League\OAuth2\Client\Grant;

use XTS_BUILD\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'XTS_BUILD\\League\\OAuth2\\Client\\Grant\\' . $class;
