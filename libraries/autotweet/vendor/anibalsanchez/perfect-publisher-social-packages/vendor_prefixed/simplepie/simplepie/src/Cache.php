 ...
 * via {@see register()}
 *
 * @deprecated since SimplePie 1.8.0, use "XTS_BUILD\SimplePie\SimplePie::set_cache()" instead
 */
class Cache
{
    /**
    ...
    public static function get_handler(string $location, string $filename, $extension)
    {
        ...
        return new \XTS_BUILD\SimplePie\Cache\File($location, $filename, $extension);
    }
...
class_alias('SimplePie\Cache', 'XTS_SimplePie_Cache');
