...
class IRI
{
    ...
    public function set_host(?string $ihost)
    {
        if ($ihost === null) {
            ...
            if (\XTS_BUILD\SimplePie\Net\IPv6::check_ipv6(substr($ihost, 1, -1))) {
                $this->ihost = '[' . \XTS_BUILD\SimplePie\Net\IPv6::compress(substr($ihost, 1, -1)) . ']';
            } else {
                $this->ihost = null;
                return false;
            }
...
class_alias('XTS_BUILD\SimplePie\IRI', 'XTS_SimplePie_IRI');
