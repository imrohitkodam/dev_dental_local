 ...
 */
namespace XTS_BUILD\SecurityLib;
...
abstract class BigMath {
    ...
    public static function createFromServerConfiguration() {
        ...
        if (extension_loaded('gmp')) {
            return new \XTS_BUILD\SecurityLib\BigMath\GMP();
        } elseif (extension_loaded('bcmath')) {
            return new \XTS_BUILD\SecurityLib\BigMath\BCMath();
        } else {
            return new \XTS_BUILD\SecurityLib\BigMath\PHPMath();
        }
