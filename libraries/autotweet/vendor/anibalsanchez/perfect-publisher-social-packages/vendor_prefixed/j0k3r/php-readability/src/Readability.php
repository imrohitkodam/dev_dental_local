...
namespace XTS_BUILD\Readability;

use XTS_BUILD\Masterminds\HTML5;
use XTS_BUILD\Psr\Log\LoggerAwareInterface;
...
class Readability implements LoggerAwareInterface
{
    ...
    private function loadHtml()
    {
        ...
        $this->dom->registerNodeClass('DOMElement', 'XTS_BUILD\Readability\JSLikeHTMLElement');
    }
