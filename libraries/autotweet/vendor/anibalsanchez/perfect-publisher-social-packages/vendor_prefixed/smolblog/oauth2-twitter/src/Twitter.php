...
use XTS_BUILD\League\OAuth2\Client\Provider\AbstractProvider;
...
use XTS_BUILD\League\OAuth2\Client\Tool\BearerAuthorizationTrait;
use XTS_BUILD\Psr\Http\Message\RequestInterface;
use XTS_BUILD\Psr\Http\Message\ResponseInterface;
use XTS_BUILD\RandomLib\Factory as RandomLibFactory;
