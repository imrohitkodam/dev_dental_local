...
namespace XTS_BUILD\Smolblog\OAuth2\Client\Test\Provider;
...
use XTS_BUILD\Smolblog\OAuth2\Client\Provider\Twitter as TwitterProvider;
   ...
   */
    ...
    public function testErrorResponse(): void
    {
      ...
      "detail": "Unauthorized"
        ...
        $stream = $this->createMock('XTS_BUILD\GuzzleHttp\Psr7\Stream');
        $stream->method('__toString')->willReturn($error_json);

        $response = $this->createMock('XTS_BUILD\GuzzleHttp\Psr7\Response');
