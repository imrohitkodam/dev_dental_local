...
use XTS_BUILD\Http\Discovery\Exception\ClassInstantiationFailedException;
use XTS_BUILD\Http\Discovery\Exception\DiscoveryFailedException;
use XTS_BUILD\Http\Discovery\Exception\NoCandidateFoundException;
use XTS_BUILD\Http\Discovery\Exception\StrategyUnavailableException;
use XTS_BUILD\Http\Discovery\Strategy\DiscoveryStrategy;
