...
use XTS_BUILD\GuzzleHttp\Client as GuzzleHttp;
use XTS_BUILD\GuzzleHttp\Promise\Promise;
use XTS_BUILD\GuzzleHttp\Psr7\Request as GuzzleRequest;
use XTS_BUILD\Http\Adapter\Artax\Client as Artax;
use XTS_BUILD\Http\Adapter\Buzz\Client as Buzz;
use XTS_BUILD\Http\Adapter\Cake\Client as Cake;
use XTS_BUILD\Http\Adapter\Guzzle5\Client as Guzzle5;
use XTS_BUILD\Http\Adapter\Guzzle6\Client as Guzzle6;
use XTS_BUILD\Http\Adapter\Guzzle7\Client as Guzzle7;
use XTS_BUILD\Http\Adapter\React\Client as React;
use XTS_BUILD\Http\Client\Curl\Client as Curl;
use XTS_BUILD\Http\Client\HttpAsyncClient;
use XTS_BUILD\Http\Client\HttpClient;
use XTS_BUILD\Http\Client\Socket\Client as Socket;
use XTS_BUILD\Http\Discovery\ClassDiscovery;
use XTS_BUILD\Http\Discovery\Exception\NotFoundException;
use XTS_BUILD\Http\Discovery\Psr17FactoryDiscovery;
use XTS_BUILD\Http\Message\MessageFactory;
use XTS_BUILD\Http\Message\MessageFactory\DiactorosMessageFactory;
use XTS_BUILD\Http\Message\MessageFactory\GuzzleMessageFactory;
use XTS_BUILD\Http\Message\MessageFactory\SlimMessageFactory;
use XTS_BUILD\Http\Message\StreamFactory;
use XTS_BUILD\Http\Message\StreamFactory\DiactorosStreamFactory;
use XTS_BUILD\Http\Message\StreamFactory\GuzzleStreamFactory;
use XTS_BUILD\Http\Message\StreamFactory\SlimStreamFactory;
use XTS_BUILD\Http\Message\UriFactory;
use XTS_BUILD\Http\Message\UriFactory\DiactorosUriFactory;
use XTS_BUILD\Http\Message\UriFactory\GuzzleUriFactory;
use XTS_BUILD\Http\Message\UriFactory\SlimUriFactory;
use Laminas\Diactoros\Request as DiactorosRequest;
use XTS_BUILD\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use XTS_BUILD\Psr\Http\Client\ClientInterface as Psr18Client;
use XTS_BUILD\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return defined('XTS_BUILD\GuzzleHttp\ClientInterface::MAJOR_VERSION');
    }
