...
namespace XTS_BUILD\Http\Discovery\Composer;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = [
        'php-http/async-client-implementation' => [
            'XTS_BUILD\Http\Client\HttpAsyncClient',
        ],
        'php-http/client-implementation' => [
            'XTS_BUILD\Http\Client\HttpClient',
        ],
        'psr/http-client-implementation' => [
            'XTS_BUILD\Psr\Http\Client\ClientInterface',
        ],
        'psr/http-factory-implementation' => [
            'XTS_BUILD\Psr\Http\Message\RequestFactoryInterface',
            'XTS_BUILD\Psr\Http\Message\ResponseFactoryInterface',
            'XTS_BUILD\Psr\Http\Message\ServerRequestFactoryInterface',
            'XTS_BUILD\Psr\Http\Message\StreamFactoryInterface',
            'XTS_BUILD\Psr\Http\Message\UploadedFileFactoryInterface',
            'XTS_BUILD\Psr\Http\Message\UriFactoryInterface',
        ],
    ];
