...
class GeneratorStringTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $source1 = $this->getMock('XTS_BUILD\RandomLib\Source');
        ...
        $source2 = $this->getMock('XTS_BUILD\RandomLib\Source');
        ...
        $this->mixer = $this->getMock('XTS_BUILD\RandomLib\Mixer');
    ...
    public function testScheme($schemeName, $expected, $scheme = 0)
    {
        ...
        if (!$scheme) {
            $scheme = constant("XTS_BUILD\RandomLib\Generator::$schemeName");
        }
