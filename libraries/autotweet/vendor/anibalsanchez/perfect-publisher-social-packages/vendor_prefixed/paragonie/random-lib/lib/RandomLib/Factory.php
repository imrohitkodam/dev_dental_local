 ...
 * @author     Paragon Initiative Enterprises <security@paragonie.com>
 */
class Factory extends \XTS_BUILD\SecurityLib\AbstractFactory
{
     ...
     */
    public function getGenerator(\XTS_BUILD\SecurityLib\Strength $strength)
    {
     ...
     */
    protected function findSources(\XTS_BUILD\SecurityLib\Strength $strength)
    {
     ...
     */
    protected function findMixer(\XTS_BUILD\SecurityLib\Strength $strength)
    {
