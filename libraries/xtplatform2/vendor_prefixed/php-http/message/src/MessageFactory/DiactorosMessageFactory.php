...
if (!interface_exists(MessageFactory::class)) {
    throw new \LogicException('You cannot use "XTP_BUILD\Http\Message\MessageFactory\DiactorosMessageFactory" as the "php-http/message-factory" package is not installed. Try running "composer require php-http/message-factory". Note that this package is deprecated, use "psr/http-factory" instead');
}
