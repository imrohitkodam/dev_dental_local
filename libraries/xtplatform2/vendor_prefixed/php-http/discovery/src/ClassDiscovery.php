...
use XTP_BUILD\Http\Discovery\Exception\ClassInstantiationFailedException;
use XTP_BUILD\Http\Discovery\Exception\DiscoveryFailedException;
use XTP_BUILD\Http\Discovery\Exception\NoCandidateFoundException;
use XTP_BUILD\Http\Discovery\Exception\StrategyUnavailableException;
use XTP_BUILD\Http\Discovery\Strategy\DiscoveryStrategy;
