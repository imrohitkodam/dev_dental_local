...
namespace XTP_BUILD\Http\Discovery\Composer;
...
use XTP_BUILD\Http\Discovery\ClassDiscovery;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = [
        'php-http/async-client-implementation' => [
            'XTP_BUILD\Http\Client\HttpAsyncClient',
        ],
        'php-http/client-implementation' => [
            'XTP_BUILD\Http\Client\HttpClient',
        ],
        'psr/http-client-implementation' => [
            'XTP_BUILD\Psr\Http\Client\ClientInterface',
        ],
        'psr/http-factory-implementation' => [
            'XTP_BUILD\Psr\Http\Message\RequestFactoryInterface',
            'XTP_BUILD\Psr\Http\Message\ResponseFactoryInterface',
            'XTP_BUILD\Psr\Http\Message\ServerRequestFactoryInterface',
            'XTP_BUILD\Psr\Http\Message\StreamFactoryInterface',
            'XTP_BUILD\Psr\Http\Message\UploadedFileFactoryInterface',
            'XTP_BUILD\Psr\Http\Message\UriFactoryInterface',
        ],
    ];
