...
$courseImg = $tjlmsCoursesHelper->getCourseImage($data, 'S_');
	...
	<div class="thumbnail">
		...
		<div class="caption center">
			<a href="<?php echo  $course_url; ?>">
				<img class=' img-rounded tjlms_pin_image' src="<?php echo $courseImg;?>" alt="<?php echo  JText::_('TJLMS_IMG_NOT_FOUND') ?>" title="<?php echo $this->escape($courseName); ?>" />
			</a>
		</div>
...
<script>
	techjoomla.jQuery(window).load(function () {
			if (window.matchMedia('(max-width: 800px)').matches){
			 ...
			 techjoomla.jQuery('.tjlms_pin_info .span6').removeClass('textleft');
		   }
