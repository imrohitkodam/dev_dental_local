...
techjoomla.jQuery(window).load(function () {
	...
	techjoomla.jQuery("object").css("height",height-50);
	techjoomla.jQuery("object").css("width",'100%');
...
<style>
	...
	.tjlms-lesson-content #playlist-container.playlist-hidden {
		position:absolute;
		z-index:2;
	}
	.tjlms-lesson-content #lesson-main-container.expanded {
		width:100%;
	}
</style>
...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV; ?>">
	...
	<?php
		...
		$course_entry_file = JURI::base().'index.php?option=com_tjlms&view=lesson&layout=loadsco&lesson_id='.$this->lesson_id.'&mode='. $this->mode .'&'.$append_var;
	?>
