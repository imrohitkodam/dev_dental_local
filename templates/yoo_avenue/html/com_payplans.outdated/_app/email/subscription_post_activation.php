		...
		<table class="fontlist" id='shadow' align="center" bgcolor="#f8f8f8" border="0" cellpadding="0" cellspacing="0" width="650">
			...
			<tr>
				<td  bgcolor="f8f8f8">
					...
					We very much hope that you are happy with the service we are providing at [[CONFIG_SITE_NAME]]. <br><br>
					...
					<p style="padding:10px; margin-left:15px;">Please remember that should you have any questions you are welcome to ocntact us via our support section at <a href="[[CONFIG_SITE_URL]]" class="links">[[CONFIG_SITE_URL]]</a> or by telephone (+44(0)20 8299 9742)<br></p>
