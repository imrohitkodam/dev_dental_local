		...
		<table class="fontlist" id='shadow' align="center" bgcolor="#f8f8f8" border="0" cellpadding="0" cellspacing="0" width="650">
			...
			<tr>
				<td  bgcolor="f8f8f8">
					...
					Please note that your subscription [[PLAN_TITLE]] at [[CONFIG_SITE_NAME]] will shortly to expire on [[SUBSCRIPTION_EXPIRATION_DATE]]. Please ensure that you complete the course by then or renew.<br><br>
					...
					<p align="center"><a target="_blank" style="text-decoration:none; color:lightgreen"  href="[[CONFIG_PLAN_RENEW_URL]]"><input value="Renew Here" style="padding:10px;border:5px black;background-color:#2B6EAD;color:white; border-radius:5px;" align="right" type="button"></a>
										...
										<p style="padding:10px; margin-left:15px;">Should you have any questions you are welcome to ocntact us via our support section at <a href="[[CONFIG_SITE_URL]]" class="links">[[CONFIG_SITE_URL]]</a> or by telephone (+44(0)20 8299 9742)<br></p>
