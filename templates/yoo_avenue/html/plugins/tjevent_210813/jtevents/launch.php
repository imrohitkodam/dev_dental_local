...
<div>
	<i class="countdown-container counters" aria-hidden="true">
	</i>

	<span class="text-info font-bold startevent<?php echo $mediaDetails->source; ?> pr-10 tj_hide_btn">
		<?php echo JText::_("PLG_TJEVENT_JTEVENTS_EVENT_STARTSIN");?>
	</span>

	<span class="text-danger font-bold endevent<?php echo $mediaDetails->source; ?> pr-10 tj_hide_btn">
		<?php echo JText::_("PLG_TJEVENT_JTEVENTS_EVENT_ENDSIN");?>
	</span>

	<span class="text-danger font-bold event-ended<?php echo $mediaDetails->source; ?> tj_hide_btn">
		<?php echo JText::_("PLG_TJEVENT_JTEVENTS_EVENT_ENDED");?>
	</span>

	<span class="countertime">
		<span id='countdown_timer<?php echo $mediaDetails->source; ?>'></span>
		<span class="text-success" id='reverse_timer<?php echo $mediaDetails->source; ?>'></span>
	</span>
...
<script>
	...
	jQuery(document).on("click", "#enroll_button<?php echo $mediaDetails->source; ?>,#jt-enterMeeting<?php echo $mediaDetails->source; ?>", function(){
		if(checkifuserenroled == 1 || cid == creator)
		{
	...
	showLabels(currentDate,startDate,endDate);
