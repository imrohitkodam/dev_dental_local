...
<?php foreach ($modules_data as $module_data)
{
	...
	<div class="tjlms_toc__lesson-title <?php echo $lessonTitleClass; ?>">
		...
		{
		?>
			<span><img style="height: 25px;" title="Required to obtain a certificate." src="<?php echo Uri::root(true).'/templates/yoo_avenue/images/certificate.png';?>"></span>
		<?php 
		}
		?>
	...
	{
		$btnTitle = Text::_("COM_TJLMS_CONTINUE");
		?>
		<div class="row mt-10">
