	...
	<div class="row after-enroll">
		<div class="col-xs-12 mt-10 mb-20 pd-0">
			...
			<div class="course-lesson-progress row">
				...
				{
					// Dental override - start
					if ($this->moduleData['currentLesson']->format == "event")
					{
						?>
						<button type="button" class="btn un-btn-primary un-big-btn"
							id = "enroll_button<?php echo $this->moduleData['currentLesson']->source; ?>">
							<?php echo Text::_("COM_TJLMS_COURSEPROGRESS_COURSE_CONTINUE");?>
							</button>
						<?php
					} // Dental override - end
					else
