<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/theme/config/theme.json
...
return [
  'defaults' => [
    ...
    'header' => [
      ...
      'width' => 'default', 
      'search_layout' => 'input-dropdown', 
      'search_dropdown.stretch' => 'navbar', 
      'search_dropdown.size' => true, 
      'search_icon' => 'left', 
      'social_gap' => 'small'
    ], 
    'navbar' => [
