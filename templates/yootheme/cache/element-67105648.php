<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/map/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['type', 'zoom', 'fit_bounds', 'controls', 'poi', 'zooming', 'dragging', 'min_zoom', 'max_zoom', [
                ...
                ], 'viewport_height_offset_top', 'height', 'width', 'width_breakpoint', 'text_color']
            ], [
              'label' => 'Style', 
