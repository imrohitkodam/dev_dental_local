<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/grid/element.json
...
return [
  ...
  'fields' => [
    ...
    'css' => [
      ...
      'attrs' => [
        'debounce' => 500, 
        'hints' => ['.el-element', '.el-nav', '.el-item', '.el-title', '.el-meta', '.el-content', '.el-image', '.el-link', '.el-hover-image']
      ]
    ], 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_link', 'panel_link_hover', 'panel_padding', 'panel_image_no_padding', 'item_maxwidth', 'panel_content_width', 'panel_expand']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
