<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/video/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => ['video', [
            ...
            ], 'video_title', 'video_controls', 'video_loop', 'video_muted', 'video_playsinline', 'video_lazyload', 'video_autoplay', 'video_poster']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Video', 
