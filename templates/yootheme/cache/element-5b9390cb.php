<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/panel-slider_item/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['title', 'meta', 'content', 'image', 'video', 'image_alt', 'icon', 'link', 'link_text', 'link_aria_label', 'hover_image', 'hover_video']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Panel', 
