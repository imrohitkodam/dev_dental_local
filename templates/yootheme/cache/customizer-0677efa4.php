<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/theme-joomla/config/customizer.json
  ...
  'panels' => [
    ...
    'advanced' => [
      'fields' => [
        ...
        'com_finder_filter' => [
          'label' => 'Search Filter', 
          'description' => 'Select the smart search filter.', 
          'type' => 'select', 
          'options' => [[
              'text' => 'None', 
              'value' => ''
            ], [
              'evaluate' => 'yootheme.builder[\'com_finder.filters\']'
            ]]
        ], 
        'bootstrap' => [
          'label' => 'System Assets', 
