<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/panel/element.json
...
return [
  ...
  'fields' => [
    ...
    'panel_link_hover' => [
      ...
      'enable' => 'link && panel_link && $match(panel_style, \'card-(default|primary|secondary)|tile-\')'
    ], 
    'panel_padding' => [
      'label' => 'Padding', 
    ...
    'css' => [
      ...
      'attrs' => [
        'debounce' => 500, 
        'hints' => ['.el-element', '.el-title', '.el-meta', '.el-content', '.el-image', '.el-link', '.el-hover-image']
      ]
    ], 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['title', 'meta', 'content', 'image', 'video', [
              'description' => 'Setting just one value preserves the original proportions. The image will be resized and cropped automatically, and where possible, high resolution images will be auto-generated.', 
              'name' => '_image_dimension', 
              'type' => 'grid', 
              'width' => '1-2', 
              'fields' => ['image_width', 'image_height']
            ], 'image_alt', 'icon', 'link', 'link_target', 'link_text', 'link_aria_label', 'hover_image', 'hover_video']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Panel', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_link', 'panel_link_hover', 'panel_padding', 'panel_image_no_padding', 'height_expand', 'panel_expand', 'html_element']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
