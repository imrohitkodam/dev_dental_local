<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/grid_item/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['title', 'meta', 'content', 'image', 'video', 'image_alt', 'icon', 'link', 'link_text', 'link_aria_label', 'hover_image', 'hover_video', 'tags']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Panel', 
