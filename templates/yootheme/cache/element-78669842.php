<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/overlay-slider_item/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['image', 'video', '_media', 'video_title', 'image_alt', 'title', 'meta', 'content', 'link', 'link_text', 'link_aria_label', 'hover_image', 'hover_video']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Item', 
