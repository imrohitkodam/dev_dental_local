<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/panel-slider/element.json
...
return [
  ...
  'fields' => [
    ...
    'panel_link_hover' => [
      ...
      'enable' => 'show_link && panel_link && $match(panel_style, \'card-(default|primary|secondary)|tile-\')'
    ], 
    'panel_padding' => [
      'label' => 'Padding', 
    ...
    'css' => [
      ...
      'attrs' => [
        'debounce' => 500, 
        'hints' => ['.el-element', '.el-item', '.el-nav', '.el-slidenav', '.el-title', '.el-meta', '.el-content', '.el-image', '.el-link', '.el-hover-image']
      ]
    ], 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['content', 'show_title', 'show_meta', 'show_content', 'show_image', 'show_video', 'show_link', 'show_hover_image', 'show_hover_video']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Slider', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['slider_width', 'height_expand', 'slider_gap', 'slider_divider']
            ], [
              'label' => 'Item Width', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['nav', 'nav_align', 'nav_margin', 'nav_breakpoint']
            ], [
              'label' => 'Slidenav', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_card_offset', 'panel_link', 'panel_link_hover', 'panel_padding', 'panel_image_no_padding', 'panel_match', 'panel_expand']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
