<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/gallery/element.json
...
return [
  ...
  'fields' => [
    ...
    'lightbox_video_autoplay' => [
      ...
      'description' => 'Enable autoplay or play a muted inline video without controls.', 
      'type' => 'select', 
      'options' => [
        'None' => '', 
        'Autoplay' => 'true', 
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'fields' => ['lightbox', 'lightbox_controls', 'lightbox_counter', 'lightbox_bg_close', 'lightbox_animation', 'lightbox_nav', [
                ...
                ], 'lightbox_image_orientation', 'lightbox_video_autoplay', 'lightbox_text_color', 'title_display', 'content_display']
            ], [
              'label' => 'Item', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['image_expand', 'overlay_link', 'item_maxwidth']
            ], [
              'label' => 'Overlay', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['overlay_mode', 'overlay_hover', 'overlay_transition_background', 'overlay_style', 'overlay_position', 'overlay_margin', 'overlay_padding', 'content_expand', 'overlay_maxwidth', 'text_color', 'text_color_hover', 'text_blend', 'overlay_transition']
            ], [
              'label' => 'Image', 
              'type' => 'group', 
              'divider' => true, 
