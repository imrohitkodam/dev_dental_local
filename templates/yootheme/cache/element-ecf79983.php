<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/overlay/element.json
...
return [
  ...
  'fields' => [
    ...
    'video_title' => [
      'label' => 'Video Title', 
      'source' => true, 
      'show' => 'video && $match(video, \'(youtube\\.com|youtube-nocookie\\.com|youtu\\.be|vimeo\\.com)\', \'i\')'
    ], 
    'image_width' => [
      'label' => 'Width', 
      'type' => 'number', 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['image', 'video', '_media', 'video_title', [
              'description' => 'Setting just one value preserves the original proportions. The image will be resized and cropped automatically, and where possible, high resolution images will be auto-generated.', 
              'name' => '_image_dimension', 
              'type' => 'grid', 
              'width' => '1-2', 
              'fields' => ['image_width', 'image_height']
            ], 'image_alt', 'title', 'meta', 'content', 'link', 'link_target', 'link_text', 'link_aria_label', 'hover_image', 'hover_video']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Container', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['height_expand', 'overlay_link', 'html_element']
            ], [
              'label' => 'Overlay', 
              'type' => 'group', 
              'divider' => true, 
