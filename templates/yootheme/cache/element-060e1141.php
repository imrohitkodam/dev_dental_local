<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/builder/elements/column/element.json
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'title' => 'Settings', 
          'fields' => ['vertical_align', 'style', 'preserve_color', 'text_color', 'padding', 'html_element', 'position_sticky', 'position_blend', [
            ...
            ], 'position_sticky_breakpoint', 'prevent_collapse']
        ], [
          'title' => 'Advanced', 
