<?php // $file = /home/customer/www/dev.dental-channel.co.uk/public_html/templates/yootheme/packages/theme-joomla-modules/config/modules.json
...
return [
  'fields' => [
    ...
    'style' => [
      ...
      'show' => '!$match(this.position, \'^(toolbar-(left|right)|(logo|navbar|header|dialog)(-mobile)?|debug)$\')'
    ], 
    'title_style' => [
      'label' => 'Title Style', 
      ...
      'show' => '!$match(this.position, \'^(toolbar-(left|right)|(logo|navbar|header)(-mobile)?|debug)$\')'
    ], 
    'title_decoration' => [
    ...
    'text_align_breakpoint' => [
      ...
      'show' => '!$match(this.position, \'^(toolbar-(left|right)|(logo|navbar|header)(-mobile)?|debug)$\') && text_align && text_align != \'justify\''
    ], 
    'text_align_fallback' => [
      ...
      'show' => '!$match(this.position, \'^(toolbar-(left|right)|(logo|navbar|header)(-mobile)?|debug)$\') && text_align && text_align != \'justify\' && text_align_breakpoint'
    ], 
    'width' => [
      'label' => 'Width', 
    ...
    'list_style' => [
      ...
      'show' => '$match(this.type, \'articles_(archive|categories|latest|popular)|tags_(popular|similar)\')'
    ], 
    'link_style' => [
      'label' => 'Link Style', 
