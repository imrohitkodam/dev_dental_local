...
/**
 * AutotweetControllerBloggerChannels.
 *
 * @since       1.0
 */
class AutotweetControllerBloggerChannels extends ExtlyController
{
    /**
     * getCallbackUrl.
     *
    ...
    public function callback()
    {
        ...
        */
        ...
        try {
            ...
            $bloggercode = $this->input->getString('code');

            // Error throw
            if (!empty($bloggercode)) {
                ...
                $bloggerChannelHelper->authenticate($bloggercode);
