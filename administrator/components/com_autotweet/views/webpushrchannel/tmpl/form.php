...
echo JText::_('COM_AUTOTWEET_CHANNEL_WEBPUSHR_PUSH_DESC');

?>
<hr>

<div class="control-group">
    <label class="required control-label" for="rest_api_key" id="rest_api_key-lbl">REST API Key <span class="star">&#160;*</span></label>
    <div class="controls">
...
<div class="control-group">
    <label class="required control-label" for="rest_authentication_token" id="rest_authentication_token-lbl">REST API Authentication Token <span class="star">&#160;*</span></label>
    <div class="controls">
        <input type="password" autocomplete="off" maxlength="255" value="<?php
        echo $this->item->xtform->get('rest_authentication_token'); ?>" id="rest_authentication_token" name="xtform[rest_authentication_token]" class="required" required="required">
    </div>
</div>

<div class="control-group">
    <label class="control-label"> <a class="btn btn-info" id="webpushrvalidationbutton"><?php
