        ...
        <div class="xt-grid">
            <div class="xt-col-span-12">
                ...
                <form name="adminForm" id="adminForm" action="index.php" method="post">
                    ...
                    <input type="hidden" name="view" id="view" value="feeds" />
                    ...
                    <table class="table adminlist table-striped" id="itemsList">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo JHTML::_('grid.sort', 'COM_AUTOTWEET_VIEW_FEED_NAME_TITLE', 'name', $this->lists->order_Dir, $this->lists->order, 'browse'); ?>
                                </th>

                                <th><?php echo JHTML::_('grid.sort', 'COM_AUTOTWEET_VIEW_FEED_URL_TITLE', 'name', $this->lists->order_Dir, $this->lists->order, 'browse'); ?>
                                </th>
                            ...
                            <tr>
                                ...
                                <td class="form-inline nowrap">
                                    <div class="xt-input-append">
                                        <input type="text" name="name" id="name" value="<?php echo $this->escape($this->getModel()->getState('name')); ?>" class="input-medium" onchange="document.adminForm.submit();"
                                            placeholder="<?php echo JText::_('COM_AUTOTWEET_VIEW_FEED_NAME_TITLE'); ?>" />
                                ...
                                <td><?php echo SelectControlHelper::contenttypes($this->getModel()->getState('contenttype'), 'contenttype', ['onchange' => 'this.form.submit();', 'class' => 'input-medium']); ?>
                                </td>
                                <?php
                                if (false === (bool) $hasAjaxOrderingSupport) {
                                    ?>
                                ...
                                ?>
                                <td><?php echo EHtmlSelect::yesNo($this->getModel()->getState('published', 1), 'published', ['onchange-submit' => 'true', 'class' => 'btn-mini']); ?>
                                </td>
...
<?php
                                ...
                                echo JRoute::_('index.php?option=com_autotweet&view=feeds&task=edit&id='.(int) $item->id); ?>"> <?php
                                ...
                                echo '<a href="'.$item->xtform->get('url').'" target="_blank">';
                                    ...
                                    echo ' <i class="xticon fas fa-globe"></i></a>'; ?>
                                </td>

                                <td><span class="content-type-<?php

                                $contenttype_id = $item->xtform->get('contenttype_id');
                                    echo $contenttype_id; ?>"></span> <?php echo $contenttype_id ? SelectControlHelper::getContenttypesName($contenttype_id) : '&mdash;'; ?>
                                </td>
                                <?php
                                if (false === (bool) $hasAjaxOrderingSupport) {
                                    ?>
