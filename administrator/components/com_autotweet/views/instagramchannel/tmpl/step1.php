...
echo '<input type="hidden" id="fb_api_perms_instagram" name="xtform[fb_api_perms_instagram]" value="1">';
...
echo '<input type="hidden" id="fb_perms_instagram_detail" name="fb_perms_instagram_detail" value="'.FacebookApp::PERMS_API_INSTAGRAM.'">';
