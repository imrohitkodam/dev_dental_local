...
?>
<form action="index.php?option=com_edocman&view=users" method="post" name="adminForm" id="adminForm">
	<table width="100%">
	<tr>
		<td align="left">
			<label for="filter_search"><?php echo JText::_('EDOCMAN_FILTER'); ?></label>
