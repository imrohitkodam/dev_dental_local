...
<table class="table table-striped">
	...
	<tr>
		<th>
			<?php echo JText::_('EDOCMAN_LASTEST_DOCUMENTS'); ?>
		</th>
		<th>
			<?php echo JText::_('EDOCMAN_DATE_ADDED'); ?>
		</th>
	</tr>
    </thead>
    <tbody>
	...
	{
		for ($i = 0, $n = count($this->latestDocuments); $i < $n; $i++) 
		{
			$row = $this->latestDocuments[$i];
			...
			<tr>
				...
				<td>
					<?php echo JHtml::_('date', $row->created_time, JText::_('DATE_FORMAT_LC2')); ?>
				</td>
			</tr>
	<?php
		}
