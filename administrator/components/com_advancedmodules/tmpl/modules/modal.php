...
$editor    = RL_Input::getCmd('editor');
$link      = 'index.php?option=com_advancedmodules&view=modules&layout=modal&tmpl=component&' . Session::getFormToken() . '=1';
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <th scope="row" class="has-context">
                                <button type="button"
                                        class="js-module-insert btn btn-sm btn-success w-100" <?php echo $attrs1; ?>>
                            ...
                            <td class="small d-none d-md-table-cell">
                                <?php if ($item->position) : ?>
                                    <button type="button"
                                            class="js-position-insert btn btn-sm btn-warning w-100" <?php echo $attrs2; ?>><?php echo $this->escape($item->position); ?></button>
                                <?php else : ?>
