...
$function = RL_Input::getCmd('function');
    ...
    <div class="new-modules">
        ...
        <div class="main-card card-columns p-4" id="comModulesSelectResultsContainer">
            <?php foreach ($this->items as &$item) : ?>
                ...
                <?php $link = 'index.php?option=com_advancedmodules&task=module.add&client_id=' . $this->state->get('client_id', 0) . $this->modalLink . '&eid=' . $item->extension_id; ?>
