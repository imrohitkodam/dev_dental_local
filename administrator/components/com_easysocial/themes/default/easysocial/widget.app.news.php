...
<div class="panel widget-app-news" data-widget-app-news>
	<div class="panel-head row-table">
		...
		<div class="col-cell text-right">
			<a href="https://stackideas.com/apps" class="btn btn-sm btn-es-primary" target="_blank"><i class="fa fa-shopping-cart"></i>&nbsp; <?php echo JText::_( 'COM_EASYSOCIAL_APPS_BROWSER' );?></a>
		</div>
	</div>
