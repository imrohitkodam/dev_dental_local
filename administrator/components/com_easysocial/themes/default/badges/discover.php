...
<div class="row">
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-head">
				<b><?php echo JText::_( 'COM_EASYSOCIAL_BADGES_INSTALL_SCAN' );?></b>
				<p><?php echo JText::_( 'COM_EASYSOCIAL_BADGES_INSTALL_SCAN_DESC' );?></p>
			</div>
	...
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-head">
				<b><?php echo JText::_( 'COM_EASYSOCIAL_BADGES_DISCOVERY_RESULT' );?></b>
			</div>

			<div class="panel-body">
				<div class="es-progress-wrap">
					<div class="t-hidden" data-progress>
