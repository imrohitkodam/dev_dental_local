			...
			<thead>
				<tr>
					...
					<th width="15%" class="center">
						<?php echo JText::_('COM_ES_TABLE_COLUMN_INSTALLED'); ?>
					</th>
					<th width="10%" class="center">
						<?php echo JText::_('COM_ES_TABLE_COLUMN_INSTALLED_VERSION'); ?>
					</th>
					<th width="10%" class="center">
						<?php echo JText::_('COM_ES_TABLE_COLUMN_LATEST_VERSION'); ?>
					</th>
					<th width="10%">
						<?php echo JText::_('COM_ES_TABLE_COLUMN_ELEMENT'); ?>
					</th>
				</tr>
			</thead>
			<tbody>
				<?php if ($modules) { ?>
					...
					<tr>
						<td class="center">
							<?php echo $this->html('grid.id', $i, $module->id); ?>
						</td>
						<td>
						...
						<td class="center">
							<?php if ($module->state == SOCIAL_LANGUAGES_INSTALLED) { ?>
							<span class="t-text--success">
								<b><?php echo JText::_('Installed'); ?></b>
							</span>
							<?php } ?>

							<?php if ($module->state == SOCIAL_LANGUAGES_NEEDS_UPDATING) { ?>
							...
							<?php if ($module->state == SOCIAL_LANGUAGES_NOT_INSTALLED) { ?>
