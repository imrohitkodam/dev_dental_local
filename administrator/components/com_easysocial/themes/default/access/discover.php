		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="t-lg-mt--xl">
					<span class="label label-danger t-fs--sm"><?php echo JText::_( 'COM_EASYSOCIAL_FOOTPRINT_NOTE' );?>:</span> <?php echo JText::_('COM_EASYSOCIAL_ACCESS_INSTALL_SCAN_FOOTPRINT');?>
				</div>
			</div>
		</div>
	</div>
