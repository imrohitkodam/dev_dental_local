...
<div class="row">
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-head">
				<b><?php echo JText::_('COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_GENERAL');?></b>
				<div class="panel-info"><?php echo JText::_('COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_GENERAL_INFO');?></div>
			</div>
			...
			<div class="panel-body">
				<div class="form-group" data-category-avatar data-hasavatar="<?php echo $category->hasAvatar(); ?>" data-defaultavatar="<?php echo $category->getDefaultAvatar(); ?>">
					<label class="col-md-4">
						<?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_AVATAR' );?>
						<i class="fa fa-question-circle pull-right"
							<?php echo $this->html( 'bootstrap.popover' , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_AVATAR' ) , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_AVATAR_DESC' ) , 'bottom' ); ?>
						></i>
					</label>
					<div class="col-md-8">
						<?php if( $category->id ){ ?>
						...
						<div>
							...
							<span data-category-avatar-remove-wrap <?php if( !$category->hasAvatar() ) { ?>style="display: none;"<?php } ?>>
								...
								<a href="javascript:void(0);" class="btn btn-es-danger btn-sm" data-id="<?php echo $category->id;?>" data-category-avatar-remove-button><i class="fa fa-remove"></i> <?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_FORM_REMOVE_AVATAR' ); ?></a>
							</span>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="title" class="col-md-4">
						<?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_TITLE' );?>
						<i class="fa fa-question-circle pull-right"
							<?php echo $this->html( 'bootstrap.popover' , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_TITLE' ) , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_TITLE_DESC' ) , 'bottom' ); ?>
						></i>
					</label>
					<div class="col-md-8">
						<input type="text" name="title" id="title" class="o-form-control input-sm" value="<?php echo $category->title;?>" placeholder="<?php echo $this->html( 'string.escape' , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_TITLE_PLACEHOLDER' ) );?>" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="alias" id="alias" class="o-form-control input-sm" value="<?php echo $category->alias;?>"/>
					</div>
				</div>
	...
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-head">
				<b><?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_USER_ACCESS' );?></b>
				<p><?php echo JText::_('COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_USER_ACCESS_INFO');?></p>
			</div>

			<div class="panel-body">
				<div class="form-group">
					<label class="col-md-4">
						<?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_SELECT_PROFILES' );?>
						<i class="fa fa-question-circle pull-right"
							<?php echo $this->html( 'bootstrap.popover' , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_PUBLISHING_STATUS' ) , JText::_( 'COM_EASYSOCIAL_GROUPS_CATEGORY_FORM_PUBLISHING_STATUS_DESC' ) , 'bottom' ); ?>
						></i>
					</label>
