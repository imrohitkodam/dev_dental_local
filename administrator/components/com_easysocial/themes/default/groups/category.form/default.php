	...
	<div class="wrapper accordion">
		<div class="tab-box tab-box-alt">
			<div class="tabbable">
				...
				<?php echo $this->loadTemplate('admin/groups/category.form/tabs' , array( 'isNew' => $category->id == 0 , 'activeTab' => $activeTab ) ); ?>

				<div class="tab-content">
					<div id="settings" class="tab-pane<?php echo $activeTab == 'settings' ? ' active in' : '';?>">
						<?php echo $this->includeTemplate('admin/groups/category.form/settings'); ?>
					</div>

					<?php if ($category->id) { ?>
					<div id="fields" class="tab-pane<?php echo $activeTab == 'fields' ? ' active in' : '';?>">
						<?php echo $this->includeTemplate('admin/fields/editor/default', array('id' => $category->id, 'formType' => 'CLUSTER')); ?>
					</div>

					<div id="access" class="tab-pane<?php echo $activeTab == 'access' ? ' active in' : '';?>">
						<?php echo $this->includeTemplate('admin/groups/category.form/access'); ?>
					</div>
					<?php } ?>
