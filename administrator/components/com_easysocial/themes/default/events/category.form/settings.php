		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="title" id="title" class="o-form-control input-sm" value="<?php echo $category->title;?>" placeholder="<?php echo $this->html('string.escape', JText::_('COM_EASYSOCIAL_EVENT_CATEGORY_FORM_TITLE_PLACEHOLDER'));?>" />
					</div>
				</div>
