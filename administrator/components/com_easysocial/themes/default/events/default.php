            ...
            <?php if (!empty($events)) { ?>
                ...
                <?php foreach ($events as $event) { ?>
                    <tr class="row<?php echo $i; ?>" data-grid-row data-id="<?php echo $event->id; ?>">
                        ...
                        <td>
                            <a href="<?php echo FRoute::url(array('view' => 'events', 'layout' => 'form', 'id' => $event->id));?>" 
                                data-event-insert
                        ...
                        <?php if ($this->tmpl != 'component') { ?>
                        <td class="center">
                            <a href="index.php?option=com_easysocial&view=events&layout=categoryForm&id=<?php echo $event->category_id;?>" target="_blank"><?php echo JText::_($event->getCategory()->title); ?></a>
                        </td>
