...
<form method="post" name="adminForm" class="esForm" id="adminForm" data-table-grid>
				...
				<?php if ($categories) { ?>
					...
					>
						...
						<td>
							...
							<a href="<?php echo FRoute::_('index.php?option=com_easysocial&view=marketplaces&layout=categoryForm&id=' . $category->id);?>"
						...
						<?php if (!$simple) { ?>
						<td class="center">
							<?php echo $this->html('grid.published', $category, 'marketplaces', '', array('publishCategory', 'unpublishCategory')); ?>
						</td>
						<td class="center">
						...
						<td class="order center">
							...
							<?php echo $this->html('grid.roworder', 'order', $orderkey + 1, count($ordering[$category->parent_id]), $saveOrder); ?>
				...
				<?php } else { ?>
					<tr class="is-empty">
						<td colspan="8" class="center empty">
							<?php echo JText::_('COM_EASYSOCIAL_PAGES_NO_CATEGORIES_AVAILABLE');?>
						</td>
					</tr>
				<?php } ?>
			</tbody>
	...
	<input type="hidden" name="view" value="<?php echo 'marketplaces'; ?>" />
	<input type="hidden" name="layout" value="<?php echo $layout;?>" />
	<input type="hidden" name="controller" value="<?php echo 'marketplaces'; ?>" />
</form>
