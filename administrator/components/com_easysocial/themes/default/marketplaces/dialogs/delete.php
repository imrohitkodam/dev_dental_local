...
<dialog>
	...
	<title><?php echo JText::_('COM_ES_MARKETPLACES_DELETE_LISTING_DIALOG_TITLE'); ?></title>
	<content>
		<p><?php echo JText::_('COM_ES_MARKETPLACES_DELETE_LISTING_DIALOG_CONFIRMATION'); ?></p>
	</content>
	<buttons>
