...
<dialog>
	...
	<title><?php echo JText::_('COM_ES_MARKETPLACES_CREATE_LISTING_DIALOG_TITLE'); ?></title>
	<content>
		<form name="approveUser" method="post" action="index.php" data-users-assign-form>
			<p>
				<?php echo JText::_('COM_ES_MARKETPLACES_CREATE_LISTING_DIALOG_DESC');?>
			</p>

			<div class="form-group">
				<label for="profileId" class="col-md-3">
					<?php echo JText::_('COM_ES_MARKETPLACES_CREATE_LISTING_DIALOG_SELECT_CATEGORY');?>
				</label>
				<div class="col-md-9">
