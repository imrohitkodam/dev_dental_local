...
<dialog>
	...
	<title><?php echo JText::_('COM_ES_MARKETPLACES_CATEGORIES_DELETECATEGORY_DIALOG_TITLE'); ?></title>
	<content>
		<p><?php echo JText::_('COM_ES_MARKETPLACES_CATEGORIES_DELETECATEGORY_DIALOG_CONTENT'); ?></p>
	</content>
	<buttons>
