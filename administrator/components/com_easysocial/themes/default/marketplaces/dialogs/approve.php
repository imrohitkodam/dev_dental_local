...
<dialog>
	...
	<title><?php echo JText::_('COM_ES_MARKETPLACES_APPROVE_DIALOG_TITLE'); ?></title>
	<content>
		<form name="approveUser" method="post" action="index.php" data-approve-form>
		<p>
			<?php echo JText::_('COM_ES_MARKETPLACES_APPROVE_DIALOG_CONTENT');?>
		</p>

		<div class="o-checkbox t-lg-mt--xl">
			<input type="checkbox" id="sendConfirmationMail" class="mr-5" checked="checked" name="email" value="1" />
			<label for="sendConfirmationMail"><?php echo JText::_('COM_ES_MARKETPLACES_APPROVE_DIALOG_SEND_EMAIL');?></label>
		</div>
