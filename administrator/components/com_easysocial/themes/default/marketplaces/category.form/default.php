								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<?php echo $this->html('form.workflows', 'workflow_id', 'marketplace', $category->getWorkflow()->id); ?>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<?php echo $this->html('form.textarea', 'description', null, $category->description); ?>
											</div>
										</div>
