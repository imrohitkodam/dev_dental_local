...
<dialog>
	...
	<bindings type="javascript">
	{
		...
		// Implementation of the actions must be done by the caller
	}
	</bindings>
	...
	<buttons>
		...
		<button data-submit-button type="button" class="btn btn-es-primary btn-sm">
			<?php echo JText::_('COM_ES_YES_BUTTON'); ?>
		</button>
	</buttons>
</dialog>
