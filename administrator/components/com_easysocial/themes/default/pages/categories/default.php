			...
			<thead>
				<tr>
					...
					<th class="center" width="5%">
						<?php echo JText::_('COM_EASYSOCIAL_TABLE_COLUMN_PAGES');?>
					</th>
				...
				<?php if ($categories) { ?>
					...
					>
						...
						<td>
							...
							<a href="<?php echo ESR::_('index.php?option=com_easysocial&view=pages&layout=categoryForm&id=' . $category->id);?>"
						...
						<?php if (!$simple) { ?>
						<td class="center">
							<?php echo $this->html('grid.published', $category, 'pages', '', array('publishCategory', 'unpublishCategory')); ?>
						</td>
						<td class="center">
