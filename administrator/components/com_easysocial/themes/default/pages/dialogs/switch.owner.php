...
<dialog>
	...
	<title><?php echo JText::_('COM_EASYSOCIAL_PAGES_CONFIRM_OWNER_DIALOG_TITLE'); ?></title>
	<content>
		<form name="approveUser" method="post" action="index.php" data-submit-form>
			<p>
				<?php echo JText::sprintf('COM_EASYSOCIAL_PAGES_CONFIRM_OWNER_DIALOG_CONTENT', '<b>' . $user->getName() . '</b>');?>
			</p>
