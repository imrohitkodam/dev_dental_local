...
class EasySocialViewAccess extends EasySocialAdminView
{
	...
	public function display($tpl = null)
	{
		...
		$model = ES::model('accessrules' , array('initState' => true, 'namespace' => 'access.listing'));
		...
		echo parent::display('admin/access/default/default');
	}
	...
	/**
	 * Renders the installation form for ACL
	 *
	 * @since	2.0
	 * @access	public
	 */
	...
	{
		$this->setHeading('COM_EASYSOCIAL_HEADING_INSTALL_ACCESS', 'COM_EASYSOCIAL_DESCRIPTION_INSTALL_ACCESS');
		
		JToolbarHelper::custom('upload', 'upload', '', JText::_('COM_EASYSOCIAL_UPLOAD_AND_INSTALL_BUTTON'), false);

		echo parent::display('admin/access/install/default');
	}
