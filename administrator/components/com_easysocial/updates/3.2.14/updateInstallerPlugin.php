...
class SocialMaintenanceScriptUpdateInstallerPlugin extends SocialMaintenanceScript
{
	public static $title = 'Update EasySocial Installer plugin';
	public static $description = 'To ensure system install the EasySocial installer plugin correctly.';
