...
class SocialMaintenanceScriptUpdateFieldsRawColumn extends SocialMaintenanceScript
{
	public static $title = 'Update fields raw column to support utf8mb4 character set';
	public static $description = 'Update fields raw column to support utf8mb4 character set';
	...
	public function main()
	{
		...
		if ($dbType == 'mysql' || $dbType == 'mysqli') {
			...
			if ($dbversion >= '5.5') {
				$query = "SHOW FULL COLUMNS FROM `#__social_fields_data` where `Field` = 'raw'";
				...
				if (strpos($collation, 'utf8mb4') === false) {
					...
					// now we alter the column collation to utf8mb4
