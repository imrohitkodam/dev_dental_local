...
class SocialStylesheetLessc {
	 ...
	 *
	 * See SocialStylesheetLessc::compileProp()
	 *
	 */
	...
	protected function injectVariables($args) {
		$this->pushEnv();
		$parser = new SocialStylesheetLessc_parser($this, __METHOD__);
	...
	public function makeParser($name) {
		$parser = new SocialStylesheetLessc_parser($this, $name);
	...
	protected function newFormatter() {
		$className = "SocialStylesheetLessc_formatter_lessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "SocialStylesheetLessc_formatter_$this->formatterName";
		}
...
// syntax tree
class SocialStylesheetLessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('SocialStylesheetLessc', 'preg_quote'),
					array_keys(self::$precedence))).')';

			$commentSingle = SocialStylesheetLessc::preg_quote(self::$commentSingle);
			$commentMultiLeft = SocialStylesheetLessc::preg_quote(self::$commentMultiLeft);
			$commentMultiRight = SocialStylesheetLessc::preg_quote(self::$commentMultiRight);
	 ...
	 *
	 * Consider the function SocialStylesheetLessc::keyword(). (all parse functions are
	 * structured the same)
	 *
	 ...
	 *
	 * All of these parse functions are powered by SocialStylesheetLessc::match(), which behaves
	 ...
	 * avoid this, SocialStylesheetLessc::seek() is used to remember and set buffer positions.
	 *
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("SocialStylesheetLessc", "preg_quote"), $directives));
	...
	protected function expressionList(&$exps) {
		...
		$exps = SocialStylesheetLessc::compressList($values, ' ');
		return true;
	}
	...
	public function propertyValue(&$value, $keyName = null) {
		...
		$value = SocialStylesheetLessc::compressList($values, ', ');
		return true;
	}
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("SocialStylesheetLessc", "preg_quote"), $stop);
	...
	protected function string(&$out) {
		...
		$patt = '([^\n]*?)(@\{|\\\\|' .
			SocialStylesheetLessc::preg_quote($delim).')';
	...
	protected function literal($what, $eatWhitespace = null) {
		...
		if (!isset(self::$literalCache[$what])) {
			self::$literalCache[$what] = SocialStylesheetLessc::preg_quote($what);
		}
	...
	protected function to($what, &$out, $until = false, $allowNewline = false) {
		...
		if (!$this->match('('.$validChars.'*?)'.SocialStylesheetLessc::preg_quote($what), $m, !$until)) return false;
...
class SocialStylesheetLessc_formatter_classic {
	public $indentChar = "  ";
...
class SocialStylesheetLessc_formatter_compressed extends SocialStylesheetLessc_formatter_classic {
...
class SocialStylesheetLessc_formatter_lessjs extends SocialStylesheetLessc_formatter_classic {
	public $disableSingle = true;
