...
class SocialInstallerHelperJoomla40 extends SocialInstallerJoomla
{
	/**
	...
	public function load($path)
	{
		...
		foreach ($files as $file) {
			...
			if ($parser->getName() != self::XML_NAMESPACE || !in_array($this->type, $this->allowed)) {
				$this->setError('COM_EASYSOCIAL_INSTALLER_MANIFEST_IS_NOT_VALID_APPLICATION');
				continue;
			}
	...
	/**
	 * Override copySQL from parent class
	 *
	 */
	public function copySQL($destination)
	{
