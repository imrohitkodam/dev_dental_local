...
class Decoder extends \Intervention\Image\AbstractDecoder
{
    ...
    public function gdResourceToTruecolor(&$resource)
    {
        ...
        // new canvas
        // known issue if the upload image/migration process stuck it here :
        // if the image resolution width and height more than 1000px, ensure that PHP memory_limit need to set higher
        // Because some of the hosting provider doesn't show PHP error on the site so difficult to know whoever debug this
