...
class S3Client extends AbstractClient
{
    ...
    {
    	// known issue
    	// sometime when the server trying to pull back the files from Amazon S3 to local server
    	// It will exhausted the memory and I think it trying to check whether this file really exist into that storage directory folder or not
    	// and compare those file size and etc.
    	// if you hit this issue as what I described at above, maybe you can pass in this parameter in an options.
    	// e.g. $options = array('force' => true); // you can take a look above explanation for this "force" parameter mean.
    	// So it will override this files into your local server even there got the same files under that directory folder.
