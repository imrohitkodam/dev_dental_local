...
?>
<form action="<?php echo FSSRoute::_( 'index.php?option=com_fss&view=ticketcats' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSSRoute::_( 'index.php?option=com_fss&controller=ticketcat&task=edit&cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td>
				...
				<?php } else { ?>
				<?php $link = FSSRoute::_('index.php?option=com_fss&tmpl=component&controller=ticketcat&view=ticketcat&task=prods&ticket_cat_id=' . $row->id); ?>
			...
			<td>
				<?php if ($row->alldepts) { ?>
					<?php echo JText::_("ALL"); ?>
				<?php } else { ?>
				<?php $link = FSSRoute::_('index.php?option=com_fss&tmpl=component&controller=ticketcat&view=ticketcat&task=depts&ticket_cat_id=' . $row->id); ?>
					<a class="fss_modal" title="<?php echo JText::_("VIEW"); ?>"  href="<?php echo $link; ?>" rel="{handler: 'iframe', size: {x: 400, y: 300}}"><?php echo JText::_("VIEW"); ?></a>
				<?php } ?>
			</td>
			<td align="center">
