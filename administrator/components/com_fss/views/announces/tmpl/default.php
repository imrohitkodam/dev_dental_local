...
?>
<form action="<?php echo FSSRoute::_( 'index.php?option=com_fss&view=announces' );?>" method="post" name="adminForm" id="adminForm">
    ...
    <thead>
        ...
        <tr>
			...
			<th width="40%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort',   'Description_For_Module', 'subtitle', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="1%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort',   'Added', 'added', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="1%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort',   'Author', 'name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="1%" nowrap="nowrap">
