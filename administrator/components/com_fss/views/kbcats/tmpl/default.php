...
?>
<form action="<?php echo FSSRoute::_( 'index.php?option=com_fss&view=kbcats' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    <thead>
        ...
        <tr>
            ...
            <th>
                <?php echo JHTML::_('grid.sort',   'PARENT_CATEGORY', 'parcattitle', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
            </th>
            <th>
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSSRoute::_( 'index.php?option=com_fss&controller=kbcat&task=edit&cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td>
			    <?php echo $row->parcattitle; ?></a>
			</td>
			<td>
			    <?php echo $row->image; ?></a>
</td>
<td align="center">
