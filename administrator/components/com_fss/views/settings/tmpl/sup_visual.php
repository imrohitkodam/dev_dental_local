		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					<td align="left" class="key">	
							<?php echo JText::_("open_show_error_alert"); ?>:
					</td>
					<td>
						<input type='checkbox' name='open_show_error_alert' value='1' <?php if ($this->settings['open_show_error_alert'] == 1) { echo " checked='yes' "; } ?>>
					</td>
					<td>
						<div class='fss_help'><?php echo JText::_('SETHELP_open_show_error_alert'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
