...
?>
<form action="<?php echo FSSRoute::_( 'index.php?option=com_fss&view=faqcats' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSSRoute::_( 'index.php?option=com_fss&controller=faqcat&task=edit&cid[]='. $row->id );
