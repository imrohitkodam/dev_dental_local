...
var numeric_value_validation_msg	=	"<?php echo JText::_('COM_TJLMS_NO_NEGATIVE_NUMBER'); ?>";
var allowed_paid_course	=	<?php echo $tjlmsparams->get('allow_paid_courses', '0', 'INT');?>;
var provide_valid_scorm_package_msg =  "<?php echo JText::_('COM_TJLMS_VALID_SCORM_PACKAGE'); ?>";
var lesson_upload_size = <?php echo $tjlmsparams->get('lesson_upload_size', 10, 'INT');?>;
var nonvalid_extension = "<?php echo JText::_('COM_TJLMS_UPLOAD_EXTENSION_ERROR');?>"
var filesize_exceeded = "<?php echo JText::sprintf('COM_TJLMS_UPLOAD_SIZE_ERROR', $tjlmsparams->get('lesson_upload_size', 10, 'INT') . ' MB');?>";
...
var video_url_or_embedcode_blank	= "<?php echo JText::_('COM_TJLMS_VIDEO_SOURCE_NOT_PROVIDED_ERROR'); ?>";
var allow_associate_files = <?php echo $tjlmsparams->get('allow_associate_files', 0, 'INT');?>;
var form_date_validation_failed = "<?php echo JText::_('COM_TJLMS_DATE_RANGE_VALIDATION'); ?>";
</script>
