...
class TjlmsHelper
{
	...
	public static function addSubmenu($vName = '')
	{
		...
		*/
		...
		{
			JHtmlSidebar::addEntry(Text::_('COM_TJLMS_TITLE_ATTEMPTS'), 'index.php?option=com_tjlms&view=attemptreport', $vName == 'attemptreport');
	...
	private static function isComponentEnabled($component)
	{
		...
		if (JFile::exists(JPATH_ADMINISTRATOR . '/components/com_' . $component . '/' . $component . '.php'))
		{
