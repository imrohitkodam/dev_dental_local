 ...
 */
class TjlmsViewCertificates extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TJLMS_TITLE_CERTIFICATE'), 'pencil-2');
		...
		if (file_exists($formPath))
		{
			...
			{
				JToolBarHelper::addNew('certificatetemplate.add', 'JTOOLBAR_NEW');
				JToolbarHelper::custom('certificates.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}

			if ($canDo->get('core.edit') && isset($this->items[0]))
			{
				JToolBarHelper::editList('certificatetemplate.edit', 'JTOOLBAR_EDIT');
			}
		}
		...
		if (isset($this->items[0]->state))
		{
			...
			{
				JToolBarHelper::deleteList('', 'certificates.delete', 'JTOOLBAR_EMPTY_TRASH');
				JToolBarHelper::divider();
			}
