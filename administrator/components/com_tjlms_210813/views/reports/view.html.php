 ...
 * @since  1.0.0
 */
class TjlmsViewReports extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			$saveQueries = array();
			$saveQueries[] = JHTML::_('select.option', '', JText::_('COM_TJLMS_SELONE_QUERY'));
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TJLMS_TITLE_REPORT'), 'list');
