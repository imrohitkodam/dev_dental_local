...
<div class="">
	<div class="modal-header">
		...
		<h3><?php echo JText::sprintf('COM_TJLMS_ORDER_FOR',$orderdetails[0]->title); ?></h3>
	</div>
<?php
		...
		<div class="row-fluid">
			<div class="span12 ">
				...
				<div class="pull-right">
					<input type="button" class="btn btn-success orderprintalign" onclick="printDiv()" value="<?php echo JText::_('COM_TJLMS_PRINT');?>">
				</div>
			</div>
		</div>
<?php
		...
		<div class="row-fluid">
			...
			<div style="text-align:right">
				...
				<div class="pull-right " >
					...
					<!--SHOW ORDER STATUS-->
					<div>
						<strong><?php echo JText::_('COM_TJLMS_ORDER_DATE'); ?></strong>  <?php echo $this->techjoomlacommon->getDateInLocal($this->orderinfo->cdate, 0 , $date_format_show );?>
					</div>
				</div>
			</div>
		...
		<div class="row-fluid">
			<hr class="hr hr-condensed"/>
				<div class="span12 "> <!-- plan detail start -->
					<h3><?php echo JText::sprintf('COM_TJLMS_PLAN_INFO',$orderdetails[0]->title); ?></h3>
									...
									<?php
											...
											?>
												<tr>
													...
													<td class="lms_tprice_label" align="left">
														<strong>
															<?php echo JText::sprintf('TAX_AMOUNT', $tax_arr['percent']) . "";?>
														</strong>
													</td>
													<td class="lms_tprice" >
														<span id= "tax_amt" >
