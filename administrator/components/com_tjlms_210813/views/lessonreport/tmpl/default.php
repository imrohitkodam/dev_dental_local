		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<a href="<?php echo JUri::root() . 'administrator/index.php?option=com_tjlms&view=attemptreport' . $additionalParam . '&filter[userfilter]=' . $item->user_id . '&filter[lessonfilter]=' .  $item->lesson_id; ?>"><?php echo $item->attemptsDone; ?></a>
				</td>
				<td>
