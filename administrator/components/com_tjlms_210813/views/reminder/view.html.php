 ...
 * @since  1.6
 */
class TjlmsViewReminder extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TJLMS_TITLE_REMINDER'), 'reminder.png');
		...
		{
			JToolbarHelper::versions('com_tjlms.reminder', $this->item->id);
		}
