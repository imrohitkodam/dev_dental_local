...
<div class="form-inline bau">
	...
	<div class="form-group">
		<label><?php echo JText::_('COM_TJLMS_ENROLMENT_START_DATE_TITLE'); ?></label>
	...
	<div class="form-group" >
		<label><?php echo JText::_('COM_TJLMS_ENROLMENT_DUE_DATE_TITLE'); ?></label>
		<div class="form-control">
				<?php
...
<!-- <div class="row-fluid form-horizontal " >
	...
	<div class="control-group">
		<div class="control-label"><?php echo JText::_('COM_TJLMS_ENROLMENT_START_DATE_TITLE'); ?></div>
		<div class="controls">
			<?php
				echo Jhtml::calendar("",'batch_start_date', "batch_start_date", '%Y-%m-%d',array('','size'=>'8','maxlength'=>'10'));
			?>
	...
	<div class="control-group" >
		<div class="control-label"><?php echo JText::_('COM_TJLMS_ENROLMENT_DUE_DATE_TITLE'); ?></div>
		<div class="controls">
				<?php
			echo Jhtml::calendar("",'batch_due_date', "batch_due_date", '%Y-%m-%d',array('size'=>'8','','maxlength'=>'10'));
		?>
