...
?>
	<?php if (!empty($this->item->max_attempt) && $this->item->max_attempt > 0) : ?>
					<div class="alert alert-info">
						<?php echo JText::sprintf('COM_TJLMS_LESSON_ASSESSMENT_DISABLED_AS_ATTEMPTED');?>
					</div>
				<?php endif;?>
				...
				<div class="container-fluid">
					<div class="row-fluid" data-js-id="disable-if-reviewed">
						<div class="span6">
				...
				<div data-js-id="assessment-details">
					...
					<div class="row-fluid">
						...
						<div class="span6" data-js-id="disable-if-reviewed">
							<div class="control-group">
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group row-fluid">
								...
								<div class="text-info controls"><?php echo JText::_('COM_TJLMS_FORM_DESC_MINIMUM_NO_OF_ASSESSMENT_NOTE'); ?></div>
					...
					<div class="row-fluid">
						...
						<div class="span6" data-js-id="answersheet_options">
							<div class="control-group">
