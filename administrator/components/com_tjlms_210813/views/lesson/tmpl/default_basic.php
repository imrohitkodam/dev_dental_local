...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tjlms&view=lesson&id='. $this->lessonId); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="lesson-basic-form_<?php echo $this->formId;?>" class="form-validate form-horizontal lesson_basic_form" >
				...
				<fieldset class="adminform">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<span class="help-block alert alert-info"><?php echo JText::_('COM_TJLMS_SUPPORTED_MEDIA_FILES_COURSE'); ?></span>
						</div>
					</div>
			...
			<div class="span6">
				<fieldset class="adminform">
					<div class="control-group">
						...
						<div class="text-info alert alert-info"><?php echo JText::_('COM_TJLMS_FORM_DESC_LESSON_NO_OF_ATTEMPTS_NOTE'); ?></div>
