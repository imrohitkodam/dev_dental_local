...
ALTER TABLE `#__tjlms_lessons` change name title varchar(255) NOT NULL;
ALTER TABLE `#__tjlms_lesson_assessment_ratings` CHANGE `rating_comment` `rating_comment` TEXT NOT NULL;
