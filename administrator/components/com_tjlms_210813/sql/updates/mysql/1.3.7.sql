...
ALTER TABLE `#__tjlms_lessons` ADD `catid` INT(10) NOT NULL AFTER `alias`; 
-- --------------------------------------------------------
...
ALTER TABLE `#__tjlms_lessons` CHANGE `free_lesson` `free_lesson` TINYINT NOT NULL;
ALTER TABLE `#__tjlms_lessons` CHANGE `consider_marks` `consider_marks` TINYINT NOT NULL; 
