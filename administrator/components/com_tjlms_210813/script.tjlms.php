...
class Com_TjlmsInstallerScript
{
	...
	public function postflight($type, $parent)
	{
		...
		$dataBaseModel = JModelLegacy::getInstance('Database', 'TjlmsModel');
...
?></th>
	...
	protected function createHtaccessFiles()
	{
		...
		if (!JFolder::exists($lessons_dir))
		{
			$result = JFolder::create($lessons_dir);
		...
		$folders = JFolder::folders($lessons_dir);
