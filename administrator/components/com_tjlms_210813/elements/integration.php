...
class JFormFieldIntegration extends JFormField
{
	...
	public function fetchElement($name, $value, $node, $control_name)
	{
		...
		$options[] = JHTML::_('select.option', 'joomla', JText::_('COM_TJLMS_JOOMLA'));
		$options[] = JHTML::_('select.option', 'jomsocial', JText::_('COM_TJLMS_JOMSOCIAL'));
		$options[] = JHTML::_('select.option', 'easysocial', JText::_('COM_TJLMS_EASYSOCIAL'));
