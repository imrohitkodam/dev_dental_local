...
class JFormFieldPointsheader extends JFormField
{
	...
	public function getInput()
	{
		...
		elseif ($this->class == 'show_notes show_point_notes')
		{
			...
			{
				$aup_click_link = "<strong><a href='" . JURI::root() . "components/com_tjlms/alphapoints/tjlms_aup.zip'>" . JText::_('HERE') . "</a></strong>";

				$aupPluginLink = "index.php?option=com_alphauserpoints&task=plugins";
				$aup_install_link = "<strong><a href='" . JURI::base() . $aupPluginLink . "' target='_blank'>" . JText::_('HERE') . "</a></strong>";

				$html[] = JText::sprintf('COM_TJLMS_AUP_POINT_SYSTEM_NOTE',
				$aup_click_link,
				$aup_install_link,
				JText::_('COM_TJLMS_COURSE_ENROLLMENT_POINTS'),
				JText::_('COM_TJLMS_LESSON_COMPLETION_POINTS')
				);
			}

			if (JFolder::exists($altafolder))
			{
				$aup_click_link = "<strong><a href='" . JURI::root() . "components/com_tjlms/altapoints/tjlms_aup.zip'>" . JText::_('HERE') . "</a></strong>";

				$aupPluginLink = "index.php?option=com_altauserpoints&task=plugins";
				$aup_install_link = "<strong><a href='" . JURI::base() . $aupPluginLink . "' target='_blank'>" . JText::_('HERE') . "</a></strong>";

				$html[] = JText::sprintf('COM_TJLMS_ALTAUP_POINT_SYSTEM_NOTE',
				$aup_click_link,
				$aup_install_link,
				JText::_('COM_TJLMS_COURSE_ENROLLMENT_POINTS'),
				JText::_('COM_TJLMS_LESSON_COMPLETION_POINTS')
			...
			{
				$html[] = JText::_('COM_TJLMS_JS_POINT_SYSTEM_NOTE');
			}

			if (JFolder::exists($esfolder))
			{
				$html[] = JText::_('COM_TJLMS_ES_POINT_SYSTEM_NOTE');
			}
