...
class JFormFieldGroupcategories extends JFormField
{
	...
	public function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$componentParams = JComponentHelper::getParams('com_tjlms');
		...
		if ($integration == 'easysocial' && JFile::exists($esmainfile))
		{
		...
		elseif ($integration == 'jomsocial' && JFile::exists($jsmainfile))
		{
		...
		{
			return '<div class="alert alert-warning">' . JText::_('NO_SOCIAL_GROUPS_CAT_FOUND') . '</div>';
		}
