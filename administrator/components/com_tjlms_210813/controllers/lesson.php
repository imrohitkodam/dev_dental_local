...
class TjlmsControllerLesson extends JControllerForm
{
	...
	public function save($key = null, $urlVar = null)
	{
		...
		else
		{
			...
			else
			{
				...
				{
						$result = 0;
						$msg = JText::_('COM_TJLMS_LESSON_SAVING_FAILED');
				}
				elseif ( $saveLesson == -2)
				{
						$result = 0;
						$msg = JText::_('COM_TJLMS_LESSON_IMAGE_UPLOAD_FAILED');
				}
				elseif ( $saveLesson == -1)
				{
						$result = 0;
						$msg = JText::_('COM_TJLMS_LESSON_LESSON_UPDATE_IMGAENAME_FAILED');
				}
			}
		}
	...
	public function updateformat()
	{
		...
		{
			$ret['OUTPUT']['result'] = 1;
			$ret['OUTPUT']['msg'] = JText::_('COM_TJLMS_LESSON_FORMAT_UPLOADED');
	...
	public function saveassessment()
	{
		...
		{
			$result = 1;
			$msg = JText::_('COM_TJLMS_ASSESMENT_SAVED');
		}
		else
		{
			$result = 0;
			$msg = JText::_('COM_TJLMS_ASSESMENT_ERROR');
		}

		if ((int) $saveassessment == -1)
		{
			$result = -1;
			$msg = JText::_('COM_TJLMS_ASSESSMENT_CANT_SAVE');
		}
