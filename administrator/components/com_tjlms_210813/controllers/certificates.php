 ...
 */
class TjlmsControllerCertificates extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		try
		{
			if (empty($pks))
			{
				throw new Exception(JText::_('COM_TJLMS_NO_ELEMENT_SELECTED'));
			}
	...
	public function publish()
	{
		...
		if ($value != 1)
		{
			...
			{
				JFactory::getApplication()->enqueueMessage(Jtext::_('COM_TJLMS_CERTIFICATE_SHOULD_NOT_PUBLISH'), 'warning');
			}
