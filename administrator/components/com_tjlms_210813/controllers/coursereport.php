 ...
 * @since  1.0.0
 */
class TjlmsControllerCoursereport extends JControllerAdmin
{
	/**
	...
	public function csvexport()
	{
		...
		$csvData       = null;
		$csvData_arr = array();
		$csvData_arr[] = JText::_('COM_TJLMS_COURSE_NAME');
		$csvData_arr[] = JText::_('COM_TJLMS_COURSE_CAT');
		$csvData_arr[] = JText::_('COM_TJLMS_ACL_GROUP');
		$csvData_arr[] = JText::_('COM_TJLMS_COURSE_TYPE');
		$csvData_arr[] = JText::_('COM_TJLMS_LESSONS_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_ENROLLED_USERS_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_PENDING_ENROLLED_USERS_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_COMPLETED_USERS_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_LIKES_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_DISLIKES_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_COMMENTS_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_RECO_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_ASSIGN_CNT');
		$csvData_arr[] = JText::_('COM_TJLMS_COURSE_ID');
