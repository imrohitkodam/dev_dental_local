 ...
 * @since  1.0.0
 */
class TjlmsControllerSinglecoursereport extends JControllerAdmin
{
	...
	public function csvexport()
	{
		...
		// Create CSV headers
		$csvData       = null;
		$csvData_arr[] = JText::_('COM_TJLMS_EMP_NAME');
		$csvData_arr[] = JText::_('COM_TJLMS_EMP_CODE');
		$csvData_arr[] = JText::_('COM_TJLMS_EMP_EMAIL');
		$csvData_arr[] = JText::_('COM_TJLMS_EMP_GROUP');
		$csvData_arr[] = JText::_('COM_TJLMS_COURSE_NAME');
		$csvData_arr[] = JText::_('COM_TJLMS_USER_ENROLLED_ON');
		$csvData_arr[] = JText::_('Due Date');
		$csvData_arr[] = JText::_('COM_TJLMS_COURSE_COMPLETED_DATE');
		$csvData_arr[] = JText::_('COM_TJLMS_COMPLETION');
		$csvData_arr[] = JText::_('COM_TJLMS_REPORT_TIMESPENT');
		...
		{
			$csvData_arr_head2[] = JText::_('COM_TJLMS_LESSON_SCORE_STUDENT');
			$csvData_arr_head2[] = JText::_('COM_TJLMS_LESSON_TIME_SPENT_STUDENT');
			$csvData_arr_head2[] = JText::_('COM_TJLMS_LESSON_STATUS_STUDENT');
		}
