...
class TjlmsControllerModule extends JControllerForm
{
	...
	public function save($key = null, $urlVar = null)
	{
		...
		if ($error)
		{
			$message = JText::_('COM_TJLMS_MODULE_SAVE_ERROR');
		}
		else
		{
			...
			if ($data['id'] > 0)
			{
				$message = JText::_('COM_TJLMS_MODULE_UPDATED_SUCCESSFULLY');
			}
			else
			{
				$message = JText::_('COM_TJLMS_MODULE_CREATED_SUCCESSFULLY');
			}
		}

		echo new JResponseJson($recordId, $message, $error);
		jexit();
	}
}
