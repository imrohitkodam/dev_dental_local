 ...
 * @since  1.0.0
 */
class TjlmsModelLessonreport extends JModelList
{
	...
	public function getItems()
	{
		...
		foreach ($items as $ind => $lessonDetails)
		{
			...
			$lessonDetails->user_name = JFactory::getUser($lessonDetails->user_id)->name;
			$lessonDetails->user_username = JFactory::getUser($lessonDetails->user_id)->username;
			$lessonDetails->user_email = JFactory::getUser($lessonDetails->user_id)->email;
		}
