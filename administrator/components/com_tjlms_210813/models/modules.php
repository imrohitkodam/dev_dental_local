...
class TjlmsModelModules extends JModelList
{
	...
	public function deleteModule($moduleId)
	{
		try
		{
			...
			$moduleModel = JModelLegacy::getInstance('Module', 'TjlmsModel');
	...
	public function getallSubFormats_HTML($lesson_id, $format, $sub_format, $form_id)
	{
		try
		{
			...
			$results = $dispatcher->trigger('getSubFormat_' . $sub_format . 'ContentHTML', array($mod_id, $lesson_id, $lesson, $comp_params, $form_id));
