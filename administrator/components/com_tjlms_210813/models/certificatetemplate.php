 ...
 */
class TjlmsModelCertificatetemplate extends JModelAdmin
{
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_tjlms.edit.certificatetemplate.data', array());
	...
	public function validate($form,$data)
	{
		...
		{
			$this->setError(JText::_("COM_TJLMS_FORM_LBL_CERTIFICATETEMPLATE_TITLE_BLANK"));
