 ...
 * @since  1.0.0
 */
class TjlmsModelstudentcoursereport extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public function getItems()
	{
		...
		foreach ($items as $ind => $course)
		{
			...
			$items[$ind]->user_name = JFactory::getUser($course->user_id)->name;
			$items[$ind]->user_username = JFactory::getUser($course->user_id)->username;
			$items[$ind]->useremail = JFactory::getUser($course->user_id)->email;
