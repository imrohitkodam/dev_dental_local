 ...
 * @since  1.6
 */
class TjlmsModelReminder extends JModelAdmin
{
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_tjlms.edit.reminder.data', array());
	...
	public function save($data)
	{
		...
		if ($pk)
		{
			...
			$dispatcher->trigger('onAfterSaveCoursereminder', array(
														$pk,
														$data['notify_cc']
													)
								);
