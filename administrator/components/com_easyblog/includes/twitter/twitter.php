...
class EasyBlogTwitter extends EasyBlog
{
	...
	public function getImage(EasyBlogPost &$blog)
	{
		...
		if ($source == false && $this->config->get('main_twitter_opengraph_imageavatar', false)) {
	...
	public function addCard(EasyBlogPost &$blog)
	{
		...
		// It seems like the Twitter already increased the maximum length to 200 (modified at Nov 1st 2022)
	...
	{
		$this->doc->setMetaData('twitter:image', $imageUrl);
	}
