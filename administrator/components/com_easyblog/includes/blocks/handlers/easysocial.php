...
class EasyBlogBlockHandlerEasysocial extends EasyBlogBlockHandlerAbstract
{
	public $icon = 'fdi fas fa-play';
	...
	public function meta()
	{
		...
		$template = EB::themes();
		$meta->wrapper = $template->output('site/composer/blocks/handlers/easysocial/wrapper');
	...
	public function getHtml($block, $textOnly = false)
	{
		...
		$contents = $template->output('site/blocks/easysocial');
