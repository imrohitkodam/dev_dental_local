...
class EasyBlogStylesheetLessc {
	...
	protected function injectVariables($args) {
		$this->pushEnv();
		$parser = new EasyBlogStylesheetLessc_parser($this, __METHOD__);
	...
	public function makeParser($name) {
		$parser = new EasyBlogStylesheetLessc_parser($this, $name);
	...
	protected function newFormatter() {
		$className = "EasyBlogStylesheetLessc_formatter_lessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "EasyBlogStylesheetLessc_formatter_$this->formatterName";
		}
...
// syntax tree
class EasyBlogStylesheetLessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('EasyBlogStylesheetLessc', 'preg_quote'),
					array_keys(self::$precedence))).')';

			$commentSingle = EasyBlogStylesheetLessc::preg_quote(self::$commentSingle);
			$commentMultiLeft = EasyBlogStylesheetLessc::preg_quote(self::$commentMultiLeft);
			$commentMultiRight = EasyBlogStylesheetLessc::preg_quote(self::$commentMultiRight);
	 ...
	 *
	 * Consider the function EasyBlogStylesheetLessc::keyword(). (all parse functions are
	 * structured the same)
	 *
	 ...
	 *
	 * All of these parse functions are powered by EasyBlogStylesheetLessc::match(), which behaves
	 ...
	 * avoid this, EasyBlogStylesheetLessc::seek() is used to remember and set buffer positions.
	 *
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("EasyBlogStylesheetLessc", "preg_quote"), $directives));
	...
	protected function expressionList(&$exps) {
		...
		$exps = EasyBlogStylesheetLessc::compressList($values, ' ');
		return true;
	}
	...
	public function propertyValue(&$value, $keyName = null) {
		...
		$value = EasyBlogStylesheetLessc::compressList($values, ', ');
		return true;
	}
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("EasyBlogStylesheetLessc", "preg_quote"), $stop);
	...
	protected function string(&$out) {
		...
		$patt = '([^\n]*?)(@\{|\\\\|' .
			EasyBlogStylesheetLessc::preg_quote($delim).')';
	...
	protected function literal($what, $eatWhitespace = null) {
		...
		if (!isset(self::$literalCache[$what])) {
			self::$literalCache[$what] = EasyBlogStylesheetLessc::preg_quote($what);
		}
	...
	protected function to($what, &$out, $until = false, $allowNewline = false) {
		...
		if (!$this->match('('.$validChars.'*?)'.EasyBlogStylesheetLessc::preg_quote($what), $m, !$until)) return false;
...
class EasyBlogStylesheetLessc_formatter_classic {
	public $indentChar = "  ";
...
class EasyBlogStylesheetLessc_formatter_compressed extends EasyBlogStylesheetLessc_formatter_classic {
...
class EasyBlogStylesheetLessc_formatter_lessjs extends EasyBlogStylesheetLessc_formatter_classic {
	public $disableSingle = true;
