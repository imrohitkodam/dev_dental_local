...
class EasyBlogResponsive extends EasyBlog
{
	public $mobile = array(
		...
		'Android'       => 'Linux; Android.*Mobile|Android; Opera Mini.*|Linux; U; Android.*',
	...
	/**
	 * Determine if the page is being view as a webview in tablet
	 *
	 * @since	6.0.0
	 * @access	public
	 */
	public function isEBTabletWevbiew()
	{
		static $webview = null;
		...
		if (is_null($webview)) {
			...
			preg_match('/EasyBlogTablet\/Webview/is', $agent, $matches);
