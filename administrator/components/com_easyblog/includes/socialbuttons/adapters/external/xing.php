...
class EasyBlogExternalButtonXing extends EasyBlogSocialButton
{
	public $type = 'xing';
	...
	public function html()
	{
		...
		$output = $theme->output('site/socialbuttons/external/xing');
		return $output;
	}

	/**
	 * Determines if the xing button should appear
	 *
	 * @since	5.1
	 * @access	public
	 */
