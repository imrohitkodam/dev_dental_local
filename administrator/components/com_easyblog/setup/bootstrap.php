...
define('SI_IDENTIFIER_SHORT', 'easyblog');
define('SI_LANG', 'COM_EB');
define('SI_CONTROLLER_PREFIX', 'EasyBlogController');
...
define('SI_PACKAGE', 'com_easyblog_6.0.2_component_pro.zip');
