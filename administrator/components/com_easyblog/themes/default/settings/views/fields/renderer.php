...
<div class="form-group">
	<?php echo $this->fd->html('form.label', $field->attributes->label, $key . '_' . $field->attributes->name, JText::_($field->attributes->label), JText::_($field->attributes->description)); ?>
	...
	<div class="col-md-7">
		...
		?>
		<?php echo $this->output('admin/settings/views/fields/' . $field->attributes->type, [
			'field' => $field,
			'key' => $key,
			'configKey' => $key . '_' . $field->attributes->name
		]); ?>
	</div>
</div>
<?php } ?>
