...
class EasyBlogModelMaintenance extends EasyBlogAdminModel
{
	...
	public function __construct()
	{
		...
		$limit = $this->app->getUserStateFromRequest('com_easyblog.maintenance.limit', 'limit', $this->app->getCfg('list_limit'), 'int');
		$limitstart = $this->app->getUserStateFromRequest('com_easyblog.maintenance.limitstart', 'limitstart', 0, 'int');
