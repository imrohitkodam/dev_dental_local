...
namespace _JchOptimizeVendor\Symfony\Component\DomCrawler;

use _JchOptimizeVendor\Symfony\Component\DomCrawler\Field\ChoiceFormField;
use _JchOptimizeVendor\Symfony\Component\DomCrawler\Field\FormField;
...
class Form extends Link implements \ArrayAccess
{
     ...
     * @param null|string $currentUri The URI of the page where the form is embedded
     * @param null|string $method     The method to use for the link (if null, it defaults to the method defined by the form)
     * @param null|string $baseHref   The URI of the <base> used for relative links, but not for empty action
     *
