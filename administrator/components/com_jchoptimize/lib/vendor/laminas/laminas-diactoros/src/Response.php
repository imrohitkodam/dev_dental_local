...
class Response implements ResponseInterface
{
    ...
    private function setStatusCode($code, $reasonPhrase = '') : void
    {
        ...
        if (!\is_string($reasonPhrase)) {
            throw new Exception\InvalidArgumentException(sprintf('Unsupported response reason phrase; must be a string, received %s', \is_object($reasonPhrase) ? \get_class($reasonPhrase) : gettype($reasonPhrase)));
        }
