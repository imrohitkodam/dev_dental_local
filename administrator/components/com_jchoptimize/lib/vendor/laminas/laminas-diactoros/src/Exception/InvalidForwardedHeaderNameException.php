...
use _JchOptimizeVendor\Laminas\Diactoros\ServerRequestFilter\FilterUsingXForwardedHeaders;
class InvalidForwardedHeaderNameException extends RuntimeException implements ExceptionInterface
{
    ...
    public static function forHeader($name) : self
    {
        ...
        return new self(\sprintf('Invalid X-Forwarded-* header name "%s" provided to %s', $name, FilterUsingXForwardedHeaders::class));
    }
}
