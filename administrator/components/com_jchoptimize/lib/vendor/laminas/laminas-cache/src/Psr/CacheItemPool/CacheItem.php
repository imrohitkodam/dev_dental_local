...
final class CacheItem implements CacheItemInterface
{
    ...
    public function expiresAt($expiration)
    {
        if (!($expiration === null || $expiration instanceof DateTimeInterface)) {
            throw new \Laminas\Cache\Psr\CacheItemPool\InvalidArgumentException('$expiration must be null or an instance of DateTimeInterface');
        }
    ...
    public function expiresAfter($time)
    {
        if ($time instanceof DateInterval) {
            ...
            throw new \Laminas\Cache\Psr\CacheItemPool\InvalidArgumentException(sprintf('Invalid $time "%s"', gettype($time)));
        }
