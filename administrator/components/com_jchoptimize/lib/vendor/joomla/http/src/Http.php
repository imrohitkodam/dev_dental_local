 ...
 */
namespace _JchOptimizeVendor\Joomla\Http;
...
class Http implements ClientInterface
{
    ...
    public function sendRequest(RequestInterface $request) : ResponseInterface
    {
        ...
        return $this->makeTransportRequest($request->getMethod(), new Uri((string) $request->getUri()), empty($data) ? null : $data, $request->getHeaders());
    }
    /**
    ...
    protected function makeTransportRequest($method, $url, $data = null, array $headers = [], $timeout = null)
    {
        ...
        if (\is_string($url)) {
            ...
            throw new \InvalidArgumentException(\sprintf('A string or %s object must be provided, a "%s" was provided.', UriInterface::class, \gettype($url)));
        }
