...
use _JchOptimizeVendor\Doctrine\Inflector\Rules\Pattern;
use _JchOptimizeVendor\Doctrine\Inflector\Rules\Substitution;
use _JchOptimizeVendor\Doctrine\Inflector\Rules\Transformation;
use _JchOptimizeVendor\Doctrine\Inflector\Rules\Word;
class Inflectible
{
    /**
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), '_JchOptimizeVendor\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), '_JchOptimizeVendor\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), '_JchOptimizeVendor\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), '_JchOptimizeVendor\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), '_JchOptimizeVendor\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), '_JchOptimizeVendor\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), '_JchOptimizeVendor\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), '_JchOptimizeVendor\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), '_JchOptimizeVendor\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), '_JchOptimizeVendor\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), '_JchOptimizeVendor\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), '_JchOptimizeVendor\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), '_JchOptimizeVendor\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), '_JchOptimizeVendor\\1\\2oes'));
