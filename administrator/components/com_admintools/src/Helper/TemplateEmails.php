...
abstract class TemplateEmails
{
	...
	private const EMAIL_DEFINITIONS = [
        ...
        'com_admintools.delugerequests'       => [
            'subject'       => 'COM_ADMINTOOLS_EMAIL_DELUGEREQUESTS_SUBJECT',
            'bodyPlaintext' => 'COM_ADMINTOOLS_EMAIL_DELUGEREQUESTS_BODY',
            'bodyHtml'      => 'COM_ADMINTOOLS_EMAIL_DELUGEREQUESTS_BODY_HTML',
            'variables'     => [
                'SITENAME',
                'DATE',
                'NUM',
	...
	public static function sendMail(string $key, array $data, ?User $user = null, string $forceLanguage = null, bool $throw = false): bool
	{
		...
		try
		{
			...
			if (ComponentHelper::getParams('com_admintools')->get('workaround_mailtemplate', 1))
			{
