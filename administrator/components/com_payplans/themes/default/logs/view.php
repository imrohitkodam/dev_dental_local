					...
					<tr class="<?php echo $diff ? " info":""; ?>">
						...
						<td>
							...
							<?php elseif($key === 'status'):?>
								<?php echo (isset($pre_value) && "" !== PPJString::trim($pre_value)) ? JText::_('COM_PAYPLANS_STATUS_'.PayplansStatus::getName($pre_value)):"&nbsp;";?>
						...
						<td>
							...
							elseif($key ==='status'):?>
								<?php echo (isset($cur_value) && "" !== PPJString::trim($cur_value)) ? JText::_('COM_PAYPLANS_STATUS_'.PayplansStatus::getName($cur_value)):"&nbsp;";?>
