		...
		<div class="app-filter-bar">
			...
			<div class="app-filter-bar__cell app-filter-bar__cell--divider-left">
				<div class="app-filter-bar__search-input-group">
					<?php echo $this->fd->html('filter.daterange', $states->dateRange, 'dateRange', 'COM_PP_FILTER_LOG_DATE'); ?>
				</div>
			</div>
			
			<?php echo $this->html('filter.logclass', 'class', 'log', $states->class, 'filter_payplans', ['none' => JText::_('COM_PAYPLANS_SELECT_LOGLEVEL')]); ?>

			<?php echo $this->html('filter.loglevel', 'level', 'log', $states->level, 'filter_payplans', ['none' => JText::_('COM_PAYPLANS_SELECT_LOGCLASS')]); ?>
			...
			<tbody>
				<?php if ($logs) { ?>
					...
					<tr>
						...
						<td>
							<a href="javascript:void(0);" data-pp-log-details data-id="<?php echo $log->log_id;?>">
						...
						<td class="center">
							<?php echo PP::date($log->created_date, true)->toDisplay(JText::_('DATE_FORMAT_LC2')); ?>
						</td>
