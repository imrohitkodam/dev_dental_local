...
<dialog>
	...
	<title><?php echo JText::sprintf('COM_PP_VIEW_PAYMENT_NOTIFICATION_LOG'); ?></title>
	<content>
	...
	<buttons>
		<?php echo $this->fd->html('dialog.button', 'COM_PP_CLOSE_BUTTON', 'default', ['attributes' => 'data-close-button']); ?></button>
	</buttons>
</dialog>
