...
<span data-table-grid-search>
	<input type="text" class="o-form-control app-filter-bar__search-input" name="<?php echo $name;?>" value="<?php echo $this->html('string.escape', $value);?>" placeholder="<?php echo JText::_('COM_PP_USERNAME', true);?>" data-table-grid-search-input />
