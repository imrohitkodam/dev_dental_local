			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs nav-tabs-icons">
					<li class="<?php echo !$activeTab || $activeTab == 'details' ? 'active' : '';?>">
						<a href="#details" data-pp-toggle="tab" data-id="details"><?php echo JText::_('COM_PP_DETAILS'); ?></a>
					</li>
					<li class="<?php echo $activeTab == 'transactions' ? 'active' : '';?>">
						<a href="#transactions" data-pp-toggle="tab" data-id="transactions"><?php echo JText::_('COM_PP_TRANSACTIONS'); ?></a>
					</li>
					<li class="<?php echo $activeTab == 'logs' ? 'active' : '';?>">
						<a href="#logs" data-pp-toggle="tab" data-id="logs"><?php echo JText::_('COM_PP_LOGS'); ?></a>
					</li>
				</ul>
