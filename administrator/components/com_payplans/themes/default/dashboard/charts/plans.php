...
<div class="panel">
	<div class="db-panel__hd">
		<b class="panel-head-title"><?php echo JText::_('COM_PP_DASHBOARD_PLANS_OVERVIEW'); ?></b>
		<div class="panel-info"><?php echo JText::_('COM_PP_DASHBAORD_PLANS_OVERVIEW_DESC'); ?></div>
	</div>

	<div data-dashboard-plans-tab style="padding: 20px;">
		...
		<div id="canvas-holder" style="min-height: 250px;">
			<canvas id="chart-area" height=""></canvas>
		</div>
