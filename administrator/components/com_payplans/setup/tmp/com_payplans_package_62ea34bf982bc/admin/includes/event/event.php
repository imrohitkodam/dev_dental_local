...
class PPEvent
{
	 ...
	 * @access	public
	 */
	public static function trigger($eventName, $args = [], $purpose = '', $refObject = null)
	{
		...
		if (is_object($pluginResults)) {

			$pluginResults = PP::makeArray($pluginResults);
			// lets unset unnessary attribut.
			if (isset($pluginResults['name'])) {
				unset($pluginResults['name']);
			}

			if (isset($pluginResults['arguments'])) {
				unset($pluginResults['arguments']);
			}

			if (isset($pluginResults['stopped'])) {
				unset($pluginResults['stopped']);
			}
		}
	 ...
	 * @access	public
	 */
	public static function triggerInternal($eventName, $args = [])
	{
		// Get plugins
