...
class PayplansGdprSection
{
	...
	public function __construct(PPUser $user, $name, $title = '', $subfolder = false)
	{
		$this->user = $user;
		$this->key = $name;
		$this->title = $title;
		...
		$this->path = PPGdpr::getUserTempPath($user);
	...
	public function createIndexFile($sidebar)
	{
		...
		<div class="gdpr-jumbo">
			<h1><?php echo JText::_('COM_PAYPLANS_GDPR_YOUR_DATA');?></h1>
			<p>
				<?php echo JText::_('COM_PAYPLANS_GDPR_DOWNLOAD_DATA_DETAILS');?>
			</p>
		</div>	
		<?php 
				...
				<div class="gdpr-container">
					...
					<div class="gdpr-container__content">
						<div class="gdpr-header">
							<?php if ($hasBack) { ?>
							<div class="gdpr-back"><a href="javascript:history.go(-1);"><?php echo JText::_('COM_PAYPLANS_BACK'); ?></a></div>
							<?php } ?>
	...
	public function createTab($adapter, $title = '')
	{
		...
		$tab = new PayplansGdrpTab($adapter, $title, $rootPath);
