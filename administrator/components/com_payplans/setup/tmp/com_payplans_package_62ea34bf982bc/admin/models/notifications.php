...
class PayplansModelNotifications extends PayPlansModel
{
	...
	public function getFileObject($absolutePath, $contents = false, $isCore = false)
	{
		...
		$overridePath = $this->getOverridePath($file->name);
	...
	/**
	 * Retrieve the path of the overriden location
	 *
	 * @since	5.0.1
	 * @access	public
	 */
	public function getOverridePath($name = null)
	{
		$path = JPATH_ROOT . '/templates/' . $this->getCurrentTemplate() . '/html/com_payplans/emails/templates';
