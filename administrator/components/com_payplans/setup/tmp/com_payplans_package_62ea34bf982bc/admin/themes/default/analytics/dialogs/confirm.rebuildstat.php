...
<dialog>
	...
	<buttons>
		<?php echo $this->fd->html('dialog.button', 'COM_PAYPLANS_AJAX_CLOSE_BUTTON', 'warning', ['attributes' => 'data-cancel-button']); ?>
		<?php echo $this->fd->html('dialog.button', 'COM_PAYPLANS_JS_DASHBOARD_REBUILD_START_DIALOG_TITLE', 'default', ['attributes' => 'data-start-button']); ?>
	</buttons>
</dialog>