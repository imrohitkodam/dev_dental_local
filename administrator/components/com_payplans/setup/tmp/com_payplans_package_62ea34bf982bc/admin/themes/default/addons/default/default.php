		...
		<table class="app-table table">
			<thead>
				<tr>
					...
					<th width="5%" class="center">
						<?php echo JText::_('COM_PP_TABLE_COLUMN_CONSUMED'); ?>
					</th>
					...
					<th width="5%" class="hidden-phone center">
						<?php echo $this->html('grid.sort', 'ordering', 'COM_PP_PLANADDON_GRID_ORDERING', $states); ?>
						<?php echo $this->html('grid.order' , $addons, 'addons'); ?>
					</th>
			...
			<tbody>
				<?php if ($addons) { ?>
					...
					<tr>
						...
						<td class="center">
							<?php echo $addon->getConsumed(); ?>
						</td>

						<td class="center">
							<?php echo ($addon->getStartDate()) ? PP::date($addon->getStartDate(), true)->toDisplay(JText::_('DATE_FORMAT_LC1')) : JText::_('COM_PP_NEVER'); ?>
						</td>

						<td class="center">
							<?php echo ($addon->getEndDate()) ? PP::date($addon->getEndDate(), true)->toDisplay(JText::_('DATE_FORMAT_LC1')) : JText::_('COM_PP_NEVER'); ?>
						</td>
						...
						<td class="center order"> 
							<?php echo $this->html('grid.ordering', count($addons), ($i + 1),  $states->ordering,  $addon->ordering, 'addons'); ?> 
						</td>
