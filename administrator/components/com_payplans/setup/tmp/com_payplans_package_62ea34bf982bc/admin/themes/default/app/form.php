...
<form action="<?php echo $uri; ?>" method="post" name="adminForm" id="adminForm">
	...
	<li class="active"><a data-pp-toggle="tab"href="#ppinstall" id="installedapps" >Available</a></li>
	<li class=""><a data-pp-toggle="tab" id="manageapps" href="#ppmanage">App instance</a></li>
	<li class=""><a data-pp-toggle="tab"href="#ppavailable" target="_blank" id="availableapps">App store</a></li></ul>
