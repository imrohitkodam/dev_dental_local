...
<dialog>
	...
	<buttons>
		<?php echo $this->fd->html('dialog.button', 'COM_PP_CLOSE_BUTTON', 'danger', ['attributes' => 'data-cancel-button']); ?>
		<?php echo $this->fd->html('dialog.button', 'COM_PP_ADD_INVOICE_BUTTON', 'default', ['attributes' => 'data-submit-button']); ?>
	</buttons>
</dialog>
