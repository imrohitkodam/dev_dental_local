...
<div class="" data-pp-form-user>
	<div class="o-input-group" >
		<input type="text" class="o-form-control" disabled="disabled" size="35" placeholder="<?php echo JText::_('COM_PP_BROWSE_USER');?>" data-pp-form-user-preview />
		
		<span class="o-input-group__append">
			<a href="javascript:void(0);" class="btn btn-pp-default-o" data-pp-form-user-browse>
				<i class="fdi fa fa-user"></i> <?php echo JText::_('COM_PP_BROWSE_BUTTON'); ?>
			</a>
