		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->fd->html('settings.dropdown', 'account_verification', 'COM_PP_CONFIG_GENERAL_REGISTRATION_VERIFICATION', [
						...
						return $this->fd->html('alert.standard', JText::_('COM_PP_CONFIG_GENERAL_REGISTRATION_VERIFICATION_NOTICE'), 'warning', [
							'dismissible' => false,
							'customClass' => $this->config->get('account_verification') == 'user' ? 'mt-md' : 'mt-md t-hidden',
