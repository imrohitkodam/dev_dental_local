...
if (!PP::isFoundryEnabled()) {
	return PP::raiseWarning(404, JText::_('Please ensure that the plugin <b>Foundry by Stackideas</b> is enabled on the site. Go to <a href="index.php?option=com_plugins&view=plugins&filter[search]=Foundry">Joomla! plugin manager</a>'));
}
