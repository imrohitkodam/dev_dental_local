...
// dump($pagination);
	...
	public function form($tpl = null)
	{
		...
		$options = ['object_id' => $planId, 'class' => 'plan', 'level' => 'all'];
	...
	{
		$data = [
			'forever' => ['title' => 'COM_PP_PLAN_TIME_EXPIRATION_FOREVER', 'value' => 'forever', 'for' => 'data-expire-forever'],
			'fixed' => ['title' => 'COM_PP_PLAN_TIME_EXPIRATION_FIXED', 'value' => 'fixed', 'for' => 'data-expire-fixed'],
			'recurring' => ['title' => 'COM_PP_PLAN_TIME_EXPIRATION_RECURRING', 'value' => 'recurring', 'for' => 'data-expire-recurring'],
			'recurring_trial_1' => ['title' => 'COM_PP_PLAN_TIME_EXPIRATION_RECURRING_TRIAL_1', 'value' => 'recurring_trial_1', 'for' => 'data-expire-recurring-trial-1'],
			'recurring_trial_2' => ['title' => 'COM_PP_PLAN_TIME_EXPIRATION_RECURRING_TRIAL_2', 'value' => 'recurring_trial_2', 'for' => 'data-expire-recurring-trial-2']
		];
