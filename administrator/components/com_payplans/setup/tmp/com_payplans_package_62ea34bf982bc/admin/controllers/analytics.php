...
class PayplansControllerAnalytics extends PayPlansController
{
	...
	public function getStatistic()
	{
		...
		$graphStatistics = $statistics->getStatisticsGraph($duration, [$customStartDate, $customEndDate], $type, $dummyData);

		$actionlog->log('COM_PP_ACTIONLOGS_ANALYTICS_UPDATE_STATS_' . strtoupper($type), 'analytics');
	...
	public function rebuildStat()
	{
		...
		$actionlog->log('COM_PP_ACTIONLOGS_ANALYTICS_REBUILD_STATS_' . strtoupper($type), 'analytics');
