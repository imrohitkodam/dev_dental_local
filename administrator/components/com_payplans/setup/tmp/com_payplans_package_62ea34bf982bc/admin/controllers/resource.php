...
class PayplansControllerResource extends PayplansController
{
	...
	public function delete()
	{
		...
		$this->info->set('COM_PP_RESOURCE_DELETE_SUCCESS', 'success');
	...
	public function store()
	{
		...
		$subscriptionIds = $this->input->get('subscription_ids', [], 'array');
		...
		$task = $this->getTask();
		$this->info->set('COM_PP_RESOURCE_UPDATED_SUCCESS', 'success');
