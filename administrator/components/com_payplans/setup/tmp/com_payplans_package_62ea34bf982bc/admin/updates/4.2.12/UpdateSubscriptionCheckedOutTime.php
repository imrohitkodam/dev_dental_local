...
class PPMaintenanceScriptUpdateSubscriptionCheckedOutTime extends PPMaintenanceScript
{
	public static $title = "Updating subscription checked out value";
	public static $description = "Updating subscription checked out value";
