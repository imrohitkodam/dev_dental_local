...
#pp .pp-checkout-container {
	...
	/*Follow Foundry utilities.css*/
	#pp .text-success-500 {
		color: #0BA97B !important;
	}
	#pp .bg-success-100 {
	...
	#pp .bg-warning-100 {
		background-color: rgb(255, 244, 236) !important;
	}

	#pp .text-primary-500 {
		color: rgb(78, 114, 226) !important;
	}
	#pp .bg-primary-100 {
		background-color: rgb(237, 241, 252) !important;
	}
