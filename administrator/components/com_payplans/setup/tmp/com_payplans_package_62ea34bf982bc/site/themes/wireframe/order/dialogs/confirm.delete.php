...
<dialog>
	...
	<title><?php echo JText::_('COM_PAYPLANS_ORDER_DELETE_CONFIRM_WINDOW_TITLE'); ?></title>
	<content>
		<form action="<?php echo JRoute::_('index.php');?>" method="post" data-submit-form>
			<p>
				<?php echo JText::_('COM_PAYPLANS_ORDER_DELETE_CONFIRM_WINDOW_MSG'); ?>
			</p>
			<?php echo $this->html('form.action', 'order', 'deleteSubscription'); ?>
