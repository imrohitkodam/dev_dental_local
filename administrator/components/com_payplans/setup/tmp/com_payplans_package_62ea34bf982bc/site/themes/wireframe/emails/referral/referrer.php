...
?>
<?php echo $this->renderHeader('COM_PP_REFERRAL_NEW_REFERRAL_HEADING'); ?>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														<p>
															<?php echo nl2br(JText::sprintf('COM_PP_REFERRAL_NEW_REFERRAL_CONTENTS', $this->isPreview() ? '$100' : $amount)); ?>
														</p>

														<div style="background: #f8f8f8;padding: 20px;">
															<?php if ($this->isPreview()) { ?>
																<code><b>EXAMPLE_REFERRAL_CODE</b></code><br />
															<?php } else { ?>
																<code><b><?php echo $code;?></b></code><br />
															<?php } ?>
														</div>
													</div>
												</td>
