...
<div class="flex px-md py-2xl flex-col md:flex-row gap-sm" data-pp-form-group>
	<div class="md:w-[320px] flex-shrink-0">
		<?php echo $this->fd->html('form.label', $field->title, '', '', '', false, ['columns' => 6]); ?>
	</div>
		...
		<div class="flex gap-xs">
			<div class="flex-grow">
				<div class="o-form-group space-y-xs">
					<?php echo $this->html('form.toggler', $type . '[' . $field->name . ']', $this->html('string.escape', $field->value), '',$field->attributes, $field->options);?>
				</div>
