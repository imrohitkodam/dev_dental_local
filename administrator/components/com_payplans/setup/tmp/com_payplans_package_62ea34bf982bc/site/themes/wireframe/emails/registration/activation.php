											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														...
														<p>
															<?php echo JText::sprintf('COM_PP_EMAIL_THANK_YOU_REGISTER_ACTIVATION', $this->isPreview() ? 'Site Name' : $siteName, $this->isPreview() ? JURI::root() : $siteUrl);?>
														</p>

														<p>
															<?php echo JText::_('COM_PP_EMAIL_AFTER_ACTIVATION_LOGIN');?>
														</p>
