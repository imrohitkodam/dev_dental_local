...
?>
<div class="flex px-md py-2xl flex-col md:flex-row gap-sm" data-pp-form-group data-type="checkbox" <?php echo isset($field->attributes['required']) ? 'required' : ''; ?>>
			...
			<div class="flex-grow">
				<div class="o-form-group space-y-xs">
					<?php foreach ($field->options as $option) { ?>
						<?php echo $this->fd->html('form.checkbox', $name, !empty($field->value) && in_array($option->value, $field->value), $option->value, '', $option->title);?>
					<?php } ?>
				</div>
