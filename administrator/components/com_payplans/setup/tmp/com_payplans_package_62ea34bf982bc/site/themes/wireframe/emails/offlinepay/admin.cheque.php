...
?>
<?php echo $this->renderHeader('COM_PP_OFFLINE_PAY_ADMIN_HEADING', 'COM_PP_OFFLINE_PAY_ADMIN_HEADING_SUBTITLE'); ?>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														<p>
															<?php echo nl2br(JText::sprintf('COM_PP_OFFLINE_PAY_ADMIN_CONTENTS', '<b>' . $this->config->get('sitename') . '</b>')); ?>
														</p>
															...
															<table align="center" style="padding: 20px;">
																...
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_NAME');?>:</b>
																	</td>						
																	<td>
																...
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_EMAIL_ADDRESS');?>:</b>
																	</td>
																	<td>
																		<?php if ($this->isPreview()) { ?>
																			customer@email.com
																...
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_USERNAME');?>:</b>
																	</td>
																	<td>
																		<?php if ($this->isPreview()) { ?>
																			username
																		<?php } else { ?>
																			<?php echo $buyer->getUsername();?>
																		<?php } ?>
																	</td>
																</tr>
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_PAYMENT_MODE');?>:</b>
																	</td>
																	<td>
																		<?php if ($this->isPreview()) { ?>
																			Payment mode
																		<?php } else { ?>
																			<?php echo $params->get('from');?>
																		<?php } ?>
																	</td>
																</tr>
																<tr>
																	<td align="right" style="padding: 10px;">
																		<b><?php echo JText::_('COM_PP_CHEQUE_NUMBER');?>:</b>
																	</td>
																	<td>
																		<?php if ($this->isPreview()) { ?>
																			123456789
																		<?php } else { ?>
																			<?php echo $params->get('id');?>
																		<?php } ?>
																	</td>
																</tr>
																</tbody>
