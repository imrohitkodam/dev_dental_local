...
?>
<?php echo $this->renderHeader('COM_PP_DOWNLOADS_EMAIL_HEADING', 'COM_PP_DOWNLOADS_EMAIL_HEADING_SUBTITLE'); ?>
											...
											<tr>
												<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
													<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
														<p><?php echo JText::sprintf("COM_PAYPLANS_EMAILS_GDPR_DOWNLOAD_DESCRIPTION", $this->isPreview() ? 'javascript:void(0);' : $downloadLink); ?></p>
													</div>
												</td>
											</tr>
										</table>
...
<?php echo $this->renderButton($this->isPreview() ? 'javascript:void(0);' : $downloadLink, JText::_('COM_PP_DOWNLOAD') . ' &rarr;'); ?>