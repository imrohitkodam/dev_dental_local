...
class PayplansControllerInstallPost extends PayplansSetupController
{
	...
	public function createSamplePlans()
	{
		...
		$plans = [
			[
				...
				'description' => $lipsum,
				'ordering' => 1,
				'details' => '{"expirationtype":"fixed","expiration":"000000000000","recurrence_count":"1","price":"20.00","trial_price_1":"0.00","trial_time_1":"000000000000","trial_price_2":"0.00","trial_time_2":"000000000000","currency":"USD"}',
				'params' => '{"teasertext":"Some teaser text","redirecturl":"","badgeVisible":"","badgePosition":"right","badgeTitle":"","badgeTitleColor":"","badgebackgroundcolor":"","planHighlighter":"","limit_count":"","scheduled":"","start_date":"2020-06-03","end_date":"2020-06-03","total_count":"0","moderate_subscription":"","parentplans":"","displaychildplanon":"-2","expiration_date":"2020-06-03","subscription_from":"","subscription_to":"","enable_fixed_expiration_date":""}'
			],
			[
				'title' => 'Sample Plan B',
				'published' => true,
				...
				'description' => $lipsum,
				'ordering' => 2,
				'details' => '{"expirationtype":"forever","expiration":"000000000000","recurrence_count":"1","price":"0.00","trial_price_1":"0.00","trial_time_1":"000000000000","trial_price_2":"0.00","trial_time_2":"000000000000","currency":"USD"}',
				'params' => '{"teasertext":"Some teaser text for plan b","redirecturl":"","badgeVisible":"","badgePosition":"right","badgeTitle":"","badgeTitleColor":"","badgebackgroundcolor":"","planHighlighter":"","limit_count":"","scheduled":"","start_date":"2020-06-03","end_date":"2020-06-03","total_count":"0","moderate_subscription":"","parentplans":"","displaychildplanon":"-2","expiration_date":"2020-06-03","subscription_from":"","subscription_to":"","enable_fixed_expiration_date":""}'
			],
			[
				'title' => 'Sample Plan C',
				'published' => true,
				...
				'description' => $lipsum,
				'ordering' => 3,
				'details' => '{"expirationtype":"fixed","expiration":"000100000000","recurrence_count":"1","price":"30.00","trial_price_1":"0.00","trial_time_1":"000000000000","trial_price_2":"0.00","trial_time_2":"000000000000","currency":"USD"}',
				'params' => '{"teasertext":"Some teaser text for plan c","redirecturl":"","badgeVisible":"1","badgePosition":"right","badgeTitle":"POPULAR","badgeTitleColor":"#ffffff","badgebackgroundcolor":"#f50303","planHighlighter":"1","limit_count":"","scheduled":"","start_date":"2020-06-03","end_date":"2020-06-03","total_count":"0","moderate_subscription":"","parentplans":"","displaychildplanon":"-2","expiration_date":"2020-06-03","subscription_from":"","subscription_to":"","enable_fixed_expiration_date":""}'
			]
		];
	...
	public function createDefaultMenu()
	{
		...
		// Get any menu items that are already created with com_payplans
		$query = array();
		...
		// Create a default plan menu item
		$planMenu = JTable::getInstance('Menu');
		$planMenu->menutype = $menuType;
		$planMenu->title = JText::_('COM_PP_INSTALLATION_DEFAULT_MENU_PLANS');
		$planMenu->alias = 'plans';
		$planMenu->path = 'plans';
		$planMenu->link = 'index.php?option=com_payplans&view=plan&plan_id=0&group_id=0';
		$planMenu->type = 'component';
		$planMenu->published = 1;
		$planMenu->parent_id = 1;
		$planMenu->component_id = $extensionId;
		$planMenu->client_id = 0;
		$planMenu->language = '*';
		$planMenu->img = '';
		$planMenu->params = '';

		$planMenu->setLocation('1', 'last-child');

		$state = $planMenu->store();
	...
	public function installActionLogs()
	{
		...
		if (!$hasActionsLog) {
			return $this->getResultObj('COM_PP_INSTALLATION_USER_ACTIONS_LOGS_NOT_SUPPORTED', true);
		}
