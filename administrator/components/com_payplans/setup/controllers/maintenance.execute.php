...
class PayPlansControllerMaintenanceExecute extends PayPlansSetupController
{
	public function execute()
	{
		...
		if ($this->isDevelopment()) {
			...
			$message = JText::sprintf('COM_PP_INSTALLATION_MAINTENANCE_EXECUTED_SCRIPT', $title);
			return $this->output($this->getResultObj($message, true));
		}
