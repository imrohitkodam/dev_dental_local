...
class PayplansViewAutomation extends PayPlansAdminView
{
	...
	public function create()
	{
		...
		$customApps = $appModel->getCustomApps('automation');
	...
	public function form()
	{
		...
		if ($element) {
			...
			$appManifest = $model->getApp($element, 'automation');
		...
		if ($id) {
			...
			$appManifest = $model->getApp($app->type, 'automation');

			$params = $app->getAppParams();
		}

		// help button for documentation links
		if ($appManifest && $appManifest->documentation) {
