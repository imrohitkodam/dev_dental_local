...
class PayplansViewLog extends PayPlansAdminView
{
	...
	public function display($tpl = null)
	{
		...
		$this->addHelpButton('https://stackideas.com/docs/payplans/administrators/logs-and-reports/logs');
	...
	public function payments()
	{
		...
		$this->addHelpButton('https://stackideas.com/docs/payplans/administrators/logs-and-reports/payment-notification');
