...
class PayPlansViewGroup extends PayPlansAdminView
{
	...
	public function display($tpl = null)
	{
		...
		$this->addHelpButton('https://stackideas.com/docs/payplans/administrators/plans/plan-groups');
		...
		$redirectLink = rtrim(JURI::root(), '/') . '/administrator/index.php?option=com_payplans&view=config&layout=plans';
