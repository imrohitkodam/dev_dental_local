...
class PayplansViewTransaction extends PayPlansAdminView
{
	...
	public function display($tpl = null)
	{
		...
		$states = $this->getStates(['search', 'created_date', 'amount', 'username', 'invoice_id', 'app_id', 'ordering', 'direction', 'limit', 'dateRange']);
	...
	public function form($tpl = null)
	{
		...
		if ($payment->getId() && ($payment instanceof PPPayment)) {
			...
			if ($gateway) {
				...
				$transactionParams = PPJString::trim($transactionParams);
			}
		}
