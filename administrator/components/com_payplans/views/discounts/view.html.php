...
class PayPlansViewDiscounts extends PayPlansAdminView
{
	...
	public function display($tpl = null)
	{
		...
		JToolbarHelper::publish('discounts.publish');
		JToolbarHelper::unpublish('discounts.unpublish');
		JToolbarHelper::deleteList(JText::_('COM_PP_DELETE_SELECTED_ITEMS'), 'discounts.delete');

		$this->addHelpButton('https://stackideas.com/docs/payplans/administrators/discounts-and-referrals/discounts');
		...
		$states = $this->getStates(['search', 'published', 'ordering', 'direction', 'limit'], $model);
	...
	public function form($generator = false)
	{
		...
		$heading = 'Discounts Form';

		if ($id) {
			$heading = 'Discounts Edit Form';
		}
	...
	{
		$this->addHelpButton('https://stackideas.com/docs/payplans/administrators/discounts-and-referrals/coupon-generator');
