...
class PayPlansViewAddons extends PayPlansAdminView
{
	...
	public function display($tpl = null)
	{
		...
		$this->addHelpButton('https://stackideas.com/docs/payplans/administrators/plans/plan-addons');
		...
		$states = $this->getStates(['search', 'published', 'limit', 'ordering', 'direction'], $model);
	...
	public function form()
	{
		...
		$priceTypes = [
			0 => JText::_('COM_PP_ADDONS_PRICE_FIXED'), 
			1 => JText::_('COM_PP_ADDONS_PRICE_PERCENTAGE')
		];

		$taxesTypes = [
			'PERCENT_OF_SUBTOTAL_NON_TAXABLE' => JText::_('COM_PP_ADDONS_NON_TAXABLE'),
		...
		$availabilityTypes = [
			0 => JText::_('COM_PP_ADDONS_AVAILABILITY_UNLIMITED'), 
			1 => JText::_('COM_PP_ADDONS_AVAILABILITY_LIMITED')
		];
