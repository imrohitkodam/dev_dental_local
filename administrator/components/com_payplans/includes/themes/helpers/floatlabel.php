...
class PPThemesHelperFloatLabel extends PPThemesHelperAbstract
{
	 ...
	 * @access	public
	 */
	public function lists($label, $name, $value, $id = '', $attributes = '', $options = [])
	{
		if (!$id) {
			$id = $name;
		}
	 ...
	 * @access	public
	 */
	public function toggler($label, $name, $value, $id = '', $attributes = '', $options = [])
	{
		if (!$id) {
			$id = $name;
		}
	 ...
	 * @access	public
	 */
	public function telephone($label, $name, $value, $id = '', $attributes = '', $options = [], $readOnly = false)
	{
		if (!$id) {
			$id = $name;
		}
	 ...
	 * @access	public
	 */
	public function file($label, $name, $value, $id = '', $attributes = [], $options = [])
	{
		if (!$id) {
			$id = $name;
		}
