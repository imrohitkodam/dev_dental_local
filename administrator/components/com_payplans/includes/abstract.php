...
class PPAbstract
{
	...
	{
		$name = PPJString::strtolower($name);

		JError::raiseError(500, JText::_('COM_PAYPLANS_ERROR_PARAMETER_MUST_BE_AN_OBJECT'));
		JError::raiseError(500, JText::_('COM_PAYPLANS_ERROR_INVALID_PARAMETER_NAME_TO_RENDER'));
