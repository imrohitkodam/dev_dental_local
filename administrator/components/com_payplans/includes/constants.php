...
define('PP_JOOMLA_ADMIN', JPATH_ADMINISTRATOR);
...
define('PP_STATISTICS_TYPE_MEMBERS', 'members');
...
define('PP_DISCOUNTS_TYPE_GLOBAL', 'global');
define('PP_DISCOUNTS_TYPE_GIFT', 'gift');
define('PP_DISCOUNTS_TYPE_REFERRAL', 'referral');
...
define('PP_EUVAT_PURPOSE_BUSINESS_NO_VAT', 3);

define('PP_JROUTER_MODE_SEF', 1);

/*
 * Constants used for SEO
 */
define('PP_META_TYPE_CHECKOUT', 'checkout');
define('PP_META_TYPE_PAYMENT', 'payment');
define('PP_META_TYPE_THANKS', 'thanks');

/*
 * Constants used for Custom Details
 */
define('PP_CUSTOM_DETAILS_TYPE_USER', 'user');
define('PP_CUSTOM_DETAILS_TYPE_SUBSCRIPTION', 'subscription');
