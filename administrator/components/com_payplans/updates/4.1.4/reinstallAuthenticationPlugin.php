...
class PPMaintenanceScriptReinstallAuthenticationPlugin extends PPMaintenanceScript
{
	public static $title = "Reinstall Authentication plugin for Payplans";
	public static $description = "To ensure site installed with Payplans authentication plugin.";
