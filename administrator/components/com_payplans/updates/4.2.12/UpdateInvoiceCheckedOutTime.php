...
class PPMaintenanceScriptUpdateInvoiceCheckedOutTime extends PPMaintenanceScript
{
	public static $title = "Updating invoice checked out value";
	public static $description = "Updating invoice checked out value";
