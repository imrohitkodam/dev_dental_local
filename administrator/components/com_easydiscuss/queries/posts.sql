...
CREATE TABLE IF NOT EXISTS `#__discuss_thread` (
  ...
  `last_poster_email` varchar(255) NOT NULL DEFAULT '',
  ...
  KEY `idx_post_type` ( `post_type` (190)),
...
CREATE TABLE IF NOT EXISTS `#__discuss_honeypot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__discuss_activities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_types` (`utype`, `uid`),
  KEY `idx_created` (`created`),
  KEY `idx_activities` (`utype`, `uid`, `created`)
) DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS `#__discuss_post_reject` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
