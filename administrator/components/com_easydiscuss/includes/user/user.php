...
class EasyDiscussUser
{
	...
	public function __construct($id = null, $resetCache = false, $debug = false)
	{
		$item = self::loadUsers($id, $resetCache, $debug);
	 ...
	 * @access	public
	 */
	public static function factory($ids = null, $resetCache = false, $debug = false)
	{
		$items	= self::loadUsers($ids, $resetCache, $debug);
		return $items;
	}
	 ...
	 * @access	public
	 */
	public static function createGuestObject($resetCache = false)
	{
		// Ensure that this block of creation only runs once throughout the site
		if (!isset(EasyDiscussUserStorage::$users[0]) || $resetCache) {
	 ...
	 * @access	public
	 */
	public static function loadUsers($ids = null, $resetCache = false, $debug = false)
	{
		...
		self::createGuestObject($resetCache);
