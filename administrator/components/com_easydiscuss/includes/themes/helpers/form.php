...
class EasyDiscussThemesHelperForm
{
	...
	/**
	 * Renders an ordering hidden input
	 *
	 * @since	5.0.7
	 * @access	public
	 */
	public function ordering($ordering, $orderingDirection)
	{
		$theme = ED::themes();
		$theme->set('ordering', $ordering);
		$theme->set('orderingDirection', $orderingDirection);

		$output = $theme->output('admin/html/form/ordering');
	 ...
	 * @access  public
	 */
	public function password($name, $id = null, $value = '', $class = '', $options = [])
	{
		$placeholder = '';
		$attributes = '';
