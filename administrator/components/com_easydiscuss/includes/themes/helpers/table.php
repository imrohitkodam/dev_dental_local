...
class EasyDiscussThemesHelperTable
{
	...
	public function saveorder()
	{
		...
		return $theme->output('admin/html/table.saveorder');
	}
	...
	{
		$class = ED::normalize($options, 'class', '');
		$title = JText::_($title);
		...
		$theme->set('currentDirection', $currentDirection);

		return $theme->output('admin/html/table.sort');
	}
