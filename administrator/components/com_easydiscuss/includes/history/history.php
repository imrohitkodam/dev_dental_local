...
class EasyDiscussHistory extends EasyDiscuss
{
	 ...
	 * @access	private
	 **/
	public function log($command, $userId, $title, $content_id = 0, $validate = true)
	{
		...
		// Only process this if need to validate the point rules whether exist or publish or not
		if ($validate) {
			$point = ED::points();
