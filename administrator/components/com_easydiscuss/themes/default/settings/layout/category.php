		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'layout_single_category_post_limit', 'COM_EASYDISCUSS_SINGLE_CATEGORY_POST_LIMIT', '', ['size' => 7, 'postfix' => 'COM_ED_POSTS'], '', '', 'text-center'); ?>
				</div>
			</div>
		</div>
	</div>
