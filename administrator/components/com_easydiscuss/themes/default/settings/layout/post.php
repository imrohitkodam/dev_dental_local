		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'layout_replies_list_limit', 'COM_EASYDISCUSS_REPLIES_LIST_LIMIT', '', ['size' => 8, 'postfix' => 'COM_EASYDISCUSS_REPLIES'], '', '', 'text-center'); ?>
					...
					<?php echo $this->html('settings.dropdown', 'main_post_activity', 'COM_ED_POST_ACTIVITY_LOGS', '', [
							'moderator' => JText::_('COM_ED_POST_ACTIVITY_LOGS_MODERATOR_OPTION'),
							'everyone' => JText::_('COM_ED_POST_ACTIVITY_LOGS_EVERYONE_OPTION'),
							'disable' => JText::_('COM_ED_POST_ACTIVITY_LOGS_DISABLE_OPTION')
						]
					);?>
					...
					<?php echo $this->html('settings.dropdown', 'layout_replies_dateformat', 'COM_ED_SETTINGS_LAYOUT_REPLIES_DATEFORMAT', 'default',
						array(
							'default' => JText::_('COM_ED_SETTINGS_LAYOUT_REPLIES_DATEFORMAT_DEFAULT'),
							'timestamp' => JText::_('COM_ED_SETTINGS_LAYOUT_REPLIES_DATEFORMAT_TIMESTAMP')
						)
					);?>
