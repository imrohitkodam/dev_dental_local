		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'layout_list_limit', 'COM_EASYDISCUSS_LIST_LIMIT', '', ['size' => 7, 'postfix' => 'COM_ED_POSTS'], '', '', 'text-center'); ?>
					<?php echo $this->html('settings.textbox', 'layout_daystostaynew', 'COM_EASYDISCUSS_NUMBER_OF_DAYS_A_POST_STAY_AS_NEW', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_DAYS'], '', '', 'text-center'); ?>
