		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.toggle', 'layout_post_creationdate', 'COM_ED_SETTINGS_LAYOUT_POST_CREATIONDATE'); ?>
					<?php echo $this->html('settings.dropdown', 'layout_post_creationdate_format', 'COM_ED_SETTINGS_LAYOUT_CREATIONDATE_DATEFORMAT', 'default',
						array(
							'default' => JText::_('COM_ED_SETTINGS_LAYOUT_CREATIONDATE_DATEFORMAT_DEFAULT'),
							'timestamp' => JText::_('COM_ED_SETTINGS_LAYOUT_CREATIONDATE_DATEFORMAT_TIMESTAMP')
						)
					);?>
				</div>
			</div>
