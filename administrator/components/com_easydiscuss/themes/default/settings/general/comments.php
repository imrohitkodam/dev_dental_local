		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php
						$dateSourceOptions = [
							'default' => 'COM_ED_COMMENTS_DATE_SOURCE_DEFAULT',
							'created' => 'COM_ED_COMMENTS_DATE_SOURCE_CREATED',
							'modified' => 'COM_ED_COMMENTS_DATE_SOURCE_MODIFIED'
						];
					?>

					<?php echo $this->html('settings.dropdown', 'main_comment_date_source', 'COM_ED_COMMENTS_DATE_SOURCE_SETTINGS', '', $dateSourceOptions); ?>

					<?php echo $this->html('settings.textbox', 'main_comment_pagination_count', 'COM_ED_COMMENT_FIRST_SIGHT_COUNT', '', ['size' => 8, 'postfix' => 'COM_EASYDISCUSS_COMMENT'], '', '', 'text-center'); ?>
				</div>
			</div>
		</div>
	</div>
