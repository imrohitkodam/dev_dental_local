		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					<?php echo $this->html('settings.dropdown', 'social_buttons_type', 'COM_ED_SETTINGS_SOCIAL_BUTTONS_TYPE', '', ['default' => 'COM_ED_DEFAULT', 'addthis' => 'AddThis', 'sharethis' => 'ShareThis'], 'data-social-button-types');?>
				</div>
			</div>
		</div>
