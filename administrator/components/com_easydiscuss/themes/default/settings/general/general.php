		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'main_reportthreshold', 'COM_EASYDISCUSS_REPORT_THRESHOLD', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_REPORTS'], '', '', 'text-center'); ?>
				</div>
			</div>
		</div>
		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'max_tags_allowed', 'COM_EASYDISCUSS_MAX_TAG_ALLOWED', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_TAGS'], '', '', 'text-center'); ?>
				</div>
			</div>
		</div>
