		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'main_daystolock_afterlastreplied', 'COM_EASYDISCUSS_DAYSTOLOCK_REPLIED', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_DAYS'], '', '', 'text-center'); ?>

					<?php echo $this->html('settings.textbox', 'main_daystolock_aftercreated', 'COM_EASYDISCUSS_DAYSTOLOCK_CREATED', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_DAYS'], '', '', 'text-center'); ?>
				</div>
			</div>
		</div>
	</div>
