		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.toggle', 'secure_cron', 'COM_ED_SETTINGS_SECURE_CRON'); ?>
					<?php echo $this->html('settings.textbox', 'secure_cron_key', 'COM_ED_SETTINGS_SECURE_CRON_KEY', '', [], JText::_('COM_ED_SETTINGS_SECURE_CRON_KEY_INFO'));?>

					<?php if ($this->config->get('secure_cron_key')) { ?>
					<div class="o-form-group <?php echo $this->config->get('secure_cron') ? '' : 't-hidden';?>" data-secure-cron-settings>
						<div class="col-md-5 o-form-label"></div>
						<div class="col-md-7">
							<div class="o-input-group">
								<input type="text" class="o-form-control" value="<?php echo JURI::root() . 'index.php?option=com_easydiscuss&cron=true&phrase=' . $this->config->get('secure_cron_key');?>" />
								<a href="javascript:void(0);" class="o-btn o-btn--default-o" data-copy-cron>
