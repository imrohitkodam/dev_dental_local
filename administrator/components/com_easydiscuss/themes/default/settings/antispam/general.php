		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="o-form-horizontal">
					...
					<?php echo $this->html('settings.textarea', 'main_filtertext', 'COM_EASYDISCUSS_BAD_WORDS', '', [], 'COM_EASYDISCUSS_REPLACE_BAD_WORDS_TIPS'); ?>
					<?php echo $this->html('settings.textbox', 'antispam_minimum_title', 'COM_EASYDISCUSS_ANTI_SPAM_MINIMUM_TITLE', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_CHARACTERS'], '', '', 'text-center'); ?>
					<?php echo $this->html('settings.textbox', 'main_post_min_length', 'COM_EASYDISCUSS_MAIN_POST_MIN_LENGTH', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_CHARACTERS'], '', '', 'text-center'); ?>
					<?php echo $this->html('settings.toggle', 'main_post_title_limit', 'COM_ED_ENFORCE_TITLE_MAX_CHARS', '', 'data-max-title-option'); ?>
					<?php echo $this->html('settings.textbox', 'main_post_title_chars', 'COM_ED_MAX_TITLE_CHARS', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_CHARACTERS'], '', '', 'text-center'); ?>
					<?php echo $this->html('settings.toggle', 'antispam_disallow_editing', 'COM_ED_ANTISPAM_DISALLOW_EDITING'); ?>
					<?php echo $this->html('settings.textbox', 'antispam_disallow_editing_days', 'COM_ED_ANTISPAM_DISALLOW_EDITING_DAYS', '', ['size' => 7, 'postfix' => 'COM_EASYDISCUSS_DAYS'], '', '', 'text-center'); ?>
				</div>
			</div>
		</div>
	</div>
