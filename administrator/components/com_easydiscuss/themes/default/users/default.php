			...
			<thead>
				<tr>
					...
					<th style="text-align:left;">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_NAME', 'u.name', $order, $orderDirection); ?>
					</th>
					<th width="15%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_USERNAME', 'u.username', $order, $orderDirection); ?>
					</th>
					...
					<th width="15%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_EMAIL', 'u.email', $order, $orderDirection); ?>
					</th>
					<th width="10%" class="center">
					...
					<th width="1%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_ID', 'u.id', $order, $orderDirection); ?>
					</th>
				</tr>
			</thead>
