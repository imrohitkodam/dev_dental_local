			...
			<thead>
				<tr>
					...
					<th style="text-align:left;">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_CUSTOMFIELDS_TITLE', 'title', $order, $orderDirection); ?>
					</th>
					<th width="5%" class="center">
						<?php echo JText::_('COM_EASYDISCUSS_PUBLISHED'); ?>
					</th>
					<th width="5%" class="center">
						<?php echo JText::_('COM_EASYDISCUSS_CUSTOMFIELDS_REQUIRED'); ?>
					</th>
					<th width="12%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_CUSTOMFIELDS_TYPE', 'type', $order, $orderDirection); ?>
					</th>
					<th width="8%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_CUSTOMFIELDS_SECTION', 'section', $order, $orderDirection); ?>
					</th>
					<th width="20%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_ORDERING', 'a.ordering', $order, $orderDirection); ?>
					</th>
					<th width="1%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_ID', 'id', $order, $orderDirection); ?>
					</th>
				</tr>
			</thead>
