			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="o-form-horizontal">
						...
						<?php echo $this->html('forms.textarea', 'description', 'COM_EASYDISCUSS_BADGE_DESCRIPTION', $badge->description); ?>
					</div>
				</div>
			</div>
		</div>
								...
								<?php foreach ($badges as $item) { ?>
									<li class="badge-item center t-lg-mr--md t-lg-mb--md <?php echo $badge->avatar == $item ? ' selected-badge' : '';?>">
										<label for="<?php echo $badge;?>">
											...
											<input type="radio" value="<?php echo $item;?>" name="avatar" id="<?php echo $item;?>"<?php echo $badge->avatar == $item ? ' checked="checked"' : '';?> />
										</label>
									</li>
								<?php } ?>
							</ul>
