...
<div id="ed" class="ed-backend si-theme--light" data-ed-wrapper>
	<?php if (!$browse) { ?>
		...
		<?php if ($this->config->get('toolbar_installation_failed')) { ?>
			<div class="app-alert o-alert o-alert--info" data-ed-toolbar-notice>
				<div class="row-table">
					<div class="col-cell alert-message">
						<?php echo JText::_('COM_ED_TOOLBAR_PACKAGE_NOT_INSTALLED');?>
					</div>
					<div class="col-cell cell-tight">
						<a href="javascript:void(0);" class="o-alert__close"  data-ed-close-toolbarnotice>×</a>
					</div>
				</div>
			</div>
		<?php } ?>
