...
ed.require(['edq'], function($){
	...
	$(document).on('click.close.button', '[data-ed-close-toolbarnotice]', function(event) {
		EasyDiscuss.ajax('admin/controllers/system/dismissToolbarNotice');

		$('[data-ed-toolbar-notice]').addClass('t-hidden');
	});
});
