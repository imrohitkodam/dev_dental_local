			...
			<thead>
				<tr>
					...
					<th style="text-align:left;">
						<?php echo $this->html('table.sort', 'COM_ED_POST_LABEL_TITLE_COLUMN', 'a.title', $order, $orderDirection); ?>
					</th>
					...
					<th width="5%" class="center">
						<?php echo $this->html('table.sort', 'COM_ED_POST_LABEL_ID_COLUMN', 'a.id', $order, $orderDirection); ?>
					</th>
				</tr>
			</thead>
