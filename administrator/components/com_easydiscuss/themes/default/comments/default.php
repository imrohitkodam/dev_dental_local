			...
			<thead>
				<tr>
					...
					<th style="text-align: left;">
						<?php echo $this->html('table.sort', 'COM_ED_COMMENTS_COMMENT_COLUMN', 'comment', $order, $orderDirection); ?>
					</th>
					<th width="1%" class="center">
						<?php echo JText::_('COM_EASYDISCUSS_PUBLISHED'); ?>
					</th>
					<th width="20%" class="center">
						<?php echo $this->html('table.sort', 'COM_ED_AUTHOR', 'user_id', $order, $orderDirection); ?>
					</th>
					<th width="20%" class="center">
