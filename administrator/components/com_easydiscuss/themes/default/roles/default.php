			...
			<thead>
				<tr>
					...
					<th style="text-align:left;">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_ROLE_TITLE', 'title', $order, $orderDirection); ?>
					</th>
					...
					<th width="20%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_USERGROUP', 'usergroup_id', $order, $orderDirection); ?>
					</th>
					<th width="6%" class="center">
						<?php echo $this->html('table.sort', 'COM_EASYDISCUSS_ROLE_ID', 'id', $order, $orderDirection); ?>
					</th>
				</tr>
			</thead>
