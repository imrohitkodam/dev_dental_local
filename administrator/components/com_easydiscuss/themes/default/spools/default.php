	...
	<div class="app-filter-bar">
		...
		<div class="app-filter-bar__cell app-filter-bar__cell--divider-left">
			...
			<?php if (!$cronLastExecuted) { ?>
					<?php echo JText::_('COM_ED_SPOOLS_SETUP_CRONJOB_MESSAGE'); ?> 
					<a href="https://stackideas.com/docs/easydiscuss/administrators/cronjobs" target="_blank" class="o-btn o-btn--default-o t-ml--sm o-btn--sm">
						<?php echo JText::_('COM_ED_SPOOLS_SETUP_CRONJOB_BUTTON'); ?>
					</a>
			<?php } else { ?>
