...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div class="row">
		...
		<div class="col-lg-5">
			<div class="panel t-d--none" data-version-widget-wrapper>
				<div class="panel-head t-my--no t-pb--no t-pl--no">
					<div class="t-d--flex">
						<div class="t-flex-grow--1">
							<b class="panel-head-title"><?php echo JText::_('COM_ED_DASHBOARD_INFORMATION');?></b>
						</div>
					</div>
				</div>

				<div class="panel-body t-d--none" data-version-widget="latest">
					<div class="l-stack t-text--center">
						<div class="l-stack">
							<div>
								<div><i class="fa fa-check-circle t-text--success"></i>&nbsp; <?php echo JText::sprintf('COM_ED_INFO_LATEST_VERSION_MESSAGE', 'EasyDiscuss');?></div>
							</div>

							<div><b><?php echo JText::_('COM_ED_INFO_INSTALLED_VERSION'); ?>: <?php echo $version;?></b></div>
						</div>
					</div>
				</div>

				<div class="panel-body t-d--none" data-version-widget="outdated">
					<div class="l-stack t-text--center">
						<div class="l-stack">
							<div>
								<div><?php echo JText::sprintf('COM_ED_INFO_OUTDATED_VERSION_MESSAGE', 'EasyDiscuss');?></div>
							</div>

							<div><?php echo JText::_('COM_ED_INFO_INSTALLED_VERSION'); ?>: <b><?php echo $version;?></b></div>

							<div class="t-text--success">
								<?php echo JText::_('COM_ED_INFO_LATEST_VERSION'); ?>: <a href="https://stackideas.com/changelog/easydiscuss" class="t-text--success" target="_blank" style="text-decoration: underline;"><b><span data-version></span></a></b>
							</div>
							...
							<a href="<?php echo JURI::root();?>administrator/index.php?option=com_easydiscuss&controller=system&task=upgrade" class="o-btn o-btn--primary">
								<b>
									<i class="fa fa-bolt"></i>&nbsp; <?php echo JText::sprintf('COM_ED_INFO_UPDATE_BUTTON', 'EasyDiscuss');?>
								</b>
							</a>
						</div>
					</div>
			...
			<div class="panel">
				<div class="panel-head t-my--no t-pb--no t-pl--no">
					<div class="t-d--flex">
						<div class="t-flex-grow--1">
							<b class="panel-head-title"><?php echo JText::_('COM_ED_DASHBOARD_STATISTICS');?></b>
						</div>
					</div>
				</div>
