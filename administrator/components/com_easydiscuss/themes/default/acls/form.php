										...
										<div class="o-form-group">
											<ol class="g-list-inline g-list-inline--dashed t-ml--md">
												...
												<li style="border-left: 0;">
													<a href="javascript:void(0);" data-select-all><?php echo JText::_('COM_ED_ACL_ALL'); ?></a>
												</li>
												<li>
													<a href="javascript:void(0);" data-select-none><?php echo JText::_('COM_ED_ACL_NONE') ?></a>
												</li>
											</ol>
										</div>
