...
class JFormFieldModal_Posts extends EasyDiscussFormField
{
	protected $type = 'Modal_Posts';

	protected function getInput()
	{
		$title = JText::_('COM_ED_MENU_SELECT_POST_TITLE');

		if ($this->value) {
			$post = ED::post($this->value);
			$title = $post->title;
		}
		...
		$output = $this->theme->output('admin/html/form/post');
