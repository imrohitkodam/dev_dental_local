...
class EasyDiscussControllerUser extends EasyDiscussController
{
	...
	public function apply()
	{
		...
		// Point adjustment if admin adjust the point for the user
		if (isset($post['points'])) {
			...
			if ($userPoints != $points) {
				...
				$pointMsg = JText::sprintf('COM_ED_POINTS_ADJUSTMENTS', $totalPoints);
				ED::history()->log('easydiscuss.update.custompoint', $profile->id, $pointMsg, 0, false);
			}
		}
