...
// 			}
	 ...
	 * @access  public
	 */
	public function branch($id, $parent_id, $postAlias = null)
	{
		$prefix = 'RE';
		...
		// force to use this alias if it is not empty
		$alias = $postAlias;

		if (!$alias) {
			// this is old behavior before 5.0.6 #1341
