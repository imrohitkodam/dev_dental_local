...
class EasyDiscussModelDashboard extends EasyDiscussAdminModel
{
	...
	public function getPostsPie()
	{
		...
		$charts = ['unanswered'=>'#dd5036,#e16751', 'unresolved'=>'#ffd54f,#ffe180', 'resolved'=>'#39b54a,#50c861'];
		$pieArray = [];
		...
		foreach ($charts as $chart => $color) {
			...
			$pie->label = ucfirst(JText::_('COM_ED_' . strtoupper($chart))) . " " . JText::_('COM_ED_POSTS');
