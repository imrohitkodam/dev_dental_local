...
class EasyDiscussModelTags extends EasyDiscussAdminModel
{
	...
	public function _buildQueryOrderBy()
	{
		...
		$filter_order = $app->getUserStateFromRequest('com_easydiscuss.tags.filter_order', 'filter_order', 'id', 'cmd');
		$filter_order_Dir = $app->getUserStateFromRequest('com_easydiscuss.tags.filter_order_Dir', 'filter_order_Dir', 'desc', 'word');
