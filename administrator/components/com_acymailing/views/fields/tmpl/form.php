				...
				<table class="acymailing_table">
					...
					<?php if(empty($this->field->core) || $this->field->namekey == 'name'){ ?>
						...
						<tr class="fieldcatclass" style="display:none;">
							...
							<td>
								<input type="text" id="fieldcatclass" name="fieldsoptions[fieldcatclass]" style="width:200px;" value="<?php echo $this->escape(empty($this->field->options['fieldcatclass']) ? '' : $this->field->options['fieldcatclass']); ?>"/>
							</td>
						</tr>
						...
						<tr class="required" style="display:none">
							...
							<td>
								<input type="text" id="errormessage" size="80" name="fieldsoptions[errormessage]" value="<?php echo $this->escape(empty($this->field->options['errormessage']) ? '' : $this->field->options['errormessage']); ?>"/>
							</td>
						</tr>
					<?php } ?>
					...
					<tr class="checkcontent" style="display:none">
						...
						<td>
							<input type="text" id="errormessagecheckcontent" size="80" name="fieldsoptions[errormessagecheckcontent]" value="<?php echo $this->escape(empty($this->field->options['errormessagecheckcontent']) ? '' : $this->field->options['errormessagecheckcontent']); ?>"/>
						</td>
					</tr>
					...
					<tr class="cols" style="display:none">
						...
						<td>
							<input type="text" style="width:50px" name="fieldsoptions[cols]" id="cols" class="inputbox" value="<?php echo $this->escape(empty($this->field->options['cols']) ? '' : $this->field->options['cols']); ?>"/>
						</td>
					</tr>
					<tr class="rows" style="display:none">
						...
						<td>
							<input type="text" style="width:50px" name="fieldsoptions[rows]" id="rows" class="inputbox" value="<?php echo $this->escape(empty($this->field->options['rows']) ? '' : $this->field->options['rows']); ?>"/>
						</td>
					</tr>
					<tr class="size" style="display:none">
						...
						<td>
							<input type="text" id="size" style="width:50px" name="fieldsoptions[size]" value="<?php echo $this->escape(empty($this->field->options['size']) ? '' : $this->field->options['size']); ?>"/>
						</td>
					</tr>
					<tr class="format" style="display:none">
						...
						<td>
							<input type="text" id="format" name="fieldsoptions[format]" value="<?php echo $this->escape(empty($this->field->options['format']) ? '' : $this->field->options['format']); ?>"/>
						</td>
					</tr>
					<tr class="customtext" style="display:none">
						...
						<td>
							<textarea cols="50" rows="10" name="fieldcustomtext"><?php echo empty($this->field->options['customtext']) ? '' : $this->field->options['customtext']; ?></textarea>
						</td>
					</tr>
