...
if($this->config->get('inboxactionswhitelist', 1)){
	...
	acymailing_display(acymailing_translation('ACY_INBOX_ACTIONS_WHITELIST').' <a target="_blank" href="https://docs.acymailing.com/v/old/integration-plugins/installed-with-acymailing/gmail-inbox-actions">'.acymailing_translation('TELL_ME_MORE').'</a>'.$notremind, 'warning');
}
?>
