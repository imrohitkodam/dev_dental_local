	...
	<div class="onelineblockoptions">
		...
		<table class="acymailing_table" cellspacing="1">
			...
			<tr>
				<td class="acykey">
                    <?php
                    echo acymailing_translation('ACY_ANONYMOUS_TRACKING');
                    echo acymailing_tooltip(
                        acymailing_translation('ACY_ANONYMOUS_TRACKING_DESC'),
                        '',
                        '',
                        '<img style="margin:0px;width: 10px;margin-left: 5px;" src="'.ACYMAILING_IMAGES.'tooltip.png" alt="Warning" />'
                    );
                    ?>
				</td>
				<td>
	...
	<div class="onelineblockoptions">
		...
		<table class="acymailing_table" cellspacing="1">
            ...
            <?php if ($this->elements->geoloc_api_key) { ?>
				<tr>
					<td class="acykey">
						<a href="https://ipinfodb.com/register.php" target="_blank"><?php echo acymailing_tooltip(acymailing_translation('GEOLOCATION_API_KEY_DESC'), 'IPInfoDB API key', '', 'IPInfoDB API key'); ?></a>
					</td>
					<td>
				...
				<tr>
					<td class="acykey">
						<a href="https://www.ip2location.io/sign-up" target="_blank"><?php echo acymailing_tooltip(acymailing_translation('GEOLOCATION_API_KEY_DESC'), 'ip2location API key', '', 'ip2location API key'); ?></a>
					</td>
					<td>
                        <?php echo $this->elements->ip2location_api_key; ?>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<span id="ip2locationTestApiKey" class="acymailing_button_grey">
							<i class="acyicon-location"></i>
							<a style="color:#666;text-decoration:none;" href="javascript:void(0);" onclick="testAPI('ip2locationTestApiKey',window.document.getElementById('ip2location_api_key').value)"><?php echo acymailing_translation('GEOLOC_TEST_API_KEY'); ?></a>
						</span>
					</td>
				</tr>
				<tr>
					<td class="acykey">
						<a href="https://docs.acymailing.com/v/old/main-pages/configuration/configuration-tabs/geolocation" target="_blank"><?php echo acymailing_tooltip(acymailing_translation('ACY_GOOGLE_MAP_KEY_DESC'), acymailing_translation('ACY_GOOGLE_MAP_KEY'), '', acymailing_translation('ACY_GOOGLE_MAP_KEY')) ?></a>
					</td>
					<td>
