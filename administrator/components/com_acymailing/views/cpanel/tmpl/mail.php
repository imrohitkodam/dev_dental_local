	...
	<div class="onelineblockoptions">
		...
		<div id="mailer_method_config">
			...
			<div id="elasticemail_config" style="display:none" class="acymailing_deploy">
				...
				<?php echo acymailing_translation_sprintf('SMTP_DESC', 'Elastic Email'); ?><br />

				<?php
				acymailing_display(acymailing_translation('ACY_ELASTIC_UNSUB').'<br />'.htmlentities('<a href="{unsubscribeauto:{unsubscribe}{/unsubscribe}}">'.acymailing_translation('UNSUBSCRIBE').'</a>'), 'info');
				?>
				...
				<?php echo acymailing_translation('NO_ACCOUNT_YET').' <a href="https://elasticemail.com/account#/joomla-acymailing" target="_blank" >'.acymailing_translation('CREATE_ACCOUNT').'</a>'; ?>
				<?php echo '<br /><a href="https://docs.acymailing.com/v/old/main-pages/configuration/configuration-tabs/configure-your-send-process/external-smtp-service" target="_blank">'.acymailing_translation('TELL_ME_MORE').'</a>'; ?>
			</div>
		</div>
	</div>
	<div class="onelineblockoptions">
				...
				<td valign="top">
					...
					if(acymailing_level(1)){
						...
						<div class="acyblockoptions acymailing_deploy" id="dkim_config" <?php echo ($this->config->get('dkim', 0) == 1) ? 'style="display:block"' : 'style="display:none"' ?> >
							...
							if ((!empty($dkimSelector) && $dkimSelector != 'acy') || $this->config->get('dkim_passphrase', '') != '' || acymailing_getVar('int', 'dkimletme')) {
								?>
								<table class="acymailing_table" cellspacing="1">
									<tr>
										<td width="185" class="acykey">
							...
							<span class="acymailing_button_grey">
								...
								<a style="color:#666;text-decoration: none;" href="https://docs.acymailing.com/v/old/main-pages/configuration/configuration-tabs/configure-your-send-process/dkim-domainkeys-identified-mail" target="_blank"><?php echo acymailing_translation('ACY_HELP'); ?></a>
							</span>
						</div>
						<?php
					}
