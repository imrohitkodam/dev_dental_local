...
?><div id="config_plugins">
	...
	<span class="acymailing_button" style="margin:15px;">
		...
		<a style="margin-left:5px;color:#fff;text-decoration: none;" href="https://www.acymailing.com/acymailing-5-plugins" target="_blank"><?php echo acymailing_translation('MORE_PLUGINS'); ?></a>
	</span>
</div>
