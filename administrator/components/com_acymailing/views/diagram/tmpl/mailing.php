						...
						<?php if(!empty($this->mailingstats->senthtml)){ ?>
							<li>
								...
								if($this->config->get('anonymous_tracking', 0) == 0) {
									...
									echo acymailing_translation('OPEN_TOTAL').': '.$this->mailingstats->opentotal;
                                }
								?>
							</li>
							<li>
								...
								if($this->config->get('anonymous_tracking', 0) == 0) {
									...
									echo acymailing_translation('CLICKED_LINK').': '.$this->mailingstats->clicktotal;
                                }
								?>
							</li>
							<?php if($this->config->get('anonymous_tracking', 0) == 0) { ?>
								<li>
									<?php
