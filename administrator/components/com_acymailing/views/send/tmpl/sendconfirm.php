				...
				if(!empty($this->lists)){
					...
					<?php if(!empty($this->values->alreadySent)){
						...
						if($config->get('warninglimitation', 1)){
							...
							acymailing_display(acymailing_translation('WARNING_LIMITATION').'<br /><a target="_blank" href="https://docs.acymailing.com/v/old/main-pages/configuration/configuration-tabs/configure-your-send-process">'.acymailing_translation('WARNING_LIMITATION_CONFIG').'</a>'.$notremind, 'warning');
						}
					}
				}else{
