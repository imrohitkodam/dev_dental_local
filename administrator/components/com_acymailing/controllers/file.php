...
class FileController extends acymailingController{
    ...
    public function installLanguages($ajax = true)
    {
        ...
        $languagesContent = $updatemeHelper->call('public/download/translations?version=5&codes='.$languages);
        ...
        $decodedLanguages = $languagesContent['result']['translations'];
