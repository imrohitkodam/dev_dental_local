...
class frequencyType extends acymailingClass
{
    ...
    {
        parent::__construct();
        $this->txtDays = [acymailing_translation('MONDAY'), acymailing_translation('TUESDAY'), acymailing_translation('WEDNESDAY'), acymailing_translation('THURSDAY'), acymailing_translation('FRIDAY'), acymailing_translation('SATURDAY'), acymailing_translation('SUNDAY')];
        $this->txtPos = [acymailing_translation('FREQUENCY_FIRST'), acymailing_translation('FREQUENCY_SECOND'), acymailing_translation('FREQUENCY_THIRD'), acymailing_translation('FREQUENCY_LAST')];
    ...
    function display($value)
    {
        ...
        if ($arrayValue[0] === 'on') {
            ...
            return acymailing_translation('ACY_ON').' '.implode(', ', $arrayValue);
        } else {
