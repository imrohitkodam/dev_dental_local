				...
				<div class="row">
					<div class="col-xs-12">
						<div class="invoice-title">
							...
							{
								?>
								<div class="overflow-hidden mb-15 border-bottom">
								<h2 class="pull-left mt-0"><?php echo Text::_('JT_ORDERS_REPORT'); ?></h2>
								<h5 class="pull-right mt-10"><strong> <?php echo Text::_('COM_JTICKETING_ORDER_ID') , ':'; ?> <?php echo $this->orderinfo->order_id; ?></strong></h5>
								</div>
								<?php
						...
						<div class="row">
							<div class="col-xs-12 bill-to-details border-bottom">
								<address class="mb-10">
								...
								if (!empty($this->userInfo))
								{
									...
									{
										echo '<span>' . (!empty($this->userInfo->business_name) ? $this->escape($this->userInfo->business_name) : '') . '</span>' ;
									}

									echo '<br><span>' . (isset($this->userInfo->phone) ? $this->userInfo->phone : '') . '</span>' ;

									echo '<br><span>' . (isset($this->userInfo->user_email) ? $this->escape($this->userInfo->user_email) : '') . '</span>' ;
									...
									if (!empty($this->userInfo->city))
									{
										...
										echo '<br>' . $this->userInfo->address . ',' . $this->userInfo->city;
									}
							...
							<div class="row border-bottom">
								<address class="">
									<?php echo $this->escape($this->companyName); ?>
									<?php echo $this->escape($this->companyAddress); ?>
									<?php echo $this->escape($this->companyVatNo); ?>
...
<script type="text/javascript">
	...
	var orderID = "<?php echo $this->orderinfo->order_id; ?>";
