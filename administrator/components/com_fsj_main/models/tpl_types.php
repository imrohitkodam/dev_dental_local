...
class fsj_mainModeltpl_types extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
			...
			$query->select(
				$this->getState(
					'list.select',
					'a.id, a.component as component, a.type as type, a.title as title, a.description as description'
				)
			);

			$query->from('#__fsj_tpl_type AS a');
