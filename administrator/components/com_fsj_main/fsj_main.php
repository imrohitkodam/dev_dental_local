...
if (!JFactory::getUser()->authorise('core.manage', 'com_fsj_main')) {
...
JLoader::register('fsj_mainHelper', dirname(__FILE__) . '/helpers/fsj_main.php');
// Base Settings
...
// run page
$controller = JControllerLegacy::getInstance('fsj_main');
