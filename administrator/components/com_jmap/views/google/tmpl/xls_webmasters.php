...
<b><font size="4" color="#0028D3"><?php echo JText::_ ('COM_JMAP_GOOGLE_WEBMASTERS_STATS_SITEMAPS' ) . $reportDelimiter; ?></font></b>
<table>
	<thead>
		<tr>
			<th style="width:15%">
				...
				foreach ($this->googleData['sitemaps'] as $sitemap) {
					...
					<tr>
						...
						<td>
							...
							'<span>' . JText::_('COM_JMAP_GOOGLE_WEBMASTERS_STATS_SITEMAP_STATUS_PENDING') . '</span>' : 
							'<span>' . JText::_('COM_JMAP_GOOGLE_WEBMASTERS_STATS_SITEMAP_STATUS_INDEXED') . '</span>';?>
						</td>
						<td>
							<?php 
						...
						<td>
							...
							'<span>' . $sitemap->getWarnings()  . '</span>' : 
							'<span>0</span>';?>
						</td>
						<td>
							<?php echo $sitemap->getErrors() > 0 ? 
							'<span>' . $sitemap->getErrors()  . '</span>' : 
							'<span>0</span>';?>
						</td>
						<td>
							<?php echo $sitemap->getIsSitemapsIndex() ? 
							'<span>' . JText::_('COM_JMAP_GOOGLE_WEBMASTERS_STATS_SITEMAP_INDEX') . '</span>' : 
							'<span>' . JText::_('COM_JMAP_GOOGLE_WEBMASTERS_STATS_SITEMAP_STANDARD') . '</span>';?>
						</td>
...
<table>
	<tr>
		<td>
			<b><?php echo JText::_('COM_JMAP_FILTER_BY_DATE_FROM' ); ?>: <?php echo $this->dates['from'];?></b>
		</td>
		<td>
			<b><?php echo JText::_('COM_JMAP_FILTER_BY_DATE_TO' ); ?>: <?php echo $this->dates['to'];?></b>
		</td>
	</tr>
</table>

<!-- GOOGLE SEARCH CONSOLE STATS AND METRICS-->
<b><font size="4" color="#0028D3"><?php echo JText::_ ('COM_JMAP_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_QUERY' ) . $reportDelimiter; ?></font></b>
<table>
	<thead>
		<tr>
			<th>
...
<b><font size="4" color="#0028D3"><?php echo JText::_ ('COM_JMAP_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_PAGES' ) . $reportDelimiter; ?></font></b>
<table>
	<thead>
		<tr>
			<th>
...
<b><font size="4" color="#0028D3"><?php echo JText::_ ('COM_JMAP_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_DEVICE' ) . $reportDelimiter; ?></font></b>
<table>
	<thead>
		<tr>
			<th style="width:50%">
...
<b><font size="4" color="#0028D3"><?php echo JText::_ ('COM_JMAP_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_COUNTRY' ) . $reportDelimiter; ?></font></b>
<table>
	<thead>
		<tr>
			<th style="width:50%">
...
<b><font size="4" color="#0028D3"><?php echo JText::_ ('COM_JMAP_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_DATE' ) . $reportDelimiter; ?></font></b>
<table>
	<thead>
		<tr>
			<th style="width:50%">
