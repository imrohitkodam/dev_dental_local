 ...
 * @since 4.6.7
 */
class JMapSeostatsServicesGoogleCompetitors extends JMapSeostatsServicesGoogleSearch {
	/**
	...
	protected static function googlepages() {
		...
		self::$_values ['googlepages'] = $g_pages === false ? JText::_ ( 'COM_JMAP_NA' ) : ( int ) $g_pages;
	}
	...
	protected static function googlebacklinks() {
		...
		self::$_values ['googlebacklinks'] = $g_back === false ? JText::_ ( 'COM_JMAP_NA' ) : ( int ) $g_back;
	}
	...
	protected static function googleRelated() {
		...
		self::$_values ['googlerelated'] = $r_pages === false ? JText::_ ( 'COM_JMAP_NA' ) : ( int ) $r_pages;
	}
	...
	protected static function bingpages() {
		...
		if ($response && $response != JText::_ ( 'COM_JMAP_NA' )) {
		...
		if (! $found)
			$this->values ['bingpages'] = JText::_ ( 'COM_JMAP_NA' );
	}
	...
	protected static function bingbacklinks() {
		...
		if (! $found)
			self::$_values ['bingbacklinks'] = JText::_ ( 'COM_JMAP_NA' );
	}
	...
	public static function getStats($url) {
		...
		self::$_values = array(
				'googlepages' => JText::_ ( 'COM_JMAP_NA' ),
				'googlebacklinks' => JText::_ ( 'COM_JMAP_NA' ),
				'googlerelated' => JText::_ ( 'COM_JMAP_NA' ),
				'bingpages' => JText::_ ( 'COM_JMAP_NA' ),
				'bingbacklinks' => JText::_ ( 'COM_JMAP_NA' )
		);
