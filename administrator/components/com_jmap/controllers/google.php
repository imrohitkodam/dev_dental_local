...
class JMapControllerGoogle extends JMapController {
	...
	protected function setModelState($scope = 'default', $ordering = true) {
		...
		$pagespeedLink = $this->getUserStateFromRequest( "$option.$scope.pagespeedlink", 'pagespeed_pageurl', $defaultModel->getComponentParams()->get('pagespeed_domain', JUri::root(false)));
