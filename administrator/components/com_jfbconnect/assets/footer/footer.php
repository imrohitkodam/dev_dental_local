	...
	<tbody>
		<tr>
			...
			<td style="text-align: center; width: 49%;">
				...
				<br/>Copyright: 2010-2019 &copy; <a href="http://www.sourcecoast.com" target="_blank">SourceCoast Web Development</a>
				<br/>
				Version: <?php echo $version;?>
			</td>
			<td style="text-align: right; width: 25%;">
				<a href="http://extensions.joomla.org/extensions/extension/social-web/social-display/jfbconnect" target="_blank"><?php echo JText::_('COM_JFBCONNECT_FOOTER_LEAVE_FEEDBACK');?></a>
				<br/>
