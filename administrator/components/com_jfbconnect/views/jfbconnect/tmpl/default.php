        ...
        <div class="span12">
            <div class="span7">
                ...
                <div class="jfbcControlIcons">
                    ...
                    <div class="icon-wrapper">
                        <div class="icon">
                            <a href="index.php?option=com_jfbconnect&view=scope">
                                <?php echo JHTML::_('image', 'administrator/components/com_jfbconnect/assets/images/icon-48-scopereview-sc.png', NULL, NULL); ?>
                                <span><?php echo JText::_('COM_JFBCONNECT_MENU_SCOPE_REVIEW'); ?></span>
                            </a>
                        </div>
                    </div>
                    <div class="icon-wrapper">
