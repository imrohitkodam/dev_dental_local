...
<ul class="nav nav-tabs">
    <li class="active"><a href="#"><?php echo JText::_('COM_JFBCONNECT_CHANNEL_CONFIGURATION_LABEL');?></a></li>
    <li><a href="index.php?option=com_jfbconnect&view=channels&layout=activity"><?php echo JText::_('COM_JFBCONNECT_CHANNEL_HISTORY_LABEL');?></a></li>
</ul>
