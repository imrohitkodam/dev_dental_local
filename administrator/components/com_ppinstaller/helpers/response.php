...
class PpinstallerAjaxResponse
{
	...
	{
		$res = new PpinstallerAjaxResponse();
		return $res;
	}
...
//	}
	...
	function sendResponse()
	{
		...
		$isIframe = (bool) JFactory::getApplication()->input->get('isIframe', false);
		...
		if($isIframe){
			$output = "<body onload=\"parent.ppInstaller_iresponse();\">" . htmlentities($output,  ENT_COMPAT | ENT_HTML401 ,  'UTF-8'). "</body>";
		}
