...
if (!JFactory::getUser()->authorise('core.manage', 'com_fsj_fssadd')) {
...
JLoader::register('fsj_fssaddHelper', dirname(__FILE__) . '/helpers/fsj_fssadd.php');
// Base Settings
...
// run page
$controller = JControllerLegacy::getInstance('fsj_fssadd');
