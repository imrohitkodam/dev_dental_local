...
class JTablefsj_fssaddcanned extends JTable{
	public function __construct(&$db)
	{
		parent::__construct('#__fsj_fssadd_canned', 'id', $db);
	}

	protected function _getAssetName()
	{
		$k = $this->_tbl_key;
		return 'com_fsj_fssadd.fssadd_canned.' . (int) $this->$k;
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('canned', 'JTablefsj_fssadd');
		$alias = $this->alias;
		$tries = 2; 
