...
class fsj_fssaddViewfsj_fssadd extends JViewLegacy
{
    ...
    {	
		...
		fsj_ToolbarsHelper::addSubmenu(JRequest::getCmd('view', 'fsj_fssadd'), 'JHtmlSidebar');
		...
		JToolBarHelper::title( JText::_('com_fsj_fssadd') , $icon );
		$mainframe = JFactory::getApplication();
		$default = str_replace("com_fsj_","",JRequest::getVar('option'));
		if (JFactory::getUser()->authorise('core.admin', 'com_fsj_fssadd'))
		{
		...
		$this->xml = simplexml_load_file(JPATH_ROOT.DS."administrator".DS."components".DS."com_fsj_fssadd".DS.$default.".xml");
	...
	function getComponents()
	{
		...
		usort($items, array("fsj_fssaddViewfsj_fssadd", "compSort"));
		return $items;
	}
