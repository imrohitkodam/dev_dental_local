	...
	<div class="row-fluid">
		...
		<div class="span10">
			<div class="pull-right" style="margin-top: 9px;">
				<?php echo JText::_("com_fsj_fssadd_menu"); ?> v<b><?php echo FSJ_Admin_Helper::getVersion("com_fsj_fssadd"); ?></b>
			</div>
			<?php $overview = FSJ_AdminHelper::GetOverview('fsj_fssadd'); ?>
			<?php echo JHtml::_('fsjtabs.start', 'fsj_fssadd_overview_tabs', array('useCookie' => 0, 'default' => 'comp')); ?>
			<?php echo JHtml::_('fsjtabs.panel', JText::_("com_fsj_fssadd_menu"), 'comp'); ?>
			...
			if ($showsettings): ?>
			<?php if (JFactory::getUser()->authorise('core.admin', 'com_fsj_main') || JFactory::getUser()->authorise('core.admin', 'com_fsj_fssadd')): ?>
				<div class="well well-small pull-left margin-small">
					<h4><?php echo JText::_('FSJ_ADMIN_SETTINGS');?></h4>
					<ul class="nav nav-list">
			<?php if (JFactory::getUser()->authorise('core.admin', 'com_fsj_main')): ?>
						<?php echo FSJ_AdminHelper::Item('FSJ_ADMIN_GLOBAL_SETTINGS',"index.php?option=com_fsj_main&view=settings&admin_com=fssadd&settings=global",'com_fsj_main','globalsettings',JText::_('FSJ_ADMIN_GLOBAL_SETTINGS_DESC')); ?>
			<?php endif; ?>
			<?php if (JFactory::getUser()->authorise('core.admin', 'com_fsj_fssadd')): ?>
						<?php echo FSJ_AdminHelper::Item('FSJ_ADMIN_COMPONENT_SETTINGS',"index.php?option=com_fsj_main&view=settings&admin_com=fssadd",'com_fsj_main','componentsettings',JText::_('FSJ_ADMIN_COMPONENT_SETTINGS_DESC')); ?>
			<?php endif; ?>
					</ul>
				</div>
			<?php endif; ?>
			...
			<?php if (JFactory::getUser()->authorise('core.admin', 'com_fsj_fssadd') && isset($this->xml->admin->templates)): ?>
				<div class="well well-small pull-left margin-small">
