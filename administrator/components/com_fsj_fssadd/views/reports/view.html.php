...
class fsj_fssaddViewreports extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		{
			JToolBarHelper::title(JText::_('COM_FSJ_'.$admin_com.'_SHORT' ). ": " . JText::_('COM_fsj_fssadd_ITEMS_fssadd_reportS' ), $icon);
		} else {
			JToolBarHelper::title(JText::_(JRequest::getVar('option').'_SHORT' ). ": " . JText::_('COM_fsj_fssadd_ITEMS_fssadd_reportS' ), $icon);
		}
	...
	function setupOrdering()
	{
		$orders = array();
				...
				$orders['a.title DESC'] = JText::_('JGLOBAL_TITLE') . " " . JText::_("JGLOBAL_ORDER_DESCENDING");
											...
											$orders['a.description ASC'] = JText::_('FSJ_FSSADD_FORM_FSSADD_REPORT_DESCRIPTION') . " " . JText::_("JGLOBAL_ORDER_ASCENDING");
						$orders['a.description DESC'] = JText::_('FSJ_FSSADD_FORM_FSSADD_REPORT_DESCRIPTION') . " " . JText::_("JGLOBAL_ORDER_DESCENDING");
