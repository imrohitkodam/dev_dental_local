<div id="acym__wysid__right__toolbar__design" class="cell grid-y acym__wysid__right__toolbar--menu">
	...
	<div class="acym__wysid__context__modal__container grid-x grid-margin-x grid-margin-y cell xxlarge-up-3 large-up-2 medium-up-1 small-up-1 acym__wysid__right__toolbar__design--show acym__wysid__right__toolbar__zones">
		...
		<div class="cell acym__wysid__zone__element--new acym__wysid__zone__element--new--2 ui-draggable ui-draggable-handle">
			<svg version="1.1" x="0px" y="0px" viewBox="0 0 80.8 81" style="enable-background:new 0 0 80.8 81;" xml:space="preserve">
		...
		<div class="cell acym__wysid__zone__element--new acym__wysid__zone__element--new--3 ui-draggable ui-draggable-handle">
			<svg version="1.1" x="0px" y="0px" viewBox="0 0 80.8 81" style="enable-background:new 0 0 80.8 81;" xml:space="preserve">
		...
		<div class="cell acym__wysid__zone__element--new acym__wysid__zone__element--new--4 ui-draggable ui-draggable-handle">
			<svg version="1.1" x="0px" y="0px" viewBox="0 0 80.8 81" style="enable-background:new 0 0 80.8 81;" xml:space="preserve">
		...
		<div class="cell acym__wysid__zone__element--new acym__wysid__zone__element--new--5 ui-draggable ui-draggable-handle">
			<svg version="1.1" x="0px" y="0px" viewBox="0 0 80.8 81" style="enable-background:new 0 0 80.8 81;" xml:space="preserve">
		...
		<div class="cell acym__wysid__zone__element--new acym__wysid__zone__element--new--6 ui-draggable ui-draggable-handle">
			<svg version="1.1" x="0px" y="0px" viewBox="0 0 80.8 81" style="enable-background:new 0 0 80.8 81;" xml:space="preserve">
	...
	<div class="acym__wysid__context__modal__container grid-x grid-margin-x grid-margin-y cell xxlarge-up-3 large-up-2 medium-up-1 small-up-1 acym__wysid__right__toolbar__design--show acym__wysid__right__toolbar__blocks">
		...
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--text ui-draggable ui-draggable-handle">
			<i class="cell acymicon-format-align-justify"></i>
			<div class="cell"><?php echo acym_translation('ACYM_TEXT'); ?></div>
		</div>
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--button ui-draggable ui-draggable-handle">
			<i class="cell acymicon-crop-16-9"></i>
			<div class="cell"><?php echo acym_translation('ACYM_BUTTON'); ?></div>
		</div>
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--space ui-draggable ui-draggable-handle">
			<i class="cell acymicon-unfold-more"></i>
			<div class="cell"><?php echo acym_translation('ACYM_SPACE'); ?></div>
		</div>
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--picture ui-draggable ui-draggable-handle">
			<i class="cell acymicon-insert-photo"></i>
			<div class="cell"><?php echo acym_translation('ACYM_IMAGE'); ?></div>
		</div>
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--video ui-draggable ui-draggable-handle">
			<i class="cell acymicon-play-circle-filled"></i>
        ...
        ?>
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--follow ui-draggable ui-draggable-handle">
			<i class="cell acymicon-facebook"></i>
			<div class="cell"><?php echo acym_translation('ACYM_FOLLOW'); ?></div>
		</div>
		<div class="grid-x cell acym__wysid__block__element--new acym__wysid__block__element--new--separator ui-draggable ui-draggable-handle">
			<i class="cell acymicon-more-horizontal"></i>
