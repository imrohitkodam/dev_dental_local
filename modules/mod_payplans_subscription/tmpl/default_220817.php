...
<?php if ($subscriptions) { ?>
	<?php foreach ($subscriptions as $subscription) { ?>
		...
		<div id="pp" class="modifydate" style="height: auto;">
			...
			<?php } else { ?>
				<?php echo JText::_('MOD_PAYPLANS_SUBSCRIPTION_EXPIRATION_DATE_' . strtoupper(PP::model('subscription')->getStatusString($subscription->status))) . " " . $subscription->getExpirationDate()->toMysql(); ?>
			<?php } ?>
		</div>
