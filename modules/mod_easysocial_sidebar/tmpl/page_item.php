...
<div id="es" class="mod-es mod-es-sidebar <?php echo $this->lib->getSuffix();?>">
	<div class="es-sidebar" data-sidebar>
		...
		<?php echo $this->lib->render('widgets', SOCIAL_TYPE_PAGE, 'pages', 'sidebarTop', ['uid' => $page->id, 'page' => $page]); ?>
		...
		<?php echo $this->lib->render('widgets', SOCIAL_TYPE_PAGE, 'pages', 'sidebarMiddle', ['uid' => $page->id, 'page' => $page]); ?>

		<?php echo $this->lib->render('widgets', SOCIAL_TYPE_PAGE, 'pages', 'sidebarBottom', ['uid' => $page->id, 'page' => $page]); ?>
