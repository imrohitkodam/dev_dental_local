...
<?php if ($conversation->getLastMessage()) { ?>
	<?php if ($conversation->getLastMessage()->created_by === $my->id) { ?>
		<i class="fdi fa fa-share" data-es-provide="tooltip" data-placement="bottom" data-original-title="<?php echo JText::_('COM_EASYSOCIAL_CONVERSATION_YOU_HAVE_REPLIED_HERE');?>"></i>
