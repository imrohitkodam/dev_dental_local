		...
		<div class="ed-mod-card__body">
			<form action="<?php echo EDR::_('view=index');?>" method="post" name="discuss-search">
				<div class="t-d--flex t-align-items--c sm:t-flex-direction--c sm:t-w--100">
						...
						<div class="o-media">
							...
							<div class="o-media__body">
								<div class="o-input-group">
									<input type="text" value="<?php echo ED::string()->escape($query); ?>" name="query" placeholder="<?php echo JText::_('MOD_EASYDISCUSS_SEARCH_PLACEHOLDER' , true);?>" class="o-form-control">
									<button class="o-btn o-btn--default-o"><?php echo JText::_('MOD_EASYDISCUSS_SEARCH_BUTTON');?></button>
								</div>
					...
					<?php if ($params->get('showaskbutton') && $acl->allowed('add_question')) { ?>
