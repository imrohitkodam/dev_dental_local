						...
						<div class="">
							...
							<div class="t-min-width--0 t-d--flex t-align-items--c o-meta" data-user-avatar="" data-isanonymous="0">
								<?php if ($post->isLastReplyAnonymous()) { ?>
									...
									&nbsp;
									<?php echo $lib->html('user.username', $post->user, ['posterName' => $post->user->getName(), 'isAnonymous' => true, 'canViewAnonymousUsername' => $post->canAccessAnonymousPost($post->last_reply_id)]); ?>
								<?php } else { ?>
